/**
 * Deobfuscated from: default-login-startup-main-startup-shared-worker-znotification.e437bbccf2b050240f86.js
 * Generated: 2025-10-05T13:04:15.140Z
 * 
...
(this.webpackJsonp = this.webpackJsonp || []).push([
  [3], {
    KoSx: function(e, E, t) {
      ...
      let S = function(e) {
        return e.SCRIPT_CONNECTED = "script-connected", e
      }({})
    },
    MPV0: function(e, E, t) {
      "use strict";
      ...
      let S = function(e) {
        return e.CHANNEL_ESTATBLISHED = "channel-established", e.CHANNEL_DISCONNECTED = "channel-disconnected", e.CHANNEL_TERMINATED = "channel-terminated", e.PORT_TRANSFERRED = "port-transferred", e.PORT_TRANSFERRED_V2 = "port-transferred-v2", e.PORT_DELIVERED = "port-delivered", e.OPEN_CHANNEL_TO = "open-channel-to", e
      }({})
    },
    R2CK: function(e, E, t) {
      "use strict";
      ...
      let S = function(e) {
        return e.REQUEST_CHANNEL = "shared-worker-req-events", e.RESPONSE_CHANNEL = "shared-worker-resp-events", e.SQLITE_AVAILABLE = "sqlite-available", e.FAIL_LOAD_LIB_SQLITE3 = "fail-load-sqlite3", e.NOTIFY_STATUS_LOAD_LIB_SQLITE3 = "status-load-sqlite3", e.OPEN_DB_FAIL = "db-open-fail", e.IPC_DB_AUTHENTICATED = "db-authenticated", e.IPC_DB_CLIENT_CONNECTED = "db-client-connected", e.IPC_START_CLOSE_DBS = "db-start-close-dbs", e.IPC_FINISH_CLOSE_DBS = "db-finish-close-dbs", e.SYNC_MSG_ABORT = "sync-msg-abort", e.DB_CORRUPTION_DETECTOR = "z-db-corruption-detector", e.SHOW_SQLITE = "show-sqlite", e.GET_NAME_OF_TARGET_SCRIPT_FOR_DAL_CHANNEL_FROM_HOST = "get-name-of-target-script-for-dal-channel-from-host", e
      }({})
    },
    "W+DE": function(e, E, t) {
      "use strict";
      ...
      let S = function(e) {
        return e.NEW_SESSION = "new-session", e
      }({})
    },
    v5OU: function(e, E, t) {
      "use strict";
      ...
      const C = {
        ...
        getResourceDir: {
          apiKey: o.GET_RESOURCE_DIR,
          type: _.REQUEST
        },
        onCheckIdleUpdaterBusy: {
          apiKey: o.CHECK_IDLE_UPDATE_BUSY,
          type: _.PROVIDE
        },
        ...
        getRecentFiles: {
          apiKey: o.GET_RECENT_FILE,
          type: _.REQUEST
        },
        authError: {
          apiKey: o.GET_AUTH_DOMAIN,
          type: _.NOTIFY
        },
        getAuthDomainReady: {
          apiKey: o.GET_AUTH_DOMAIN_READY,
          type: _.NOTIFY
        },
        getAuthDomainReply: {
          apiKey: o.GET_AUTH_DOMAIN_REPLY,
          type: _.PROVIDE
        }
      };
      var N = t("R2CK");
      const T = {
        ...
        onFailedLoadSqlite: {
          apiKey: N.a.FAIL_LOAD_LIB_SQLITE3,
          type: _.SUBSCRIBE
        },
        ...
        updateAvailableSqliteState: {
          apiKey: N.a.NOTIFY_STATUS_LOAD_LIB_SQLITE3,
          type: _.NOTIFY
        },
        notifyOpenDBFailed: {
          apiKey: N.a.OPEN_DB_FAIL,
          type: _.NOTIFY
        },
        authenticateDb: {
          apiKey: N.a.IPC_DB_AUTHENTICATED,
          type: _.NOTIFY
        },
        onReceiveSession: {
          apiKey: N.a.IPC_DB_AUTHENTICATED,
        ...
        notifyDbConnected: {
          apiKey: N.a.IPC_DB_CLIENT_CONNECTED,
          type: _.NOTIFY
        },
        requestCloseDbs: {
          apiKey: N.a.IPC_START_CLOSE_DBS,
          type: _.NOTIFY
        },
        onRequestCloseDbs: {
          apiKey: N.a.IPC_START_CLOSE_DBS,
        ...
        notifyFinishCloseDb: {
          apiKey: N.a.IPC_FINISH_CLOSE_DBS,
          type: _.NOTIFY
        },
        abortSyncMsg: {
          apiKey: N.a.SYNC_MSG_ABORT,
          type: _.NOTIFY
        },
        getIDBDatabaseHealthStatus: {
          apiKey: N.a.DB_CORRUPTION_DETECTOR,
          type: _.REQUEST
        },
        canIUseSQLite: {
          apiKey: N.a.SQLITE_AVAILABLE,
          type: _.REQUEST
        },
        showSQLite: {
          apiKey: N.a.SHOW_SQLITE,
          type: _.NOTIFY
        },
        getNameOfTargetScriptForDALChannelFromHost: {
          apiKey: N.a.GET_NAME_OF_TARGET_SCRIPT_FOR_DAL_CHANNEL_FROM_HOST,
          type: _.REQUEST
        }
      };
      let A = function(e) {
      ...
      const I = {
        ...
        createTimer: {
          apiKey: y.CREATE_TIMER,
          type: _.NOTIFY
        },
        clearTimer: {
          apiKey: y.CLEAR_TIMER,
          type: _.NOTIFY
        },
      ...
      const c = {
        crossQosLog: {
          apiKey: B.CROSS_LOG_QOS_CHANNEL,
          type: _.REQUEST
        },
        crossQosConfig: {
          apiKey: B.CROSS_LOG_QOS_CONFIG,
          type: _.NOTIFY
        },
        notifyOsCloseMain: {
          apiKey: B.SIGNAL_OS_CLOSE_MAIN_CHANNEL,
          type: _.NOTIFY
        },
        notifyQosReady: {
          apiKey: B.CROSS_LOG_QOS_READY_CHANNEL,
          type: _.NOTIFY
        },
        onQosLog: {
          apiKey: B.CROSS_LOG_QOS_CHANNEL,
        ...
        onActionLog999: {
          apiKey: B.CROSS_ACTION_LOG_999_CHANNEL,
          type: _.SUBSCRIBE
        },
        ...
        notifyActionLogReady: {
          apiKey: B.CROSS_LOG_ACTION_READY_CHANNEL,
          type: _.NOTIFY
        },
        onActionLog: {
          apiKey: B.CROSS_LOG_ACTION_CHANNEL,
          type: _.SUBSCRIBE
        },
        ...
        loadShellQos: {
          apiKey: B.LOAD_SHELL_QOS,
          type: _.REQUEST
        },
        checkRecentCrash: {
          apiKey: B.RECENT_CRASH,
          type: _.REQUEST
        }
      };
      let D = function(e) {
        return e.LOGIN = "login", e.LOGIN_STEP = "login-step", e.USER_NOT_LOGGED_IN = "signal_USER_NOT_LOGGED_IN", e.LOGIN_SUCCESS = "login-success", e.LOGIN_AFTER_INSTALL = "login-after-install", e
      }({});
      const K = {
        login: {
          apiKey: D.LOGIN,
        ...
        loginAfterInstall: {
          apiKey: D.LOGIN_AFTER_INSTALL,
          type: _.RAW_SEND
        },
        onUserNotLogged: {
          apiKey: D.USER_NOT_LOGGED_IN,
          type: _.SUBSCRIBE
        },
      ...
      const P = {
        sendMessage: {
          apiKey: l.SEND_METRICS,
          type: _.NOTIFY
        },
        onMessage: {
          apiKey: l.RESPONSE_METRICS,
          type: _.SUBSCRIBE
        }
      };
      var u = t("3xbP");
      const d = Object(S.a)(Object(S.a)({}, u.a), {}, {
          CLOSE_ALL_CHILDS: "close-all-childs"
        }),
        H = {
          onChildWindowClose: {
            apiKey: d.CHILD_WINDOW_CLOSED,
            type: _.SUBSCRIBE
          },
      ...
      const G = {
        start: {
          apiKey: m.START_SCREENCAP,
          type: _.REQUEST
        },
        getClipboard: {
          apiKey: m.GET_CLIPBOARD,
          type: _.REQUEST
        },
        restart: {
          apiKey: m.RESTART_SCREENCAP,
          type: _.REQUEST
        },
        rewriteClipboard: {
          apiKey: m.REWRITE_CLIPBOARD,
          type: _.REQUEST
        },
        onChangeStatus: {
          apiKey: m.CHANGE_SCREENCAP_STATUS,
          type: _.SUBSCRIBE
        },
        ...
        onScreenshotShortcut: {
          apiKey: m.SCREENSHOT_SHORTCUT_RESULT,
          type: _.SUBSCRIBE
        },
        ...
        onScreenCapture: {
          apiKey: m.SCREENSHOT_CAPTURE_SHORTCUT,
          type: _.SUBSCRIBE
        },
        ...
        onCaptureAccept: {
          apiKey: m.SCREEN_CAPTURE_RESPONSE_ACCEPT,
          type: _.SUBSCRIBE
        },
        ...
        onCaptureNoPermission: {
          apiKey: m.SCREEN_CAPTURE_RESPONSE_NO_PERMISSION,
          type: _.SUBSCRIBE
        },
        ...
        onSend2Me: {
          apiKey: m.SCREEN_CAPTURE_RESPONSE_SEND2ME,
          type: _.SUBSCRIBE
        },
        removeListenSend2Me: {
          apiKey: m.SCREEN_CAPTURE_RESPONSE_SEND2ME,
        ...
        onWarningInstallRosetta: {
          apiKey: m.WARNING_INSTALL_ROSETTA,
          type: _.SUBSCRIBE
        },
      ...
      let g = function(e) {
        return e.OPEN_IN_APP_PAYMENT = "open-in-app-payment", e.CLOSE_IN_APP_PAYMENT = "close-in-app-payment", e
      }({});
      const v = {
        openUrl: {
          apiKey: g.OPEN_IN_APP_PAYMENT,
          type: _.REQUEST
        },
        closeInAppPayment: {
          apiKey: g.CLOSE_IN_APP_PAYMENT,
          type: _.REQUEST
        }
      };
      const F = {
      ...
      var h = t("fsQs");
      let M = function(e) {
        return e.SHOW_SHARED_WORKER = "show-shared-worker", e.SHARED_WORKER_START = "shared-worker-start", e.SHARED_WORKER_HANDLE = "shared-worker-handle", e.SHARED_WORKER_PING = "shared-worker-ping", e.SHARED_WORKER_DISPOSE = "shared-worker-dispose", e.SHARED_WORKER_PROGRESS = "shared-worker-progress", e.SHARED_WORKER_RESP = "shared-worker-resp", e.SHARED_WORKER_RUN = "shared-worker-run", e.SHARED_WORKER_ABORT = "shared-worker-abort", e.SHARED_WORKER_UPDATE_PARAMS = "shared-worker-update-params", e[e.UNLOAD_ZLOG = h.s] = "UNLOAD_ZLOG", e
      }({});
      const W = {
        show: {
          apiKey: M.SHOW_SHARED_WORKER,
          type: _.NOTIFY
        },
        start: {
          apiKey: M.SHARED_WORKER_START,
          type: _.NOTIFY
        },
        register: {
          apiKey: M.SHARED_WORKER_HANDLE,
          type: _.NOTIFY
        },
        ping: {
          apiKey: M.SHARED_WORKER_PING,
          type: _.NOTIFY
        },
        dispose: {
          apiKey: M.SHARED_WORKER_DISPOSE,
          type: _.NOTIFY
        },
        updateProgress: {
          apiKey: M.SHARED_WORKER_PROGRESS,
          type: _.NOTIFY
        },
        ...
        updateTaskParams: {
          apiKey: M.SHARED_WORKER_UPDATE_PARAMS,
          type: _.NOTIFY
        },
      ...
      const f = {
        requestUpdate: {
          apiKey: Q.REQUEST_UPDATE,
          type: _.REQUEST
        },
        requestCheckUpdate: {
          apiKey: Q.REQUEST_CHECK_UPDATE,
          type: _.NOTIFY
        },
        onNewUpdate: {
          apiKey: Q.BINARY_UPDATED,
          type: _.SUBSCRIBE
        },
        onNewManualUpdate: {
          apiKey: Q.MANUAL_BINARY_UPDATED,
          type: _.SUBSCRIBE
        },
        onFallbackUpdate: {
          apiKey: Q.FALLBACK_UPDATE,
          type: _.SUBSCRIBE
        },
        ...
        onManualUpdateInstalling: {
          apiKey: Q.MANUAL_UPDATE_INSTALLING,
          type: _.SUBSCRIBE
        },
        ...
        onManualUpdateDownloading: {
          apiKey: Q.MANUAL_UPDATE_DOWNLOADING,
          type: _.SUBSCRIBE
        },
        ...
        onManualUpdateChecked: {
          apiKey: Q.MANUAL_UPDATE_CHECKED,
          type: _.SUBSCRIBE
        },
        ...
        onManualUpdateCheckedOnly: {
          apiKey: Q.MANUAL_UPDATE_CHECKED_ONLY,
          type: _.SUBSCRIBE
        },
        ...
        onManualUpdateCheckOnlyErr: {
          apiKey: Q.MANUAL_UPDATE_CHECKED_ONLY_ERR,
          type: _.SUBSCRIBE
        },
        ...
        requestCheckDownloadUpdate: {
          apiKey: Q.MANUAL_UPDATE_DOWNLOAD_CHECK,
          type: _.RAW_SEND
        },
        requestCheckDownloadUpdateOnly: {
          apiKey: Q.MANUAL_UPDATE_DOWNLOAD_CHECK_ONLY,
          type: _.NOTIFY
        },
        requestResourceReload: {
          apiKey: Q.RESOURCE_RELOAD_SAFE,
          type: _.NOTIFY
        },
        requestBinaryReload: {
          apiKey: Q.BINARY_RELOAD_SAFE,
          type: _.NOTIFY
        },
        requestManualBinaryReload: {
          apiKey: Q.MANUAL_BINARY_RELOAD_SAFE,
          type: _.NOTIFY
        },
        openUpdatePage: {
          apiKey: Q.OPEN_UPDATE_PAGE,
          type: _.NOTIFY
        },
        onReceiveUpdateInfo: {
          apiKey: Q.RECEIVE_UPDATE_INFO,
          type: _.ONCE
        },
        onUncaughtError: {
          apiKey: Q.UNCAUGHT_ERR,
          type: _.UNSUBSCRIBE
        },
      ...
      const Y = {
        ...
        maximizeToggler: {
          apiKey: w.MAXIMIZE_TOGGLER,
          type: _.REQUEST
        },
        setLoginSize: {
          apiKey: w.SET_LOGIN_SIZE,
          type: _.REQUEST
        },
        expandMainWindow: {
          apiKey: w.EXPAND_MAIN_WINDOW,
          type: _.REQUEST
        },
        isMaximized: {
          apiKey: w.IS_MAXIMIZED,
          type: _.REQUEST
        },
        isFullScreen: {
          apiKey: w.IS_FULLSCREEN,
          type: _.REQUEST
        },
        fullscreenToggler: {
          apiKey: w.FULLSCREEN_TOGGLER,
          type: _.REQUEST
        },
        flashFrame: {
          apiKey: w.FLASH_FRAME,
          type: _.REQUEST
        },
        focus: {
          apiKey: w.FOCUS,
        ...
        showOpenDialog: {
          apiKey: w.SHOW_OPEN_DIALOG,
          type: _.REQUEST
        },
        showSaveDialog: {
          apiKey: w.SHOW_SAVE_DIALOG,
          type: _.REQUEST
        },
        showOpenDialogSync: {
          apiKey: w.SHOW_OPEN_DIALOG_SYNC,
          type: _.REQUEST
        },
        showSaveDialogSync: {
          apiKey: w.SHOW_SAVE_DIALOG_SYNC,
          type: _.REQUEST
        },
        onVisibilityChange: {
          apiKey: w.VISIBILITY_CHANGE,
          type: _.SUBSCRIBE
        },
        ...
        openPhotoViewerDevtool: {
          apiKey: w.OPEN_PHOTO_VIEWER_DEVTOOL,
          type: _.REQUEST
        },
        onUnloadZLog: {
          apiKey: w.UNLOAD_ZLOG,
          type: _.SUBSCRIBE
        },
        removeListenUnloadZLog: {
          apiKey: w.UNLOAD_ZLOG,
      ...
      const k = {
        ...
        checkOpenConvReq: {
          apiKey: b.CHECK_ON_START_UP,
          type: _.REQUEST
        },
        checkArgvLink: {
          apiKey: b.CHECK_ARG_LINK,
          type: _.RAW_SEND
        }
      };
      let V = function(e) {
      ...
      const z = {
        ...
        onCallActiveNative: {
          apiKey: V.CALL_ACTIVE_NATIVE_APP,
          type: _.SUBSCRIBE
        },
        ...
        sendDataToNative: {
          apiKey: V.SEND_TO_NATIVE,
          type: _.RAW_SEND
        },
        onCallResponseDevices: {
          apiKey: V.CALL_RESPONSE_LIST_DEVICE,
          type: _.ONCE
        },
      ...
      const $ = {
        onChannelEstablished: {
          apiKey: q.a.CHANNEL_ESTATBLISHED,
          type: _.SUBSCRIBE
        },
        ...
        onChannelDisconnected: {
          apiKey: q.a.CHANNEL_DISCONNECTED,
          type: _.SUBSCRIBE
        },
        ...
        onReceiveTransferredPortV2: {
          apiKey: q.a.PORT_TRANSFERRED_V2,
          type: _.SUBSCRIBE_V2
        },
        ...
        notifyPortDelivered: {
          apiKey: q.a.PORT_DELIVERED,
          type: _.NOTIFY
        },
        requestOpenChannelTo: {
          apiKey: q.a.OPEN_CHANNEL_TO,
          type: _.NOTIFY
        }
      };
      let Z = function(e) {
        return e.GET_HEAP = "gett-heap", e.WRITE_HEAP = "write-heap", e
      }({});
      const x = {
        getHeap: {
          apiKey: Z.GET_HEAP,
      ...
      function Ee(e, E, t) {
        ...
        ee(e, $zsub)[t.name] = e => {
          -1 == _.indexOf(e) && _.push(e), J.provider[S] || (J.provider[S] = E[t.name](((...e) => {
            for (let E of _) E(...e)
          })))
        }
      }
      ...
      function te(e, E, t) {
        ...
        ee(e, $zsub)[t.name] = e => {
          const S = _.indexOf(e); - 1 != S && _.splice(S, 1), _.length <= 0 && (E[t.name](), delete J.provider[t.apiKey])
        }
      }
      globalThis.$zsub = {};
      const Se = {};
      ...
      function _e(e, E, t) {
        let _ = Se[E];
        void 0 === _ && (_ = {}), _ = Object(S.a)(Object(S.a)({}, _), t), Se[E] = _;
        const {
          args: a,
          ports: R
        } = _;
        if (void 0 !== a && void 0 !== R) {
          const t = J.listeners[e];
          for (const e of t) {
            const [E, ...t] = a;
            E.ports = R, e(E, ...t)
          }
      ...
      function ae(e, E, t) {
        ...
        ee(e, $zsub)[t.name] = e => {
          if (-1 == _.indexOf(e) && _.push(e), !J.provider[S]) {
            const e = (e, ...E) => {
              _e(S, e, {
                args: E
              })
            };
            J.provider[S] = E[t.name](e)
          }
        }
      }
      let Re = !1;
      ...
      function ie(e, E, t) {
        for (let R in t) {
          var a;
          const p = t[R];
          switch (J.listeners[p.apiKey] = null !== (a = J.listeners[p.apiKey]) && void 0 !== a ? a : [], p.type) {
            case _.SUBSCRIBE:
              Ee(e, E, Object(S.a)({
                name: R
              }, p));
            ...
            case _.UNSUBSCRIBE:
              ...
              break;
            case _.SUBSCRIBE_V2:
              pe(), ae(e, E, Object(S.a)({
                name: R
              }, p))
          }
        }
      }
      ie("$zwindow", $zwindow, Y), ie("$zuri", $zuri, k), ie("$zapp", $zapp, R), ie("$zresource", $zresource, C), ie("$zdownload", $zdownload, r), ie("$zdb", $zdb, T), ie("$zsessionManager", $zsessionManager, j), ie("$zupdater", $zupdater, f), ie("$zsharedWorker", $zsharedWorker, W), ie("$zlogger", $zlogger, c), ie("$zlogin", $zlogin, K), ie("$zMetric", $zMetric, P), ie("$zmulti", $zmulti, H), ie("$zscreencap", $zscreencap, G), ie("$zcall", $zcall, z), ie("$zFeatures.activeDeactive", $zFeatures.activeDeactive, I), ie("$zFeatures.mainless", $zFeatures.mainless, O), ie("$zFeatures.syncDownload", $zFeatures.syncDownload, L), ie("$zcloud", $zcloud, x), ie("$zInAppPayment", $zInAppPayment, v), ie("$zMsgChannel", $zMsgChannel, $), ie("$zscript", $zscript, F), ie("$zbackup", $zbackup, i)
    }
  }
]);
//# sourceMappingURL=../sourcemaps/lazy/default-login-startup-main-startup-shared-worker-znotification.e437bbccf2b050240f86.js.map
