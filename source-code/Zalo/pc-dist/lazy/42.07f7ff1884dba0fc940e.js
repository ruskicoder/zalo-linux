/**
 * Deobfuscated from: 42.07f7ff1884dba0fc940e.js
 * Generated: 2025-10-05T13:04:14.852Z
 * 
  ...
  [42], {
    ...
    TZgy: function(e, t, a) {
      ...
      var n = a("q1tI"),
        ...
        E = a("c51z"),
        _ = a("J39W");
      var d = c.a.forwardRef(((e, t) => {
          const a = Object(n.useRef)(),
            [r, s] = Object(n.useState)(!1),
            [i, d] = Object(n.useState)(!1),
            [f, p] = Object(n.useState)(E.default.currentLanguage()),
            N = e => {
              let t = `:flag-${e}:`;
              return c.a.createElement("span", {
                className: "emoji-sizer emoji-outer ",
                style: {
                  background: `url(${g.default.emojiImg})`,
                  backgroundSize: "6500%",
                  backgroundPosition: g.default.emojiMapPos[t],
                  marginLeft: "5px",
            ...
            L = e => {
              E.default.changeToLang(e), p(e), $zapp.changeLanguage(e), b()
            };
          return c.a.createElement(c.a.Fragment, null, c.a.createElement(o.a, {
            ...
            items: [{
              ...
              items: [{
                ...
                onclick: () => L(m.LANG_INDEX_VI),
                checked: f == m.LANG_INDEX_VI
              }, {
                text: "English",
                icon: {
                  html: N("us")
                },
                onclick: () => L(m.LANG_INDEX_EN),
                checked: f == m.LANG_INDEX_EN
              }]
            }, {
              textKey: "STR_ABOUT",
              onclick: () => {
      ...
      var N = () => {
          ...
          return {
            quitApp: Object(n.useCallback)((() => {
              f.ModuleContainer.resolve(p.a).quitApp()
            }), [])
          }
        },
        b = (a("y1FZ"), a("/MKj"));
      const L = "screen-old-app",
        A = {
          Root: L,
...
//# sourceMappingURL=../sourcemaps/lazy/42.07f7ff1884dba0fc940e.js.map
