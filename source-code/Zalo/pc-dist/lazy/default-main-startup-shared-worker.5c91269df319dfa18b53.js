/**
 * Deobfuscated from: default-main-startup-shared-worker.5c91269df319dfa18b53.js
 * Generated: 2025-10-05T13:04:18.529Z
 * 
  ...
  [16], {
    "37f1": function(e, t, i) {
      ...
      var s, r = i("VTBJ"),
        ...
        F = i("vAzq"),
        j = i("AtyM");
      Object(g.injectable)()(s = Object(g.singleton)(u.a)(s = function(e, t) {
        return Object(g.inject)(v.c)(e, void 0, 0)
      }(s = function(e, t) {
        return Object(g.inject)(f.b)(e, void 0, 1)
      }(s = function(e, t) {
        return Object(g.inject)(M.e)(e, void 0, 2)
      }(s = function(e, t) {
        return Object(g.inject)(w.b)(e, void 0, 3)
      }(s = function(e, t) {
        return Object(g.inject)(p.ZLoggerFactory)(e, void 0, 4)
      }(s = Reflect.metadata("design:type", Function)(s = Reflect.metadata("design:paramtypes", [void 0 === v.IUtilsMediaManager ? Object : v.IUtilsMediaManager, void 0 === f.IMediaRepositoryFactory ? Object : f.IMediaRepositoryFactory, void 0 === M.b ? Object : M.b, void 0 === w.IMediaPrimaryKeyConvertor ? Object : w.IMediaPrimaryKeyConvertor, void 0 === p.ZLoggerFactory ? Object : p.ZLoggerFactory])(s = class {
        constructor(e, t, i, s, r) {
          this._utilsMediaManager = void 0, this._mediaMapperFactory = void 0, this._mediaRepositoryFactory = void 0, this._mediaPrimaryKeyConvertor = void 0, this._logger = void 0, this._utilsMediaManager = e, this._mediaRepositoryFactory = t, this._mediaMapperFactory = i, this._mediaPrimaryKeyConvertor = s, this._logger = r.createZLogger("media-manager", [""])
        }
        filter(e, t) {
          return Object(D.a)() ? I.a.filterMedia(e, t) : h.a.filter(e, t)
        }
        getMediaRepository(e, t = !0) {
          const i = this._mediaRepositoryFactory.getMediaRepository(e);
          if (!i && t) throw Error(`[getMediaRepository]: can't get mediaRepository has mediaType: ${e}!`);
          return i
        }
        getMediaMapper(e, t = !0) {
          const i = this._mediaMapperFactory.getMediaMapper(e);
          if (!i && t) throw Error(`[getMediaMapper]: can't get mediaMapper has mediaType: ${e}!`);
          return i
        }
        async _isMigrationDone() {
          return (await g.ModuleContainer.resolve(E.c).getMediaMigrationState()).stateName === U.b.DONE
        }
        async isExistedMedia(e, t) {
          try {
            ...
            var i;
            const e = [null == s || null === (i = s.toString) || void 0 === i ? void 0 : i.call(s), null == s ? void 0 : s.stack].join("\n");
            return this._logger.zsymb(21, "ZN6J3H", ["[isExistedMedia] - error: {}", "9KnA77"], e), !1
          }
        }
        async addMedias(e, t, i = `${a.c.UNKNOWN}${a.d.UNKNOWN}`) {
          try {
            if (!e) throw Error("mediaType is undefined!");
            if (!t || !t.length) return;
            const s = this.getMediaRepository(e),
              r = this.getMediaMapper(e),
              a = t.map((t => (t.src = i, "image" === e && (t.subType = o.MSG_SUBTYPE_MEDIA_DOODLE), r.toDomainFromDTO(t)))),
              n = (await s.insertMulti(a)).success.map((t => this.getMediaMapper(e).toMediaToCreateOrUpdateUtilsMediaDTOFromDomain(t)));
            await this._utilsMediaManager.createOrUpdateFromMedias(n)
          } catch (r) {
            var s;
            const e = [null == r || null === (s = r.toString) || void 0 === s ? void 0 : s.call(r), null == r ? void 0 : r.stack].join("\n");
            this._logger.zsymb(21, "wM4d6Y", ["[addMedias] - error: {}", "HK7QTD"], e)
          }
        }
        addMediaToConvOnly(e, t = `${a.c.UNKNOWN}${a.d.UNKNOWN}`) {
          var i, s, r;
          if (!Object(D.a)()) return h.a.addMediaToConversationOnly(e);
          let n = [];
          if (null != e && null !== (i = e.image) && void 0 !== i && i.length) {
            const i = this.getMediaRepository("image"),
              s = this.getMediaMapper("image");
            n.push(null == i ? void 0 : i.insertMulti(e.image.map((e => (e.src = t, s.toDomainFromDTO(e))))).then((e => {
              if (e.success.length) {
          ...
          if (null != e && null !== (s = e.link) && void 0 !== s && s.length) {
            const i = this.getMediaRepository("link"),
              s = this.getMediaMapper("link");
            n.push(null == i ? void 0 : i.insertMulti(e.link.map((e => {
              e.src = t;
              return s.toDomainFromDTO(e)
            }))).then((e => {
              if (e.success.length) {
          ...
          if (null != e && null !== (r = e.file) && void 0 !== r && r.length) {
            const i = this.getMediaRepository("file"),
              s = this.getMediaMapper("file");
            n.push(i.insertMulti(e.file.map((e => (e.src = t, s.toDomainFromDTO(e))))).then((e => {
              if (e.success.length) {
        ...
        async deleteMediasById(e, t, i) {
          try {
            if (!i) throw Error("mediaIdObjs is undefined!");
            ...
            for (const e of o) {
              ...
              if (!i && s) {
                ...
                e.newId = i ? `${i.cliMsgId}_${i.fromUid}_${i.toUid}` : ""
              }
            }
            const d = this.getMediaRepository(e, !1),
              u = [];
            for (const e of o) u.push(Object(r.a)(Object(r.a)({}, e), {}, {
              deleteTo: await this._isMigrationDone() ? y.a.NEW : y.a.UNKNOWN
            }));
            if (d) await d.deleteMultiMedias(u);
            else {
              var s, a, n;
              const e = [];
              e.push(null === (s = g.ModuleContainer.resolve(l.b)) || void 0 === s ? void 0 : s.deleteMultiMedias(u), null === (a = g.ModuleContainer.resolve(c.b)) || void 0 === a ? void 0 : a.deleteMultiMedias(u), null === (n = g.ModuleContainer.resolve(m.b)) || void 0 === n ? void 0 : n.deleteMultiMedias(u)), await Promise.all(e)
            }
          } catch (d) {
            var o;
            const e = [null == d || null === (o = d.toString) || void 0 === o ? void 0 : o.call(d), null == d ? void 0 : d.stack].join("\n");
            this._logger.zsymb(21, "iDvsZs", ["[deleteMediasById] - error: {}", "5DRrqN"], e)
          }
        }
        async getValidMediasOfConv(e, t, i, s, a, n) {
          try {
            if (!t) return Promise.resolve([]);
            const d = j.a.now(),
              l = {
                cliMsgId: o.MessageConstants.MAX_MSG_ID,
                sendDttm: parseInt(o.MessageConstants.MAX_SENDDTTM),
                msgId: s || o.MessageConstants.MAX_MSG_ID
              };
            if (null != n && n.lastItemOpts) l.cliMsgId = n.lastItemOpts.cliMsgId, l.sendDttm = n.lastItemOpts.sendDttm;
            else if (s) {
              const e = await this.getMediaFieldsByMsgId(t, s);
              e && (l.cliMsgId = e.cliMsgId, l.sendDttm = e.sendDttm)
            }
            const c = h.a.getLastDeleteConv(t, e),
              m = this.getMediaRepository(e),
              g = await m.getMediasOfConv(t, l, i, Object(r.a)(Object(r.a)({}, a), {}, {
                deletePointOfConv: c
              }));
            if (!g.length) return [];
            const u = this.getMediaMapper(e),
              p = await Promise.all(g.map((e => u.toDTO(e))));
            return this._trackDBPerformance({
              executionTime: j.a.now() - d,
            ...
            return this._logger.zsymb(21, "-uwt8f", ["[getValidMediasOfConv] - error: {}", "qPu_I4"], e), Promise.resolve([])
          }
        }
        async getLastMediasOfConvWithoutCorrectData(e, t, i, s = 100, r) {
          if (!Object(D.a)()) return h.a.getLastMediaFromConversation(t, e, s, i);
          try {
            if (!t) return Promise.resolve([null, Error("convId is undefined!")]);
            const a = {
              cliMsgId: o.MessageConstants.MAX_MSG_ID,
              sendDttm: parseInt(o.MessageConstants.MAX_SENDDTTM),
              msgId: i || d.default.load_media.use_max_id || o.MessageConstants.MAX_MSG_ID
            };
            if (null != r && r.lastItemOpts) a.cliMsgId = r.lastItemOpts.cliMsgId, a.sendDttm = r.lastItemOpts.sendDttm;
            else if (i) {
              const e = await this.getMediaFieldsByMsgId(t, i);
              e && (a.cliMsgId = e.cliMsgId, a.sendDttm = e.sendDttm)
            }
            const n = this.getMediaRepository(e),
              l = await n.getLastMediasOfConv(t, a, s);
            ...
            return this._logger.zsymb(21, "np6XON", ["[getLastMediasOfConvWithoutCorrectData] - error: {}", "yEzKU4"], e), [null, n]
          }
        }
        async updateMedia(e, t, i, s, a) {
          if (!Object(D.a)()) {
            const t = Object(r.a)(Object(r.a)({}, s), {}, {
              msgId: i
            });
            return h.a.updateMedia(t, e, a)
          }
          return this._updateMedia(e, t, i, s, a)
        }
        async countMediaOfConv(e, t, i) {
          try {
            ...
            s.cliMsgId = s.cliMsgId ? s.cliMsgId : "", s.sendDttm = s.sendDttm ? s.sendDttm : 0, s.msgId = s.msgId ? s.msgId : "", a.cliMsgId = a.cliMsgId ? a.cliMsgId : o.MessageConstants.MAX_MSG_ID, a.sendDttm = a.sendDttm ? a.sendDttm : parseInt(o.MessageConstants.MAX_SENDDTTM), a.msgId = a.msgId ? a.msgId : o.MessageConstants.MAX_MSG_ID;
            const n = this.getMediaRepository(e);
            return {
              ok: !0,
              result: await n.countMediaOfConv(t, {
                from: Object(r.a)({}, s),
                to: Object(r.a)({}, a)
              }),
              error: null
            ...
            return this._logger.zsymb(21, "a8z8Hs", ["[countMediaOfConv] - error: {}", "dZWiuO"], e), {
              ok: !1,
              result: 0,
              error: a
            }
        ...
        async getMediaFieldsByMsgId(e, t) {
          ...
          const i = await b.default.getInstance().Core.Message.get(t, {
            partition: e
          });
          return i ? {
            cliMsgId: "number" == typeof i.cliMsgId ? i.cliMsgId.toString() : i.cliMsgId,
            fromUid: i.fromUid,
            toUid: i.toUid,
            sendDttm: "string" == typeof i.sendDttm ? parseInt(i.sendDttm) : i.sendDttm
          } : Promise.resolve(void 0)
        }
        async getAllValidPhotoAndVideosOfConv(e) {
          if (!Object(D.a)()) return h.a.getAllMediaFromConv(e);
          let t = !0,
            i = {
              cliMsgId: o.MessageConstants.MAX_MSG_ID,
              sendDttm: parseInt(o.MessageConstants.MAX_SENDDTTM)
            },
            s = o.MessageConstants.MAX_MSG_ID,
            r = "",
            a = [],
            n = [];
          for (; t;) {
            const d = await this.getValidMediasOfConv("image", e, 50, s, {}, {
              lastItemOpts: {
                cliMsgId: i.cliMsgId,
                sendDttm: i.sendDttm
              }
            ...
            if (d.length) {
              if (d.forEach((e => {
                  e && e.subType == o.MSG_SUBTYPE_MEDIA_VIDEO ? a.push(e) : !e || e.subType != o.MSG_SUBTYPE_PHOTO && e.subType !== o.MSG_SUBTYPE_MEDIA_DOODLE || n.push(e)
                })), l = {
                  cliMsgId: d[d.length - 1].cliMsgId,
                  sendDttm: d[d.length - 1].sendDttm
                }, m = d[d.length - 1].msgId, c = d[d.length - 1].mediaId, m && s && m == s || c && r && c == r) break;
              i = l, r = c, s = m
            }
          }
          return {
        ...
        async getAllValidPhotoAndVideosOfConvV2(e) {
          ...
          do {
            const s = await this.getMediaRepository("image").getLastMediasOfConvInNewDB(e, n, 50),
              d = [],
              l = s.map((e => e.cliMsgId)),
              c = {
                index: "cliMsgIdIndex",
                partition: e
              },
              m = b.default.getInstance(),
              g = (await m.Core.Message.getMultiIfExists(l, c)).reduce(((e, t) => (t && (e[`${t.cliMsgId}_${t.fromUid}_${t.toUid}`] = t), e)), {}),
              u = [];
            for (const e of s) u.push(new Promise((async t => {
              try {
                var i, s;
                const t = Object(r.a)(Object(r.a)({}, e), {}, {
                    msgId: null !== (i = null === (s = g[e.mediaId]) || void 0 === s ? void 0 : s.msgId) && void 0 !== i ? i : ""
                  }),
            ...
            if (await Promise.all(u), d.length) {
              d.forEach((e => {
                e.subType == o.MSG_SUBTYPE_MEDIA_VIDEO ? i.push(e) : e.subType != o.MSG_SUBTYPE_PHOTO && e.subType != o.MSG_SUBTYPE_MEDIA_DOODLE || t.push(e)
              }));
              let e = {
                cliMsgId: d[d.length - 1].cliMsgId,
                sendDttm: d[d.length - 1].sendDttm
              };
              if (e.cliMsgId && n.cliMsgId == e.cliMsgId || e.sendDttm && n.sendDttm == e.sendDttm) break;
              n = e
            }
            a = d.length >= 50
          } while (a);
          a = !1;
          let d = o.MessageConstants.MAX_MSG_ID;
          do {
            const s = await this.getMediaRepository("image").getLastMediasOfConvInOldDB(e, {
                msgId: d
              }, 50),
              r = await Promise.all(s.map((e => this.getMediaMapper("image").toDTO(e, !1))));
            if (r.length) {
              r.forEach((e => {
                e.subType == o.MSG_SUBTYPE_MEDIA_VIDEO ? i.push(e) : e.subType != o.MSG_SUBTYPE_PHOTO && e.subType != o.MSG_SUBTYPE_MEDIA_DOODLE || t.push(e)
              }));
          ...
          return this._trackDBPerformance({
            executionTime: j.a.now() - s,
            actionName: "getAllByConv",
            mediaType: "all",
            resultSize: t.length + i.length
          }), {
            photos: t,
            videos: i
          }
        }
        async getImageMessagesForPhotoViewer(e, t, i, s, r, a) {
          if (!Object(D.a)()) return _.default.getImagesForPhotoViewer({
            userId: e
          }, t, i, s, r, a);
          try {
            var n;
            if (!e || !t) throw Error("convId or lastMsgId is undefined!");
            const d = await this.getMediaFieldsByMsgId(e, t);
            return await (null === (n = g.ModuleContainer.resolve(l.b)) || void 0 === n ? void 0 : n.getImageMessagesForPhotoViewer(e, i, {
              sendDttm: (null == d ? void 0 : d.sendDttm) || parseInt(o.MessageConstants.MAX_SENDDTTM),
              cliMsgId: (null == d ? void 0 : d.cliMsgId) || o.MessageConstants.MAX_MSG_ID,
              msgId: t
            }, s, r, a))
          } catch (c) {
            var d;
            const e = [null == c || null === (d = c.toString) || void 0 === d ? void 0 : d.call(c), null == c ? void 0 : c.stack].join("\n");
            return this._logger.zsymb(21, "anHF6J", ["[getImageMessagesForPhotoViewer] - error: {}", "Lw6pqq"], e), []
          }
        }
        async getLastestAddedFiles(e, t = 40) {
          if (!Object(D.a)()) return _.default.getLatestFiles(e, t);
          try {
            if (!e) {
              e = Date.now();
              let t = n.default.getTimeNow();
              e = e > t ? e : t
            }
            const i = o.MessageConstants.MAX_CONVERSATION_ID,
              s = parseInt(o.MessageConstants.MAX_MSG_ID),
              r = g.ModuleContainer.resolve(c.b),
              a = await r.getLastestAddedFiles({
                convId: i,
                sendDttm: e,
                cliMsgId: s
              }, t);
            if (a.length > 0) {
              ...
              return await Promise.all(a.map((t => e.toDTO(t))))
            }
            return []
          } catch (s) {
            var i;
            const e = [null == s || null === (i = s.toString) || void 0 === i ? void 0 : i.call(s), null == s ? void 0 : s.stack].join("\n");
            return this._logger.zsymb(21, "8jDOwb", ["[getLastestAddedFiles] - error: {}", "K6_tmM"], e), Promise.resolve([])
          }
        }
        async getMultiMedias(e, t, i) {
          if (!Object(D.a)()) return _.default.getMediaByIds(e, i);
          try {
            if (!i || i.length < 0) throw Error("msgIds is undefined or empty!");
            const s = j.a.now(),
              r = [],
              a = i.map((e => this.getMediaFieldsByMsgId(t, e).then((async t => {
                r.push({
                  newId: t ? `${t.cliMsgId}_${t.fromUid}_${t.toUid}` : "",
                  oldId: e,
                  getFrom: await this._isMigrationDone() ? y.b.NEW : y.b.UNKNOWN
                })
              }))));
            if (await Promise.all(a), !r.length) return [];
            const n = (await this.getMediaRepository(e).getMultiMedias(r)).filter(Boolean);
            ...
            var s;
            const e = [null == r || null === (s = r.toString) || void 0 === s ? void 0 : s.call(r), null == r ? void 0 : r.stack].join("\n");
            return this._logger.zsymb(21, "rARX79", ["[getMultiMedias] - error: {}", "dtjZJQ"], e), []
          }
        }
        async getMediaById(e, t, i) {
          try {
            if (!i) throw Error("mediaId is undefined!");
            const s = await this.getMediaFieldsByMsgId(t, i),
              r = this.getMediaRepository(e),
              a = await r.getMedia({
                newId: s ? `${s.cliMsgId}_${s.fromUid}_${s.toUid}` : "",
                oldId: i
              }, void 0, await this._isMigrationDone() ? y.b.NEW : y.b.UNKNOWN);
            return a ? await this.getMediaMapper(e).toDTO(a) : void 0
          } catch (r) {
            var s;
            const e = [null == r || null === (s = r.toString) || void 0 === s ? void 0 : s.call(r), null == r ? void 0 : r.stack].join("\n");
            return this._logger.zsymb(21, "awjoCF", ["[getMediaById] - error: {}", "TKU2_m"], e), Promise.resolve(void 0)
          }
        }
        async _updateMedia(e, t, i, s, r) {
          try {
            if (!t) throw Error("chatID isn't valid!");
            if (!i) throw Error("mediaId isn't valid!");
            if (!s) throw Error("mediaValue isn't valid!");
            const r = this.getMediaRepository(e),
              a = await this._mediaPrimaryKeyConvertor.toMediaPKFromMessagePK(t, i),
              n = this.getMediaMapper(e).toNewEAttsFromDTOAtts(s);
            return await r.updateMedia({
              ...
              value: n,
              ignoreNotFound: !0
            }, await this._isMigrationDone() ? y.c.NEW : y.c.UNKNOWN)
          } catch (n) {
            var a;
            const e = [null == n || null === (a = n.toString) || void 0 === a ? void 0 : a.call(n), null == n ? void 0 : n.stack].join("\n");
            return this._logger.zsymb(21, "7qOrwV", ["[_updateMedia] - error: {}", "dDYnqL"], e), !1
          }
        }
          ...
          try {
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              switch (d) {
                ...
                case o.MSG_PHOTO_2:
                case o.MSG_DOODLE:
                  if (!Object(S.a)(a) && !O.default.isPhotoStickerMessage(a)) {
                    const e = a.message.thumb || a.message.oriUrl,
                      t = d == o.MSG_DOODLE ? Object(r.a)(Object(r.a)({}, a.message), {}, {
                        thumbUrl: e
                      }) : a.message;
                    i.push({
                      sendDttm: l,
                ...
                case o.MSG_FILE:
                  ...
                  break;
                case o.MSG_CONTACT:
                  "recommened.link" === a.message.action && s.push({
                    sendDttm: l,
                    msgId: a.msgId,
                    userId: a.toUid,
                    message: a.message,
                ...
                case o.MSG_VIDEO:
                  i.push({
                    ...
                    message: a.message,
                    fromUid: a.fromUid,
                    subType: o.MSG_SUBTYPE_MEDIA_VIDEO,
                    type: "image",
                    ttl: a.ttl,
                    cliMsgId: a.cliMsgId
                  })
            ...
            let a = [];
            return i.length > 0 && a.push(b.default.getInstance().Core.Image.insertMulti(i, {
              replace: !1
            })), s.length > 0 && a.push(b.default.getInstance().Core.Link.insertMulti(s, {
              replace: !1
            ...
            var t;
            const e = [null == i || null === (t = i.toString) || void 0 === t ? void 0 : t.call(i), null == i ? void 0 : i.stack].join("\n");
            this._logger.zsymb(21, "Ztheb1", ["[_addMediasWhenTransferMessageOldFlow] - error: {}", "KvaI-1"], e)
          }
        }
        async _addMediasFromMessages(e, t) {
          try {
            if (!e || !e.length) return;
            t = t || `${a.c.UNKNOWN}${a.d.FROM_MSG}`;
            const i = [],
              s = [],
              n = [],
              d = this.getMediaMapper("image"),
              l = this.getMediaMapper("file"),
              c = this.getMediaMapper("link");
            e.forEach((e => {
              const a = e.msgType;
              switch (a) {
                case o.MSG_PHOTO:
                ...
                case o.MSG_DOODLE:
                  if (a === o.MSG_DOODLE) {
                    ...
                    if (e.message) {
                      ...
                      s = Object(r.a)(Object(r.a)({}, e.message), {}, {
                        thumbUrl: t
                      })
                    }
                    i.push(d.toDomainFromTMessage(Object(r.a)(Object(r.a)({}, e), {}, {
                      message: s
                    }), o.MSG_SUBTYPE_MEDIA_DOODLE, t))
                  } else Object(S.a)(e) || O.default.isPhotoStickerMessage(e) || i.push(d.toDomainFromTMessage(e, o.MSG_SUBTYPE_PHOTO, t));
                  break;
                case o.MSG_FILE:
                  s.push(l.toDomainFromMessage(e, t));
                  break;
                case o.MSG_CONTACT:
                  "recommened.link" === e.message.action && n.push(c.toDomainFromMessage(e, t));
                  break;
                case o.MSG_VIDEO:
                  i.push(d.toDomainFromTMessage(e, o.MSG_SUBTYPE_MEDIA_VIDEO, t))
              }
            }));
            let m = [];
            return i.length > 0 && m.push(this.getMediaRepository("image").insertMulti(i).then((e => {
              if (e.success.length) {
                const t = e.success.map((e => this.getMediaMapper("image").toMediaToCreateOrUpdateUtilsMediaDTOFromDomain(e)));
                this._utilsMediaManager.createOrUpdateFromMedias(t)
              }
            }))), s.length > 0 && m.push(this.getMediaRepository("file").insertMulti(s).then((e => {
              if (e.success.length) {
                const t = e.success.map((e => this.getMediaMapper("file").toMediaToCreateOrUpdateUtilsMediaDTOFromDomain(e)));
                this._utilsMediaManager.createOrUpdateFromMedias(t)
              }
            }))), n.length > 0 && m.push(this.getMediaRepository("link").insertMulti(n).then((e => {
              if (e.success.length) {
                const t = e.success.map((e => this.getMediaMapper("link").toMediaToCreateOrUpdateUtilsMediaDTOFromDomain(e)));
                this._utilsMediaManager.createOrUpdateFromMedias(t)
              }
            ...
            var i;
            const e = [null == s || null === (i = s.toString) || void 0 === i ? void 0 : i.call(s), null == s ? void 0 : s.stack].join("\n");
            this._logger.zsymb(21, "7Ad2kT", ["[_addMediasFromMessages] - error: {}", "gOdYZz"], e)
          }
        }
        async _addMediasAtExportImportFlowOldFlow(e) {
          ...
          const t = [],
            ...
            s = [];
          e.forEach((e => {
            if (e.msgType === o.MSG_FILE) i.push({
              msgId: e.msgId,
              userId: e.toUid,
              message: e.message,
              sendDttm: e.sendDttm,
            ...
            else if (e.msgType === o.MSG_CONTACT) "recommened.link" === e.message.action && s.push({
              msgId: e.msgId,
              userId: e.toUid,
              message: e.message,
              sendDttm: e.sendDttm,
            ...
            else if (e.msgType !== o.MSG_PHOTO && e.msgType !== o.MSG_PHOTO_2 && e.msgType !== o.MSG_DOODLE || Object(S.a)(e) || O.default.isPhotoStickerMessage(e)) e.msgType === o.MSG_VIDEO && t.push({
              msgId: e.msgId,
              userId: e.toUid,
              message: e.message,
              sendDttm: e.sendDttm,
              ...
              if (e.msgType === o.MSG_DOODLE) {
                const e = i.message.thumb || i.message.oriUrl;
                i.subType = o.MSG_SUBTYPE_MEDIA_DOODLE, i.message = Object(r.a)(Object(r.a)({}, i.message), {}, {
                  thumbUrl: e
                })
              }
              t.push(i)
            }
          })), i.length && _.default.addFilesToConversation(i), s.length && _.default.addLinksToConversation(s), t.length && _.default.addOrUpdateImagesToConversation(t)
        }
        async _addMediasFromMessagesWhenBackupOldFlow(e) {
          ...
          e.forEach((e => {
            ...
            else if (!(e.msgType !== o.MSG_PHOTO && e.msgType !== o.MSG_PHOTO_2 && e.msgType !== o.MSG_DOODLE || Object(S.a)(e) || O.default.isPhotoStickerMessage(e))) {
              let i = e.message;
              if (e.msgType === o.MSG_DOODLE) {
                const t = e.message.thumb || e.message.oriUrl;
                i = Object(r.a)(Object(r.a)({}, e.message), {}, {
                  thumbUrl: t
                })
              }
              t.push({
        ...
        async _emptyOldMediaStore(e, t) {
          const i = {
              from: [t, 0, ""],
              to: [t, o.MessageConstants.MAX_MSG_ID.length, o.MessageConstants.MAX_MSG_ID],
              excludeFrom: !1,
              excludeTo: !1
            },
            s = {
              index: "userId_sendDttm_msgId",
              direction: T.CursorDirection.PREV
            },
        ...
        async _emptyNewMediaStore(e, t) {
          const i = {
              from: [t, 0, ""],
              to: [t, parseInt(o.MessageConstants.MAX_SENDDTTM), o.MessageConstants.MAX_MSG_ID],
              excludeFrom: !1,
              excludeTo: !1
            },
            s = {
        ...
        async updateFile(e, t, i, s) {
          return Object(D.a)() ? this._updateMedia("file", e, t, i, s) : !!(await _.default.updateFile(t, i, s))
        }
        getMediaFromConversation(e, t, i, s, r) {
          if (!Object(D.a)()) return h.a.getMediaFromConversation({
            userId: t
          }, e, i, s, r);
          const a = e.substring(0, e.length - 1);
          return this.getValidMediasOfConv(a, t, i, s, r)
        }
        async deleteMediaWhenDeleteMsg(e, t, i) {
          if (!Object(D.a)()) return void _.default.deleteMediaItem(t);
          let s = "";
          if (null != i && i.mediaIdKeys) {
            const {
              cliMsgId: e,
              fromUid: t,
              convId: r
            ...
            s = `${e}_${t}_${r}`
          } else s = await this._mediaPrimaryKeyConvertor.toMediaPKFromMessagePK(e, t);
          this.deleteMediasById("", e, {
            newId: s,
            oldId: t
          })
        }
        async deleteMediaItems(e, t, i, s) {
          if (!i) return [];
          if (!Object(D.a)()) return h.a.deleteMediaItem(i, e);
          let r = [];
          r = null != s && s.mediaIdKeysArr && s.mediaIdKeysArr.length ? s.mediaIdKeysArr.map((e => `${e.cliMsgId}_${e.fromUid}_${e.convId}`)) : await Promise.all(i.map((e => this._mediaPrimaryKeyConvertor.toMediaPKFromMessagePK(t, e))));
          const a = i.map(((e, t) => ({
            oldId: e,
            newId: r[t]
          })));
        ...
        async addLinksToConversation(e) {
          Object(D.a)() ? this.addMedias("link", e) : _.default.addLinksToConversation(e)
        }
        async getFilesFromConversation(e, t, i) {
          return Object(D.a)() ? this.getValidMediasOfConv("file", e, t, i, null) : _.default.getFilesFromConversation({
            userId: e
          }, t, i)
        }
        async addMediasWhenTransferMessage(e, t, i) {
          return i ? this._addMediasFromMessages(e, t) : this._addMediasWhenTransferMessageOldFlow(e)
        }
        async addMediasAtExportImportFlow(e, t) {
          return Object(D.a)() ? this._addMediasFromMessages(e, t) : this._addMediasAtExportImportFlowOldFlow(e)
        }
        async addMediasFromMessagesWhenBackup(e, t) {
          return Object(D.a)() ? this._addMediasFromMessages(e, t) : this._addMediasFromMessagesWhenBackupOldFlow(e)
        }
        async deleteImageByMsgId(e, t, i) {
          if (!Object(D.a)()) return _.default.deleteImageByMsgId(t);
          let s = "";
          return s = null != i && i.mediaIdKeys ? `${i.mediaIdKeys.cliMsgId}_${i.mediaIdKeys.fromUid}_${i.mediaIdKeys.convId}` : await this._mediaPrimaryKeyConvertor.toMediaPKFromMessagePK(e, t), await this.deleteMediasById("image", e, {
            newId: s,
            oldId: t
          }), !0
        }
        async doAddMediaToConversation(e, t) {
          return Object(D.a)() ? this.addMedias(e, t) : h.a.doAddMediaToConversation(t, e)
        }
        async updateMsgIdForRelativeMedia(e, t, i) {
          if (Object(D.a)()) {
            const s = (t, i, s) => {
              this.getMediaById(t, e, s).then((r => {
                r && (r.msgId = i, this.deleteMediasById(t, e, {
                  newId: void 0,
                  oldId: s
                }).then((() => {
                  this.addMedias(t, [r])
            ...
            s("file", t, i), s("image", t, i), s("link", t, i)
          } else {
            const e = (e, t, i) => {
                e.get(i).then((s => {
                  s && (s.msgId = t, e.delete(i).then((() => {
                    e.insert(s)
                  })))
                }))
              },
              s = b.default.getInstance();
            e(s.Core.File, t, i), e(s.Core.Image, t, i), e(s.Core.Link, t, i)
          }
        }
        async emptyMediaStores(e, t) {
          e && t && t.length && (Object(D.a)() ? t.forEach((t => {
        ...
        async addMediasFromOldDB(e, t) {
          ...
          if (s) {
            const i = t.reduce(((t, i) => {
              ...
              if (null !== (r = s[a]) && void 0 !== r && r[e]) {
                const r = i.msgId,
                  n = s[a][e].lastId;
                n && r && n < r && t.oldMediaEntitiesShouldAddToNewDB.push(i)
              } else t.oldMediaEntitiesShouldAddToNewDB.push(i);
              return t.oldMediaIdsShouldDeleteFromOldDB.push(i.msgId), t
            }), {
              oldMediaEntitiesShouldAddToNewDB: [],
              oldMediaIdsShouldDeleteFromOldDB: []
            });
            r = i.oldMediaEntitiesShouldAddToNewDB, a = i.oldMediaIdsShouldDeleteFromOldDB
          }
          const n = await i.correctMediasInOldDB(r, {
              saveBack: !1
            }),
        ...
        async getMediasFromOldDB(e, t, i) {
          ...
          return this.getMediaRepository(e).getOldDBTable().getAll(s, r)
        }
        async deleteMediasFromOldDB(e, t) {
          const i = this.getMediaRepository(e);
          return (await i.getOldDBTable().deleteMulti(t)).success
        }
        async deleteMediasFromOldDBByRange(e, t, i) {
          const s = {
              from: "",
              to: i,
              excludeFrom: !0,
            ...
            n = await a.getOldDBTable().getAllKey(s, r);
        ...
        async countTotalMediaInOldDB(e) {
          try {
            ...
            var t;
            const e = [null == i || null === (t = i.toString) || void 0 === t ? void 0 : t.call(i), null == i ? void 0 : i.stack].join("\n");
            return this._logger.zsymb(21, "fBMRxo", ["[countTotalMediaInOldDB] - error: {}", "fWKhF2"], e), 0
          }
        }
        async _testAddMedias(e, t = 50) {
          let i = [];
          const s = 2 * Date.now() + Math.round(1e5 * Math.random()) + 1e3,
          ...
          switch (e) {
            case "image":
              for (let e = 0; e < t; e++) {
                ...
                i.push({
                  ...
                  isExpired: !1,
                  isExpiredAll: !1,
                  subType: Math.round(Math.random()) ? o.MSG_SUBTYPE_PHOTO : o.MSG_SUBTYPE_MEDIA_VIDEO,
                  sendDttm: Date.now() + e,
                  ttl: 0,
                  localPath: null,
                  previewThumb: void 0,
            ...
            case "file":
              for (let e = 0; e < t; e++) {
                const t = a[Math.round(Math.random() * (a.length - 1))],
                  o = n[Math.round(Math.random() * (n.length - 1))],
                  d = s + e,
                  l = r + e;
                i.push({
                  userId: o,
          ...
          await (null == d ? void 0 : d.insertMulti(i))
        }
        _getMediaDB(e, t) {
          const i = b.default.getInstance();
          switch (e) {
            case "image":
              return t ? i.Media.Image : i.Core.Image;
            case "file":
              return t ? i.Media.File : i.Core.File;
            case "link":
              return t ? i.Media.Link : i.Core.Link
          }
        }
        _trackDBPerformance(e) {
          Object(F.b)().logInfo(F.a.LoadMedia, {
    ...
    "4ePI": function(e, t, i) {
      ...
      class h {
        ...
        insertMulti(e, t) {
          ...
          const i = [];
          return e.forEach((e => {
            e.cliMsgId && e.fromUid && e.convId ? (e.mediaId = `${e.cliMsgId}_${e.fromUid}_${e.convId}`, i.push(e)) : this.logger.zsymb(21, "vKezdL", ["[insertMulti]: media doesn't have valid key_from_to: {}_{}_{}", "Lvk_NU"], e.cliMsgId, e.fromUid, e.convId)
          })), this.dbTable.insertMulti(i, t)
        }
        async update(e, t) {
          if (!h.isNewMediaIdFormat(e)) throw Error("[update]: mediaId doesn't have new media id format!");
          return !!(await this.dbTable.update(e, t))
        }
        async updateMedia(e, t, i = d.c.UNKNOWN) {
          if (!e) throw Error("[updateMedia]: mediaIdObj is undefined!");
          const {
            newId: r,
            oldId: a
          } = e;
          if ((i === d.c.NEW || await this._isMigrationDone()) && r) return !!(await this.dbTable.update(r, t));
          if (i === d.c.OLD && a) {
            let e;
            if (t) {
              const i = this.getMediaMapper().toOldEAttsFromNewEAtts(t.value || {});
              return e = Object(s.a)(Object(s.a)({}, t), {}, {
        ...
        delete(e, t) {
          if (!h.isNewMediaIdFormat(e)) throw Error("[delete]: mediaId doesn't have new media id format!");
          return this.dbTable.delete(e, t)
        }
        deleteMulti(e, t) {
          if (!e || !e.length) throw Error("[deleteMulti]: mediaIds is undefined or empty!");
          if (e.some((e => !h.isNewMediaIdFormat(e)))) throw Error("[deleteMulti]: mediaIds contains an id which doesn't have new media id format!");
          return this.dbTable.deleteMulti(e, t)
        }
        async deleteMedia(e, t, i = d.a.UNKNOWN) {
          if (!e) throw Error("[deleteMedia]: mediaObj is undefined!");
          const {
            newId: s,
            oldId: r
          } = e;
          if ((i === d.a.NEW || await this._isMigrationDone()) && s) return this.dbTable.delete(s);
          if (i === d.a.OLD && r) return this.getOldDBTable().delete(r, t);
          {
            const e = [];
            s && e.push(this.dbTable.delete(s, t)), r && e.push(this.getOldDBTable().delete(r, t));
              ...
              o = async () => {
                try {
                  await this.deleteMedia({
                    newId: r,
                    oldId: a
                  }, t, n) && i.success.push(e)
                } catch (o) {
                  var s;
                  const t = [null == o || null === (s = o.toString) || void 0 === s ? void 0 : s.call(o), null == o ? void 0 : o.stack].join("\n");
                  this.logger.zsymb(18, "FTr-mv", t), i.fail.push(e)
                }
              };
            s.push(o)
          }
        ...
        async get(e, t) {
          if (!h.isNewMediaIdFormat(e)) throw Error("[get]: mediaId doesn't have new media id format!");
        ...
        async getMulti(e, t) {
          const {
            newIdFormats: i,
            oldIdFormats: s
          } = e.reduce(((e, t) => (h.isNewMediaIdFormat(t) && e.newIdFormats.push(t), e)), {
            newIdFormats: [],
            oldIdFormats: []
          });
          let r = [];
        ...
        async getMedia(e, t, i = d.b.UNKNOWN) {
          if (!e) throw Error("[getMedia]: mediaIdObj params is undefined!");
          const {
            newId: s,
            oldId: r
          } = e;
          if ((i === d.b.NEW || await this._isMigrationDone()) && s) return this.dbTable.get(s, t);
          if (i === d.b.OLD && r) {
        ...
        async getMultiMedias(e, t) {
          ...
          for (const {
            ...
            of e) s.push(this.getMedia({
            newId: r,
            oldId: a
          }, t, "number" == typeof n ? n : d.b.UNKNOWN));
          return i = (await Promise.allSettled(s)).map((e => "fulfilled" === e.status ? e.value : void 0)), i
        }
        getAll(e, t) {
        ...
        async getAllInOldDB(e, t) {
          ...
          return null != i && i.length ? i.map((e => this.getMediaMapper().toDomainFromOldDomain(e))) : []
        }
          ...
          if (!t.member || e.fromUid && e.fromUid === t.member) {
            ...
            if (t.name) {
              if (e.message.params && e.message.href) try {
                ...
                s = t.mediaTitle ? m.default.simpleStripVietnamese(t.mediaTitle) : m.default.simpleStripVietnamese(e.message.title), r = t.src
              } catch (i) {
                return m.default.logCoreError(i), !1
              }
              a = m.default.simpleStripVietnamese(t.name)
            }
            if (!t.name || a.length <= s.length && m.default.searchContent(s, a)) {
              let s = !1;
              if (t.ext && (s = o.fileExt[t.ext].some((t => {
                  if (!e.message.title) {
                    const t = n.a.decrypt(e.message, g.default.UIN, !1);
                    try {
                ...
                }))), !t.ext || s) return null == t.date.start && null == t.date.end || (e.sendDttm >= t.date.start ? e.sendDttm <= t.date.end : 0)
            }
          }
          return !1
        }
        async isExistedMedia(e) {
          ...
          if (e) {
            ...
            i && (t = !!(await this.dbTable.get(i))), s && !t && (t = !!(await this.getOldDBTable().get(s)))
          }
          return t
        }
        async getLastMediasOfConv(e, t, i = 100) {
          ...
          return n.length < i && !(await this._isMigrationDone()) && n.push(...await this.getLastMediasOfConvInOldDB(e, {
            msgId: a
          }, i - n.length)), n
        }
        async countMediaOfConv(e, t) {
          ...
          return i = await this.countMediaOfConvInNewDB(e, {
            from: {
              sendDttm: s.sendDttm,
              cliMsgId: s.cliMsgId
            },
          ...
          }), await this._isMigrationDone() || (i += await this.countMediaOfConvInOldDB(e, {
            from: {
              msgId: s.msgId
            },
            to: {
        ...
        async getMediasOfConv(e, t, i, s) {
          ...
          let a = [];
          if (r.default.load_media.optimize_mode && (a = await this._isMigrationDone() ? await this.getMediasOfConvOptimizeMode(e, t, i, s) : await this.getMediasOfConvOptimizeModeInMixedDB(e, t, i, s)), null != s && s.deletePointOfConv) {
            const {
              lastId: e,
              lastSendDttm: t,
              lastCliMsgId: i
            } = s.deletePointOfConv;
            return a.filter((s => !(e && s.msgId && s.msgId <= e) && (!(t && s.sendDttm <= t) && !(i && s.cliMsgId <= i))))
          }
          return a
        }
        async getMediasOfConvOptimizeModeInMixedDB(e, t, i, s) {
          let r = !1,
            a = !1;
          s && s.date && (null !== s.date.start || null !== s.date.end) && (r = !0);
          const n = [],
            {
              sendDttm: o,
              cliMsgId: d
            ...
            M = {
              index: "convId_sendDttm_cliMsgId",
              limit: i,
              direction: l.CursorDirection.PREV,
              useLGKeyRange: !0,
              predicate: e => {
                if (!e) return !1;
                if (!m.default.mapHasItem(e.content)) return !1;
                if (!c.a.instance.filterDBMessage(e)) return !1;
                let t = h.filterMedia({
                  message: e.content,
                  fromUid: e.fromUid,
                  sendDttm: e.sendDttm
                }, s);
                return 0 === t && (a = !0), !!t && (e.sendDttm > o && e.cliMsgId > d || (n.push(e), !1))
              },
              aborted: r ? () => a : void 0
            };
          try {
            let t = await this.dbTable.getAll(f, M);
            if (t.length < i) {
              ...
              })), n.length > 0 && a.push(...n), t.push(...a.slice(0, i - t.length))) : t.push(...r) : n.length > 0 && t.push(...n)
            }
            return t
          } catch (I) {
            const t = [e, this.mediaType, i, g, u, !!s].join("_");
            throw this.logger.zsymb(21, "tzSXMB", ["[getMediasOfConvOptimizeModeInMixedDB] errInfo: {}", "NEtm6U"], t), I
          }
        }
        async getSendDttmOfLatestMediaInOldDB(e) {
          ...
          return {
            sendDttm: "string" == typeof s[0].sendDttm ? parseInt(s[0].sendDttm) : s[0].sendDttm,
            cliMsgId: "" + (s[0].cliMsgId || 0)
          }
        }
        async getMediasOfConvOptimizeMode(e, t, i, s) {
          if (!e || !t || !i) throw Error(`[getMediasOfConvOptimizeMode]: convId: ${e}, lastItemOptions: ${JSON.stringify(t)}, limit: ${i} isn't valid!`);
          const {
            sendDttm: r,
            cliMsgId: a,
            msgId: n
          ...
          return o.length < i && !(await this._isMigrationDone()) && o.push(...await this.getMediasOfConvOptimizeModeInOldDB(e, {
            msgId: n
          }, i - o.length, s)), o
        }
        getMediasOfConvOptimizeModeInNewDB(e, t, i, s) {
          ...
          try {
            return this.dbTable.getAll(d, g)
          } catch (u) {
            const t = [e, this.mediaType, i, n, o, !!s].join("_");
            throw this.logger.zsymb(21, "nlfBaJ", ["[getMediasOfConvOptimizeModeInNewDB] errInfo: {}", "3Lyb_z"], t), u
          }
        }
        async getMediasOfConvOptimizeModeInOldDB(e, t, i, s) {
          ...
          try {
            ...
            throw this.logger.zsymb(21, "WxR2X2", ["[getMediasOfConvOptimizeModeInOldDB] errInfo: {}", "2OPoNi"], t), g
          }
        }
        ...
        async getLastMediasOfConvInOldDB(e, t, i) {
          ...
          return o.length > 0 ? o.map((e => Object(s.a)(Object(s.a)({}, this.getMediaMapper().toDomainFromOldDomain(e)), {}, {
            msgId: e.msgId
          }))) : []
        }
        correctMediasInOldDB(e, t = {
          ...
          return e && e.length ? new Promise((i => {
            let s = [],
              r = {},
              a = [];
            if (e.forEach((e => {
                if (e && e.msgId && e.sendDttm) {
                  ...
                  e.type && e.cliMsgId && !t ? a.push(e) : (s.push(e.msgId), r[e.msgId] = e)
                }
              })), !s.length) return i(a);
            {
              let n = "";
              const d = (e, t) => {
                  ...
                  return "" !== t.fromUid && null != t.fromUid ? (i = !0, e.fromUid = t.fromUid + "") : i = !1, {
                    isSuccess: i,
                    data: i ? e : null
                  }
                },
                l = e[0].userId;
              g.default.getConvMessagesByIdsInQueue(s, l).then((e => {
                const s = [],
                  n = [];
                if (e) {
                  for (let i in e)
                ...
                let o = a.concat(s);
                return o.sort(((e, t) => parseInt(t.sendDttm) - parseInt(e.sendDttm))), s.length && t.saveBack && this.deleteAndInsertInOldDB(s), n.length && this.getOldDBTable().deleteMulti(n), i(o)
              })).catch((e => i(a)))
            }
          })) : Promise.resolve([])
        }
        ...
        async _isMigrationDone() {
          return (await this._mediaMigrationManager.getMediaMigrationState()).stateName === u.b.DONE
        }
      }
    },
    "5R0e": function(e, t, i) {
    ...
    "7WMW": function(e, t, i) {
      ...
      i.d(t, "a", (function() {
        return s.a
      })), i.d(t, "b", (function() {})), i.d(t, "c", (function() {
        return a
      }));
    ...
    AjFa: function(e, t, i) {
      ...
      class m extends r.a {
        ...
        async getImageMessagesForPhotoViewer(e, t, i, r, a, n) {
          const d = await this.getMsgIdsOfImageMediaForPhotoViewer(e, i, t, r, a, n);
          if (null == d || !d.length) return [];
          const l = await Promise.all(d.map((e => this.getMediaMapper().toDTO(e)))),
            m = [];
          let g = [];
          for (const c of l) m.push(o.default.getInstance().Core.Message.get(c.msgId, {
            partition: e
          }).then((e => {
            e ? g.push(Object(s.a)(Object(s.a)({}, c), e)) : c.message && g.push(c)
          })));
          return await Promise.all(m), g.reverse(), c.default._fillExifBeforeShow(g), g
        }
        async getMsgIdsOfImageMediaForPhotoViewer(e, t, i, s, r, a) {
            ...
            p = e => {
              ...
              if (!a.member || e.fromUid && e.fromUid === a.member) {
                ...
                if (a.name) {
                  if (e.message.params && e.message.href) try {
                    let t = JSON.parse(e.message.params);
                    i = t.mediaTitle ? d.default.simpleStripVietnamese(t.mediaTitle) : d.default.simpleStripVietnamese(e.message.title), s = t.src
                  } catch (t) {
                    return this.logger.zsymb(18, "sj4E3Y", t), !1
                  }
                  r = d.default.simpleStripVietnamese(a.name)
                }
                if (!a.name || d.default.searchContent(i, r) || d.default.searchContent(s, r)) {
                  let t = !1;
                  if (a.ext && (t = l.fileExt[a.ext].some((t => e.message.title.endsWith(t)))), !a.ext || t) return !a.date.start || !a.date.end || (a.date.end < e.sendDttm ? e.sendDttm < a.date.start + 864e5 : (u = !0, !1))
                }
              }
              return !1
            };
          ...
          if (s) {
            const t = async () => {
              ...
              if (!(await this._isMigrationDone())) {
                const s = {
                    from: [e, m.length, m],
                    to: [e, l.MessageConstants.MAX_MSG_ID.length, l.MessageConstants.MAX_MSG_ID],
                    excludeFrom: !g,
                    excludeTo: !g
                  },
                  r = {
              ...
              if (t.length < i) {
                const s = {
                    from: [e, c, o],
                    to: [e, parseInt(l.MessageConstants.MAX_SENDDTTM), l.MessageConstants.MAX_MSG_ID],
                    excludeFrom: !g,
                    excludeTo: !g
                  },
                  r = {
          ...
          if (r) {
            const t = async () => {
              ...
              if (t = await this.getAll(s, r), t.length < i && !(await this._isMigrationDone())) {
                const s = {
                    from: [e, 0, ""],
                    to: [e, m.length, m],
                    excludeFrom: !g,
          ...
          try {
            ...
            return this.logger.zsymb(18, "Wp5MK8", M), []
          }
        }
      }
    ...
    Ceyj: function(e, t, i) {
      ...
      function a(e, t) {
        return e.reduce(((e, i, s, r) => (e[t(i, s, r) ? 0 : 1].push(i), e)), [
          [],
          []
        ])
      }
      ...
      Object(l.singleton)(c.a)(n = Reflect.metadata("design:type", Function)(n = Reflect.metadata("design:paramtypes", [])(n = class {
        constructor() {
          this._logger = void 0, this.dispose = () => {}, this.correctTTLItemEntity = e => {
            ...
            return i.beginTime = t(i.beginTime, 0), i.cliMsgId = t(i.cliMsgId, ""), i.expireOn = t(i.expireOn, Date.now()), i.fromUid = t(i.fromUid, ""), i.mediaType = t(i.mediaType, ""), i.msgId = t(i.msgId, ""), i.sendDttm = t(i.sendDttm, "") + "", i.serverTime = t(i.serverTime, "") + "", i.toUid = t(i.toUid, ""), i.ttl = t(i.ttl, 0), i.ttlType = t(i.ttlType, ""), i
          }, this._safePut = async e => {
            const t = [],
              i = [],
              s = r.default.getInstance();
            for (const r of e) try {
              const e = this.correctTTLItemEntity(r);
              await s.MsgInfo.TTLItem.insert(e, {
                replace: !0
              }), t.push(r)
            } catch (a) {
              i.push([r, a])
            ...
            let t = e.map((e => f(e)));
            const [i, s] = a(t, (e => e.ok)), r = i.map((e => e.value));
            let n = [],
              o = [];
            ...
            const i = t ? {
                ...
                to: [e, d.MessageConstants.MAX_CONVERSATION_ID, u],
                excludeFrom: !1,
                excludeTo: !0
              } : {
                to: [e],
            ...
            return await a.MsgInfo.TTLItem.getAll(i, s)
            ...
            const t = g.b.messageCache;
            let i;
            return t && (i = await t.getMappedMessagesByConvIdAsync(e)), i
          }, this._logger = l.ModuleContainer.resolve(m.ZLoggerFactory).createZLogger("utils", ["ttl", "destructor", "ttl"])
        }
      }) || n) || n);
      const h = e => "number" == typeof e ? String(e) : e,
        p = [o.a.Message, o.a.Quote],
        f = (e = {}) => {
          const t = Object(s.a)({}, e);
          return t.cliMsgId = h(t.cliMsgId), t.cliMsgId ? (t.fromUid = h(t.fromUid), t.fromUid ? (t.toUid = h(t.toUid), t.toUid ? (t.msgId = h(t.msgId), i = t.ttlType, p.includes(i) ? (t.expireOn = +t.expireOn, "number" != typeof t.expireOn ? {
            ok: !1,
            error: e
          } : {
            ok: !0,
      ...
      Object(o.b)(d)(s = class {
        ...
        insertTask(e, t) {
          this.taskIds.length > 20 && (this.taskIds = this.taskIds.slice(1)), this.taskIds = [...this.taskIds, e], this.tasks.set(e, {
            ...
            progress: 0,
            status: "running"
          }), Object(n.h)(this.name, "all")
        }
        updateTaskProgress(e, t) {
          const i = this.tasks.get(e);
          i && (this.tasks.set(e, Object(r.a)(Object(r.a)({}, i), {}, {
            progress: t
          })), Object(n.g)(this.name, e))
        }
    ...
    Hbak: function(e, t, i) {
      ...
      var s, r = i("jDHv"),
        ...
        o = i("ClHk"),
        d = i("Mgpg");
      Object(a.j)()(s = Object(r.singleton)(n.a)(s = Object(r.injectable)()(s = function(e, t) {
        return Object(r.inject)(d.ZLoggerFactory)(e, void 0, 0)
      }(s = Reflect.metadata("design:type", Function)(s = Reflect.metadata("design:paramtypes", [void 0 === d.ZLoggerFactory ? Object : d.ZLoggerFactory])(s = class {
        constructor(e) {
        ...
        onStart() {
          this.logger.zsymb(3, "lrxuQI", ["start", "WxrJ0m"]), $zsharedWorker.start(), $zsub.$zsharedWorker.onRequestRunTask((async (e, t) => {
            var i;
            const s = this.handlers.get(t.type);
            if (!s) return;
            null === (i = this.monitor) || void 0 === i || i.insertTask(t.id, t.type), this.logger.zsymb(3, "if0B4o", ["{} id: {}", "hzOVUf"], t.type, t.id);
            ...
            this.runningMap.set(a, n), this.logger.zsymb(3, "ewCPc_", ["{} id: {} start", "TKyvNa"], t.type, t.id);
            try {
              const e = (e, i) => {
                var s;
                $zsharedWorker.updateProgress({
                  ...
                  progress: e,
                  checkpoint: i
                }), null === (s = this.monitor) || void 0 === s || s.updateTaskProgress(t.id, e)
              };
              await s.execute({
                abort: r.signal,
                params: t.params,
                ...
                var i;
                r.signal.aborted || (null === (i = this.monitor) || void 0 === i || i.updateTaskStatus(t.id, "finished"), $zsharedWorker.responseResult({
                  id: a,
                  result: e
                }), this.logger.zsymb(3, "7xCxi_", ["{} id: {} finished", "zlX2wc"], t.type, t.id))
              })).catch((e => {
                var i;
                if (r.signal.aborted) return;
                null === (i = this.monitor) || void 0 === i || i.updateTaskStatus(t.id, "error");
                const s = "number" == typeof e.error ? e.error : -999;
                ...
                }), this.logger.zsymb(0, "tjVCHc", (() => [`task ${t.type} id: ${t.id} failed`, {
                  error: e
                }]))
              }))
            } catch (d) {
              ...
              }), this.logger.zsymb(0, "cI_n-t", (() => [`task ${t.type} id: ${t.id} failed`, {
                error: d
              }]))
            }
            ...
            var s;
            i && (null === (s = this.monitor) || void 0 === s || s.updateTaskStatus(t.id, "error"), i.abort.abort());
            this.logger.zsymb(3, "xyw0y_", ["abort task {} id: {}", "HP1Vgm"], t.type, t.id)
          })), $zsub.$zsharedWorker.onRequestUpdateTaskParams(((e, t) => {
            const i = this.runningMap.get(t.id);
            if (i) return i.updateParams(t.params), void this.logger.zsymb(3, "Y2sx_2", ["{} id: {} - updated params", "FJnn95"], t.type, t.id);
            this.logger.zsymb(18, "b7JW_S", `${t.type} id: ${t.id} - update params failed. task not found`)
          }));
          const e = () => {
            $zFileManager.cleanupLogFileDescriptors(), $zsub.$zsharedWorker.removeListenUnloadZLog(e)
          };
          $zsub.$zsharedWorker.onUnloadZLog(e), "shared-worker" === __ZaBUNDLENAME__ && this.startCheckAlive()
        }
        registerHandler(e, t) {
          this.logger.zsymb(3, "3BO7MV", ["register handler: {}", "L0LS1a"], e), this.handlers.set(e, t), $zsharedWorker.register(e)
        }
        startCheckAlive() {
          this.logger.zsymb(3, "5z36eb", ["start check alive", "6XGRLT"]), setInterval((() => {
            this.logger.zsymb(3, "Y1huno", ["sending ping", "k-3kRl"]), $zsharedWorker.ping()
          }), 6e4)
        }
      }) || s) || s) || s) || s) || s)
    },
      ...
      class r {
        ...
        getTracker() {
          ...
          return {
            ...
            doAsync: (t, ...i) => (this.start(e), t(...i).then((t => (this.end(e), t)))),
            reset: () => {
              this.data.delete(e)
            }
          }
        ...
        start(e) {
          ...
          if (t) {
            let i = t.start;
            t.counting <= 0 && (i = Date.now()), this.data.set(e, Object(s.a)(Object(s.a)({}, t), {}, {
          ...
          if (t) {
            ...
            t.counting && t.counting > 1 && (i = Date.now()), this.data.set(e, Object(s.a)(Object(s.a)({}, t), {}, {
              time: r,
              start: i,
              counting: t.counting - 1
            }))
    ...
    KszJ: function(e, t, i) {
      ...
      var s, r = i("jDHv"),
        ...
        o = i("Mgpg"),
        d = i("/n5c");
      Object(a.j)()(s = Object(a.h)()(s = Object(r.injectable)()(s = Object(r.singleton)(n.a)(s = function(e, t) {
        return Object(r.inject)(o.ZLoggerFactory)(e, void 0, 0)
      }(s = Reflect.metadata("design:type", Function)(s = Reflect.metadata("design:paramtypes", [void 0 === o.ZLoggerFactory ? Object : o.ZLoggerFactory])(s = class {
        constructor(e) {
        ...
        onStart() {
          $zsub.$zsharedWorker.onReceiveUpdateProgress(((e, t) => {
            ...
            i ? i.notifyProgressChange(t.progress, t.checkpoint) : $zsharedWorker.abortTask({
              id: t.id
            })
          })), $zsub.$zsharedWorker.onReceiveResult(((e, t) => {
            const i = this.runningTasks.get(t.id);
            i ? (this.logger.zsymb(3, "gfdtdu", ["resolve:{} id: {} success:{}", "pNCrBT"], i.type, t.id, !t.error), t.error ? i.notifyError(t.error) : i.notifyResult(t.result, t.checkpoint), this.runningTasks.delete(t.id)) : this.logger.zsymb(18, "Vs-rVP", (() => ["not found resolver for task", {
              id: t.id
            }]))
          }));
          const e = async () => {
        ...
        run(e) {
          ...
          e.id = t, this.runningTasks.set(t, e), this.logger.zsymb(3, "chrj72", ["run:{} id: {}", "uVx8I-"], e.type, t), $zsharedWorker.runTask(e.toDescriptor())
        }
        abort(e) {
          this.runningTasks.get(e) && (this.runningTasks.delete(e), $zsharedWorker.abortTask({
            id: e
          }))
        }
        notifyChangeParams(e, t) {
          const i = this.runningTasks.get(e);
          if (!i) throw new Error(`not found task with id: ${e}`);
          const s = {
            id: e,
            type: i.type,
            params: t
          };
          $zsharedWorker.updateTaskParams(s)
        }
      }) || s) || s) || s) || s) || s) || s)
    },
    "Q/Ir": function(e, t, i) {
      ...
      setTimeout((async function() {
        if (l) return;
        const e = s.ModuleContainer.resolve(a.ZLoggerFactory).createZLogger("bootstrap", ["shared"]);
        e.zsymb(3, "aAhUkC", ["running application bootstrap", "F9lM3W"]);
        let t = (() => {
        ...
        try {
          const i = s.ModuleContainer.resolve(r.a);
          await i.start(), Object(n.a)(t), t === o.RunMode.Browser && Object(d.b)(), "shared-worker" === __ZaBUNDLENAME__ && await i.init(), e.zsymb(3, "q-ylI-", ["application bootstrap success", "FU-L8m"])
        } catch (i) {
          e.zsymb(0, "XdmVWp", (() => ["application bootstrap fail", {
            reason: i
          }]))
        }
      }), 0)
    ...
    W13p: function(e, t, i) {
      ...
      class n extends s.a {
        ...
        async getLastestAddedFiles(e, t) {
          ...
          return i.length < t && !(await this._isMigrationDone()) && i.push(...await this.getLastestAddedFilesInOldDB({
            sendDttm: e.sendDttm
          }, t - i.length)), i
        }
        ...
        async getLastestAddedFilesInOldDB(e, t) {
          ...
          return i.length > 0 ? i.map((e => this.getMediaMapper().toDomainFromOldDomain(e))) : []
        }
      }
    ...
    nhJq: function(e, t, i) {
      ...
      let s = $znode.rimraf,
        r = $znode.fs;
      async function a(e) {
        if (await o(e)) return new Promise(((t, i) => {
          s(e, (e => {
            e ? i(e) : t()
          }))
        }))
      ...
      async function n(e) {
        return e.endsWith("/") || (e += "/"), await o(e) ? e : new Promise(((t, i) => {
          r.mkdir(e, (s => {
            s ? i(s) : t(e)
          }))
        }))
    ...
    oqw1: function(e, t, i) {
      ...
      var s, r = i("jDHv"),
        ...
        o = i("drXQ"),
        d = i("Hw41");
      let l = r.ModuleContainer.injectable()(s = class {
    ...
    rBRb: function(e, t, i) {
      ...
      var s, r = i("jDHv"),
        a = i("fsN4"),
        n = i("KPNQ");
      let o = Object(r.injectable)()(s = class {
        async toMediaPKFromMessagePK(e, t) {
          if (!t) return "";
          const i = await a.default.getInstance().Core.Message.get(t, {
            partition: e
          });
          return i && (i.cliMsgId || i.fromUid || i.toUid) ? `${i.cliMsgId}_${i.fromUid}_${i.toUid}` : ""
        }
        ...
        _getMessagesByCliMsgIdRange(e, t) {
          ...
          return a.default.getInstance().Core.Message.getAll(i, s)
        }
      ...
      var l, c = i("RgQf"),
        m = i("MLPV"),
        g = i("J/8C");
      let u = Object(r.injectable)()(l = class {
      ...
      let _ = Object(r.injectable)()(h = class {
        toDomainFromOldDomain(e, t = `${f.c.UNKNOWN}${f.d.FROM_OLD_DB}`) {
          ...
          return {
            ...
            metadata: Object(p.a)(Object(p.a)({}, b(e.message.params)), {}, {
              vOrient: M.a.None
            })
          }
        }
        toDomainFromDTO(e) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.userId) {
            ...
            const t = {
              ...
              i = `This imageDTO doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
        ...
        toDomainFromTMessage(e, t, i = `${f.c.UNKNOWN}${f.d.FROM_MSG}`) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.toUid) {
            ...
            const t = {
              ...
              i = `This messageEntity doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
        ...
        async toDTO(e, t = !0) {
          ...
          const i = e.msgId ? e.msgId : t ? await r.ModuleContainer.resolve(n.b).toMessagePKFromMediaPK(e.mediaId) : "";
          return {
            mediaId: e.mediaId,
            msgId: i,
            cliMsgId: e.cliMsgId,
      ...
      let D = Object(r.injectable)()(O = class {
        toDomainFromOldDomain(e, t = `${f.c.UNKNOWN}${f.d.FROM_OLD_DB}`) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.userId) {
            ...
            const t = {
              ...
              i = `This oldFileEntity doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
          const i = "string" == typeof e.sendDttm ? parseInt(e.sendDttm) : e.sendDttm,
            s = "number" == typeof e.fromUid ? e.fromUid.toString() : e.fromUid;
          return {
            ...
            type: I(e.message.params) ? f.a.FOLDER : f.a.FILE,
            src: t,
        ...
        toDomainFromDTO(e) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.userId) {
            ...
            const t = {
              ...
              i = `This fileDTO doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
          const t = "string" == typeof e.sendDttm ? parseInt(e.sendDttm) : e.sendDttm,
            i = "number" == typeof e.fromUid ? e.fromUid.toString() : e.fromUid;
          return {
            ...
            type: e.fileType || I(e.message.params) ? f.a.FOLDER : f.a.FILE,
            src: e.src,
        ...
        toDomainFromMessage(e, t = `${f.c.UNKNOWN}${f.d.FROM_MSG}`) {
          ...
          const i = "string" == typeof e.sendDttm ? parseInt(e.sendDttm) : e.sendDttm,
            s = "number" == typeof e.fromUid ? e.fromUid.toString() : e.fromUid;
          return {
            mediaId: `${e.cliMsgId}_${s}_${e.toUid}`,
            convId: e.toUid,
            cliMsgId: "number" == typeof e.cliMsgId ? e.cliMsgId.toString() : e.cliMsgId,
            fromUid: s,
            content: {
      ...
      let v = Object(r.injectable)()(T = class {
        toDomainFromOldDomain(e, t = `${f.c.UNKNOWN}${f.d.FROM_OLD_DB}`) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.userId) {
            ...
            const t = {
              ...
              i = `This oldLinkEntity doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
          const i = "string" == typeof e.sendDttm ? parseInt(e.sendDttm) : e.sendDttm,
            s = "number" == typeof e.fromUid ? e.fromUid.toString() : e.fromUid;
        ...
        toDomainFromDTO(e) {
          ...
          if (!e.cliMsgId || "0" != e.fromUid && !e.fromUid || !e.userId) {
            ...
            const t = {
              ...
              i = `This linkDTO doesn't have key_from_to valid: ${JSON.stringify(t)}`;
            throw Error(i)
          }
          const t = "string" == typeof e.sendDttm ? parseInt(e.sendDttm) : e.sendDttm,
            i = "number" == typeof e.fromUid ? e.fromUid.toString() : e.fromUid;
        ...
        toNewEAttsFromDTOAtts(e) {
          ...
          e.hasOwnProperty("message") && "object" == typeof e.message && (t.content = {
            title: "object" == typeof e.message.title ? (null === (i = e.message.title) || void 0 === i ? void 0 : i.title) || "" : e.message.title || "",
            params: e.message.params || "",
            href: e.message.href || "",
            thumb: e.message.thumb || "",
            description: e.message.description || "",
      ...
      r.ModuleContainer.register(g.b, v);
      var w, E = i("AjFa"),
        U = i("Mgpg"),
        S = i("H8Z7");
      Object(r.injectable)()(w = Object(r.singleton)(E.b)(w = function(e, t) {
        ...
        return Object(r.inject)(S.c)(e, void 0, 1)
      }(w = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 2)
      }(w = Reflect.metadata("design:type", Function)(w = Reflect.metadata("design:paramtypes", [void 0 === m.IImageMediaMapper ? Object : m.IImageMediaMapper, void 0 === S.IMediaMigrationManager ? Object : S.IMediaMigrationManager, void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(w = class extends E.a {
        constructor(e, t, i) {
          super("Media", "Image", "image", "crud-image-media", t, i), this.imageMediaMapper = void 0, this.oldDBTable = void 0, this.imageMediaMapper = e, this.oldDBTable = this._dalInstance.Core.Image
        }
        getOldDBTable() {
      ...
      var F, j = i("W13p");
      Object(r.injectable)()(F = Object(r.singleton)(j.b)(F = function(e, t) {
        return Object(r.inject)(c.a)(e, void 0, 0)
      }(F = function(e, t) {
        return Object(r.inject)(S.c)(e, void 0, 1)
      }(F = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 2)
      }(F = Reflect.metadata("design:type", Function)(F = Reflect.metadata("design:paramtypes", [void 0 === c.IFileMediaMapper ? Object : c.IFileMediaMapper, void 0 === S.IMediaMigrationManager ? Object : S.IMediaMigrationManager, void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(F = class extends j.a {
        constructor(e, t, i) {
          super("Media", "File", "file", "crud-file-media", t, i), this.fileMediaMapper = void 0, this.oldDBTable = void 0, this.fileMediaMapper = e, this.oldDBTable = this._dalInstance.Core.File
        }
        getOldDBTable() {
      ...
      var N, C = i("5R0e");
      Object(r.injectable)()(N = Object(r.singleton)(C.b)(N = function(e, t) {
        return Object(r.inject)(g.b)(e, void 0, 0)
      }(N = function(e, t) {
        return Object(r.inject)(S.c)(e, void 0, 1)
      }(N = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 2)
      }(N = Reflect.metadata("design:type", Function)(N = Reflect.metadata("design:paramtypes", [void 0 === g.ILinkMediaMapper ? Object : g.ILinkMediaMapper, void 0 === S.IMediaMigrationManager ? Object : S.IMediaMigrationManager, void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(N = class extends C.a {
        constructor(e, t, i) {
          super("Media", "Link", "link", "crud-link-media", t, i), this.linkMediaMapper = void 0, this.oldDBTable = void 0, this.linkMediaMapper = e, this.oldDBTable = this._dalInstance.Core.Link
        }
        getOldDBTable() {
      ...
      class L {
        constructor(e) {
          this._lruCache = void 0, this._lruCache = new B.default(e)
        }
        get(e) {
      ...
      Object(r.injectable)()(P = Object(r.singleton)(k.c)(P = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 0)
      }(P = Reflect.metadata("design:type", Function)(P = Reflect.metadata("design:paramtypes", [void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(P = class extends A.b {
        constructor(e) {
        ...
        async _saveValueOnField(e, t, i) {
          const s = this._cache.get(e) || await this._dbCollection.get(e);
          if (s) {
            s[t].some((e => e === i)) || (s[t].push(i), await this.update(e, {
              value: {
                [t]: s[t]
              },
              attributes: [t]
        ...
        async _saveValuesOnField(e, t, i) {
          ...
          if (s) {
            ...
            r.length && (s[t].push(...r), await this.update(e, {
              value: {
                [t]: s[t]
              },
              attributes: [t]
        ...
        async _deleteValueOnField(e, t, i) {
          const s = this._cache.get(e) || await this._dbCollection.get(e);
          if (s) {
            const r = s[t].indexOf(i); - 1 !== r && (s[t].splice(r, 1), await this.update(e, {
              value: {
                [t]: s[t]
              },
              attributes: [t]
        ...
        async _deleteValuesByField(e, t, i) {
          ...
          if (s) {
            ...
            r.length < s[t].length && (s[t] = r, await this.update(e, {
              value: {
                [t]: r
              },
              attributes: [t]
        ...
        async _getItemListByField(e, t, i = !0) {
          ...
          var a;
          if (i) return r && null !== (a = r[t]) && void 0 !== a && a.length ? r[t].slice() : [];
          const n = await this._dbCollection.get(e);
          return n && !r && this._cache.set(e, Object(p.a)({}, n)), n && null !== (s = n[t]) && void 0 !== s && s.length ? n[t].slice() : []
        }
      }) || P) || P) || P) || P);
      var R, x = i("SrDO"),
        $ = i("fhp4");
      Object(r.injectable)()(R = Object(r.singleton)(x.b)(R = class {
        getMediaMapper(e) {
          switch (e) {
            case "image":
              return r.ModuleContainer.resolve($.c);
            case "file":
              return r.ModuleContainer.resolve($.a);
            case "link":
              return r.ModuleContainer.resolve($.d);
            default:
              return
          }
        }
      ...
      var z, J = i("3dEI");
      Object(r.injectable)()(z = Object(r.singleton)(J.b)(z = class {
      ...
      const K = "utils-media-domain-service",
        G = Object(r.define)(K);
      var W, V = i("5txd");
      Object(r.injectable)()(W = Object(r.singleton)(G)(W = function(e, t) {
        return Object(r.inject)(k.c)(e, void 0, 0)
      }(W = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 1)
      }(W = Reflect.metadata("design:type", Function)(W = Reflect.metadata("design:paramtypes", [void 0 === k.b ? Object : k.b, void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(W = class {
        constructor(e, t) {
          this._log = void 0, this._logger = void 0, this._utilsMediaRepository = void 0, this._utilsMediaRepository = e, this._logger = t.createZLogger(`${K}`, ["mn-utils-media-de"]), this._log = Object(V.a)(this._logger)
        }
        async create(e) {
        ...
        addFileTypes(e, t) {
          if (!e) throw Error("[addFileTypes] utilsMediaEntity isn't existed!");
          if (!t || !t.length) return Object(p.a)({}, e);
          const i = Object(p.a)(Object(p.a)({}, e), {}, {
      ...
      var Z, H = i("mvkY"),
        X = i("jbAT");
      Object(r.injectable)()(Z = Object(r.singleton)(X.b)(Z = function(e, t) {
        return Object(r.inject)(G)(e, void 0, 0)
      }(Z = function(e, t) {
        return Object(r.inject)(k.c)(e, void 0, 1)
      }(Z = function(e, t) {
        return Object(r.inject)(d)(e, void 0, 2)
      }(Z = function(e, t) {
        return Object(r.inject)(U.ZLoggerFactory)(e, void 0, 3)
      }(Z = Reflect.metadata("design:type", Function)(Z = Reflect.metadata("design:paramtypes", [Object, void 0 === k.b ? Object : k.b, Object, void 0 === U.ZLoggerFactory ? Object : U.ZLoggerFactory])(Z = class {
        constructor(e, t, i, s) {
          this._utilsMediaDomainService = void 0, this._utilsMediaRepository = void 0, this._mapper = void 0, this._logger = void 0, this._log = void 0, this._utilsMediaDomainService = e, this._utilsMediaRepository = t, this._mapper = i, this._logger = s.createZLogger(H.b, ["manage-utils-media-in-app"]), this._log = Object(V.a)(this._logger)
        }
        async create(e) {
          try {
        ...
        async createOrUpdate(e) {
          try {
            ...
            let i = await this._utilsMediaRepository.get(t);
            if (i) {
              const {
                senderIds: s,
                fileTypes: r
              ...
              let a = i.senderIds,
                n = i.fileTypes;
              if (s && s.length && (a = this._utilsMediaDomainService.addSenders(i, s).senderIds), r && r.length && (n = this._utilsMediaDomainService.addFileTypes(i, r).fileTypes), a.length !== i.senderIds.length || n.length !== i.fileTypes.length) {
              ...
              return this._mapper.toUtilsMediaDTOFromDomain(i)
            }
          ...
          try {
            ...
            e.forEach((e => {
              ...
              if ("image" === e.mediaType || "link" === e.mediaType)
                if (i) {
                  -1 === i.senderIds.indexOf(e.fromUid) && (i.senderIds.push(e.fromUid), t.set(e.convId, i))
                } else i = {
                  convId: e.convId,
                  mediaType: e.mediaType,
                  senderIds: [e.fromUid],
                ...
                const s = this._getFileType(e.content.params);
                if (i) {
                  -1 === i.fileTypes.indexOf(s) && (i.fileTypes.push(s), t.set(e.convId, i))
                } else i = {
                  convId: e.convId,
                  mediaType: e.mediaType,
                  senderIds: [e.fromUid],
            ...
            return (await Promise.all(i.map((e => this.createOrUpdate(e))))).filter(Boolean)
          } catch (t) {
        ...
        _getFileType(e) {
          try {
            ...
            return "zip" === i && 2 === s ? "folder" : i.toLowerCase()
          } catch (t) {
      ...
      Object(r.injectable)()(Q = Object(r.singleton)(q)(Q = class {
        constructor() {
          this._localStorage = Y.default.getInstance()
        }
          ...
          for await (const {
            ...
            function*(e) {
              ...
              const n = null !== (t = null == e ? void 0 : e.retries) && void 0 !== t ? t : 3,
                o = null !== (i = null == e ? void 0 : e.min) && void 0 !== i ? i : 100,
                d = null !== (s = null == e ? void 0 : e.max) && void 0 !== s ? s : 1e4,
                l = null !== (r = null == e ? void 0 : e.step) && void 0 !== r ? r : 2,
                c = null !== (a = null == e ? void 0 : e.jitter) && void 0 !== a ? a : 0;
              if (o <= 0) throw new be(ye.INVALID_CONFIG_MIN);
              if (c < 0 || c > 1) throw new be(ye.INVALID_CONFIG_JITTER);
              let m = 0;
              for (; m <= n;) {
                const e = _e({
                  nTry: m,
            ...
            if (null != t && t.afterRetry && (null == t || t.afterRetry({
                ...
                shouldRetry: o,
                success: !1
              })), !o) throw new be(ye.RETRY_ON_ERROR_CONDITION_FAIL);
            await r()
          }
          throw new be(ye.MAX_RETRY)
        }
      }
      var De;
      const Te = new de.a,
      ...
      Object(te.d)()(De = Object(r.injectable)()(De = Object(r.singleton)(S.c)(De = function(e, t) {
        ...
        pauseMigration(e) {
          this._logger.zsymb(3, "kK74Tg", ["[mm] pause migration - reason: {}", "_PgAln"], e), this.flushHoldingJobs(), this._forceStop = !0, this._worker.pause()
        }
        async resumeMigration(e) {
          this._logger.zsymb(3, "4q4F-c", ["[mm] resume migration - reason: {}", "2MJ_Q9"], e), this._forceStop = !1, Object(Ie.a)() && !me() && (this._isLoadData || await this._loadData(), this._currentJobDescs.forEach((e => {
            if (e.state === ee.a.FAILED) {
              e.state = ee.a.NEW;
              const t = this._createJob(e);
              if (t) {
                const i = this._scheduleJob(e.id, t);
                this._worker.add(i, {
                  priority: ve
                })
              }
        ...
        _createJob(e) {
          ...
          return this._updateStateOfCurrentJobByJobId(t, ee.a.RUNNING), re(i) ? this._createJobFromGetFromOldDBCurrentStep(t, i) : ae(i) ? this._createJobFromAddToNewDBCurrentStep(t, i) : ne(i) ? this._createJobFromDeleteFromOldDBCurrentStep(t, i) : void 0
        }
            ...
            try {
              await this._withRetry((async () => {
                ...
                if (this._logger.zsymb(3, "lJXeB-", ["[mm] getFromOldDBStep - DONE - jobId: {}, {}", "n76TNc"], e, o.length), o.length >= r ? this._currentMsgIdCursor = o[o.length - 1].msgId : this._mediaMigrationState && this._mediaMigrationState.mediaTableNamesToMigrate.length && (this._mediaMigrationState.mediaTableNamesToMigrate.shift(), this._currentMsgIdCursor = oe.MessageConstants.MAX_MSG_ID), this._runMigration(), o.length) {
                  ...
                  const i = this._createJobFromAddToNewDBCurrentStep(e, t);
                  await i()
                }
              }))()
            } catch (t) {
              this._logger.zsymb(3, "Ruz9sG", ["[mm] throw error from get from old DB step - jobId: {}, {}", "vQ3cCD"], e, null == t ? void 0 : t.message)
            }
          }
        }
          ...
          return async () => {
            try {
              await this._withRetry((async () => {
                ...
                if (!i) return void this._logger.zsymb(18, "jSzHFJ", "[mm] addToNewDBStep is undefined!");
                const n = await i();
                if (n.state === ee.e.FAILED) throw n.data.jobId = e, n.data.jobType = "ADD_TO_NEW_DB", n.data;
                const {
                  data: o
                } = n;
                if (this._logger.zsymb(3, "nuy9hr", ["[mm] addToNewDBStep - jobId: {}, {}", "X0dfnc"], e, o.length), o.length) {
                  const t = {
                  ...
                  this._updateCurrentStepByJobId(e, t);
                  const i = this._createJobFromDeleteFromOldDBCurrentStep(e, t);
                  await i()
                }
              }))()
            } catch (i) {
              this._logger.zsymb(3, "a_por3", ["[mm] throw error from add to new DB step - jobId: {}, {}", "UFr4Pr"], e, null == i ? void 0 : i.message)
            }
          }
        }
          ...
          return async () => {
            try {
              await this._withRetry((async () => {
                await this._persistCurrentJobDescs();
                const t = this._createStep(i);
                if (!t) return void this._logger.zsymb(21, "HN_tZi", ["[mm] deleteFromOldDBStep is undefined!", "816L28"]);
                const s = await t();
                if (s.state === ee.e.FAILED) throw s.data.jobId = e, s.data.jobType = "DELETE_FROM_OLD_DB", s.data;
                this._logger.zsymb(3, "ArCsB-", ["[mm] deleteFromOldDBStep - DONE - jobId: {}", "m4nwL_"], e), this._currentJobDescs = this._currentJobDescs.filter((t => t.id !== e)), this._currentJobHolders = this._currentJobHolders.filter((t => t.jobId !== e)), this._persistCurrentJobDescs()
              }))()
            } catch (t) {
              this._logger.zsymb(3, "vMOoUY", ["[mm] throw error from delete from old DB step - jobId: {} - err: {}", "bVLhGM"], e, null == t ? void 0 : t.message)
            }
          }
        }
        _updateCurrentStepByJobId(e, t) {
          const i = this._currentJobDescs.find((t => t.id === e));
          i && (i.currentStep = t)
        }
          ...
          return re(e) ? async () => {
            try {
              ...
              const {
                ...
                amount: i,
                lastMsgId: s
              } = e.dataToRun, a = t, n = r.ModuleContainer.resolve(le.a), o = await n.getMediasFromOldDB(a, i, s);
              return {
                state: ee.e.DONE,
                data: o
              }
            } catch (t) {
              return this._logger.zsymb(21, "Yy14mT", ["[mm] get from old db step err: {}", "_ui-5s"], null == t ? void 0 : t.message), {
                state: ee.e.FAILED,
                data: t
              }
            }
            ...
            try {
              ...
              let d = i;
              d || (d = await o.getMediasFromOldDB(n, a, s));
              ...
              return this._logger.zsymb(21, "Jxz4uv", ["[mm] add to new db step err: {}", "5E8LLr"], null == t ? void 0 : t.message), {
                state: ee.e.FAILED,
                data: t
              }
            }
            ...
            try {
              ...
              return i ? {
                state: ee.e.DONE,
                data: await o.deleteMediasFromOldDB(n, i)
              } : {
                state: ee.e.DONE,
                data: await o.deleteMediasFromOldDBByRange(n, a, s)
              }
            } catch (t) {
              return this._logger.zsymb(21, "ye0d3p", ["[mm] delete from old db step err: {}", "z_Gabr"], null == t ? void 0 : t.message), {
                state: ee.e.FAILED,
                data: t
              }
            }
        ...
        async _loadData() {
          if (me() || !Object(Ie.a)()) return;
          const e = await this.getMediaMigrationState();
          this._logger.zsymb(3, "8ALLgw", ["[mm] MEDIA MIGRATION STATE after load data: {}", "plqM9_"], e.stateName), this._mediaMigrationState = e;
          ...
          t.length > 0 && t.forEach((e => {
            ...
            if (i) {
              const e = this._scheduleJob(t.id, i);
              this._worker.add(e, {
                priority: ve
              })
            }
        ...
        async _statsMediaMigration() {
          ...
          let i = ee.b.NOT_DONE,
            s = [];
          return i = t.reduce(((e, t, i) => (0 === i && t > 0 ? s.push("image") : 1 === i && t > 0 ? s.push("file") : 2 === i && t > 0 && s.push("link"), e + t)), 0) > 0 ? ee.b.NOT_DONE : ee.b.DONE, {
            stateName: i,
            remainingTableNames: s
          }
        }
        async _runMigration() {
          if (this._logger.zsymb(0, "xw1VAH", "[mm] ====================RUN MIGRATION===================="), !Object(Ie.a)()) return void this._logger.zsymb(0, "Yi52OT", "[mm] ==========STOP MIGRATION: not use new media DB flow (cfsv)==========");
          if (me()) return void this._logger.zsymb(0, "45tI6p", "[mm] ==========STOP MIGRATION: stop migration (cfsv)==========");
          if (this._forceStop) return void this._logger.zsymb(0, "ztJ3le", "[mm] ==========STOP MIGRATION: force stop (in app)==========");
          if (!this._isLoadData && (await this._loadData(), !this._isLoadData)) return;
          if (this._mediaMigrationState.stateName === ee.b.DONE) return void this._logger.zsymb(0, "RupBQp", "[mm] ==========STOP MIGRATION: migration done==========");
          const e = this._mediaMigrationState.mediaTableNamesToMigrate.length > 0 ? this._mediaMigrationState.mediaTableNamesToMigrate[0] : "";
          if (!e) {
            if (!this._currentJobDescs.length) return this._logger.zsymb(0, "sKFjbg", "[mm] ==========STOP MIGRATION: no media table to migrate=========="), this._stopListenEvents(), void(await this._mediaMigrationStatePersist.clearPersistedJobDescSummaries());
            this._logger.zsymb(0, "TA7sYr", "[mm] ==========STOP MIGRATION: no media table to migrate, but still have running jobs==========")
          }
          if (this._logger.zsymb(3, "0Z6h7F", ["[mm] worker pending: ", "siVomN"], this._worker.pending), this._logger.zsymb(3, "Kr3hNj", ["[mm] worker size: ", "qpE4_W"], this._worker.size), e) {
            if (Te.value % this._maxWorkerPoolNum == 0 && (await this._waitIn(this._delayTimeEachKJobs), this._forceStop || !Object(Ie.a)() || me())) return;
            const t = {
                id: Te.next(),
                state: ee.a.NEW,
                currentStep: {
        ...
        _withRetry(e) {
          return Oe(e, {
            ...
            shouldRetryOnError: async ({
              error: e,
              currentState: t
            }) => this._forceStop || me() || !Object(Ie.a)() ? (this._updateStateOfCurrentJobByJobId(e.jobId, ee.a.FAILED), !1) : "UnknownError" === e.name || "QuotaExceededError" === e.name || 22 === e.code ? (this._updateStateOfCurrentJobByJobId(e.jobId, ee.a.FAILED), this.pauseMigration("DB_ERROR"), !1) : (this._logger.zsymb(21, "EtJzTS", ["[mm]: Retry - jobId: {} - jobType: {} - error: {}", "QL-p9p"], e.jobId, e.jobType, e.message), !0)
          })
        }
        async _waitIn(e) {
          return this._logger.zsymb(3, "fEd3CT", ["[mm]: waiting in {} seconds", "0ZZraF"], e), new Promise((t => {
            setTimeout(t, 1e3 * e)
          }))
        }
        _getTestMediaMigrationFlag(e) {
          const t = Y.default.getInstance().getItemForCurrentUser(e);
          try {
