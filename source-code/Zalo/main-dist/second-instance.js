/**
 * Deobfuscated from: second-instance.js
 * Generated: 2025-10-05T13:03:59.803Z
 * 
...
! function(e) {
  ...
  kkFf: function(e, t, n) {
    ...
    ! function() {
      try {
        const e = r.app.getPath("appData"),
          t = p.a.join(e, i.appFolder, "startup.log");
        u.a.appendFileSync(t, `${(new Date).toLocaleString()}\n`)
      } catch (e) {}
      r.app.quit()
    }()
  },
