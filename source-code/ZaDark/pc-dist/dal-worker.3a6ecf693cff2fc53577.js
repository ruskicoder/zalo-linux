/**
 * Deobfuscated from: dal-worker.3a6ecf693cff2fc53577.js
 * Generated: 2025-10-05T13:04:42.231Z
 * 
...
__ZaBUNDLENAME__ = "dal-worker", __SCRIPT_TYPE__ = "web-worker",
  function(t) {
    var e = {};
    ...
    "1asr": function(t, e, n) {
      ...
      class f extends s.a {
        ...
        constructor(t, e, n = c.idleTimeout, r = c.finalTimeout, o = c.heartbeatInterval, s = !1) {
        ...
        cancelIdleTimeout(t, {
          ...
          this._idleTimeoutCanceledPermanently = !1 === e, this._idleTimeoutID && (clearTimeout(this._idleTimeoutID), this._idleTimeoutID = void 0, 0 === Object.keys(this.activities).length && this._idleTimeoutCanceledPermanently && (this._finishReason = a[5], this.finish(t)))
        }
        setFinishReason(t) {
        ...
        _restartIdleTimeout(t) {
          this.cancelIdleTimeout(), this._idleTimeoutID = setTimeout((() => {
            this._finished || 0 !== Object.keys(this.activities).length || (this._finishReason = a[1], this.finish(t))
          }), this._idleTimeout)
        }
        _pushActivity(t) {
        ...
        _popActivity(t) {
          if (this.activities[t] && (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && i.c.log(`[Tracing] popActivity ${t}`), delete this.activities[t], ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && i.c.log("[Tracing] new activities count", Object.keys(this.activities).length)), 0 === Object.keys(this.activities).length) {
            const t = Object(r.d)();
            this._idleTimeoutCanceledPermanently ? (this._finishReason = a[5], this.finish(t)) : this._restartIdleTimeout(t + this._idleTimeout / 1e3)
          }
        }
        _beat() {
    ...
    "2HVB": function(t, e, n) {
      ...
      function l(t, e, n, l) {
        ...
        ! function(t, e) {
          ...
          c && c.value && (c.value = Object(s.e)(c.value, o));
          const a = t.request;
          a && a.url && (a.url = Object(s.e)(a.url, o))
        }(_, t),
        function(t, e) {
          e.length > 0 && (t.sdk = t.sdk || {}, t.sdk.integrations = [...t.sdk.integrations || [], ...e])
        }(_, g), void 0 === e.type && function(t, e) {
          const n = c.a._sentryDebugIds;
          if (!n) return;
          let r;
          const i = d.get(e);
          i ? r = i : (r = new Map, d.set(e, r));
        ...
        return b.then((t => (t && function(t) {
          ...
          t.contexts && t.contexts.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = Object(a.a)(t.contexts.trace.data, e, n)));
          t.spans && (r.spans = t.spans.map((t => (t.data && (t.data = Object(a.a)(t.data, e, n)), t))));
          return r
        }(t, p, h) : t)))
      }
      const d = new WeakMap
    ...
    "5DaW": function(t, e, n) {
      ...
      function _(t, e) {
        ...
        let c = new d.a(t, this);
        return c = h(c, i, {
          parentSampled: t.parentSampled,
          transactionContext: t,
          ...e
        }), c.sampled && c.initSpanRecorder(i._experiments && i._experiments.maxSpans), n && n.emit && n.emit("startTransaction", c), c
      }
      ...
      function g(t, e, n, r, i, o, s) {
        ...
        return u = h(u, a, {
          ...
          ...o
        }), u.sampled && u.initSpanRecorder(a._experiments && a._experiments.maxSpans), c && c.emit && c.emit("startTransaction", u), u
      }

      function y() {
        const t = Object(o.e)();
        t.__SENTRY__ && (t.__SENTRY__.extensions = t.__SENTRY__.extensions || {}, t.__SENTRY__.extensions.startTransaction || (t.__SENTRY__.extensions.startTransaction = _), t.__SENTRY__.extensions.traceHeaders || (t.__SENTRY__.extensions.traceHeaders = p), u || (u = !0, Object(c.b)("error", f), Object(c.b)("unhandledrejection", f)))
      }
    },
    "5l/R": function(t, e, n) {
      "use strict";
    ...
    "6PXS": function(t, e, n) {
      ...
      function g(t, e) {
        if (Object(i.i)(t)) {
          ...
          const r = {};
          e.set(t, r);
          for (const i of Object.keys(t)) void 0 !== t[i] && (r[i] = g(t[i], e));
          return r
        }
        if (Array.isArray(t)) {
          const n = e.get(t);
      ...
      function h(t) {
        if (!p[t]) switch (p[t] = !0, t) {
          ...
          case "history":
            ...
            break;
          case "error":
            j = f.onerror, f.onerror = function(t, e, n, r, i) {
              return g("error", {
                column: r,
                error: i,
                line: n,
          ...
          case "unhandledrejection":
            w = f.onunhandledrejection, f.onunhandledrejection = function(t) {
              return g("unhandledrejection", t), !(w && !w.__SENTRY_LOADER__) || w.apply(this, arguments)
      ...
      function T(t, e = !1) {
        return n => {
          ...
          (void 0 === S || function(t, e) {
            ...
            name: r,
            global: e
          }), O = n), clearTimeout(S), S = f.setTimeout((() => {
            S = void 0
          }), E)
        }
      }
    ...
    "8+WD": function(t, e, n) {
      ...
      function s(t, e) {
        return null === e ? null : n => {
          ...
          Object(o.f)(r) || ("object" == typeof e ? e.handleEvent(n) : e.call(t, n))
        }
      }
      const c = self.addEventListener;
      self.addEventListener = (t, e, n) => {
        c(t, "message" !== t ? e : s(self, e), n)
      };
      const a = Object.getOwnPropertyDescriptor(self, "onmessage");
      Object.defineProperty(self, "onmessage", Object(r.a)(Object(r.a)({}, a), {}, {
        set(t) {
          c("message", s(self, t))
        }
      })), self.addReservedMsgListener = (t, e) => {
        const n = n => {
          const {
            data: r
          } = n, s = {
          ...
          if (Object(o.f)(r)) {
            const [c] = r, a = Object(o.d)(c);
            if (a === t)
              if (Object(o.g)(a)) {
                const t = r[r.length - 1];
                s.getPorts = () => new Promise((e => {
                  let n = () => {};
                  n = self.addReservedMsgListener(i.g, (r => {
                    const {
                      data: i
                    } = r, [o, s] = i;
                    if (s === t) {
                  ...
                  })), self.postReservedMsg([i.f, t])
                })), e(s)
              } else e(n)
          }
        };
        return c("message", n), () => self.removeEventListener("message", n)
      }, self.postReservedMsg = t => {
        ...
        if (Object(o.f)(e)) {
          const [t, n] = e;
          t === Object(o.b)(i.k) && self.importScripts(n)
        }
      }))
    },
    "8LbN": function(t, e, n) {
    ...
    "8oxB": function(t, e) {
      ...
      function d() {
        f && a && (f = !1, a.length ? u = a.concat(u) : l = -1, u.length && p())
      }
      ...
      i.nextTick = function(t) {
        ...
        u.push(new h(t, e)), 1 !== u.length || f || c(p)
    ...
    "8yT3": function(t, e, n) {
      ...
      function c(t, e) {
        const n = s(t),
          ...
          f = {
            traceId: c || Object(i.h)(),
            spanId: Object(i.h)().substring(16),
            sampled: void 0 !== u && u
          };
        return a && (f.parentSpanId = a), o && (f.dsc = o), {
          traceparentData: n,
      ...
      function a(t = Object(i.h)(), e = Object(i.h)().substring(16), n) {
        let r = "";
    ...
    AsUd: function(t, e, n) {
      ...
      function m(t, e) {
        const n = Object(o.c)(),
          ...
          c = n.getClient();
        if (c) {
          if (c.captureCheckIn) return c.captureCheckIn(t, e, s);
    ...
    "F+4+": function(t, e, n) {
      ...
      function f(t, e, n = Object(r.a)(t.bufferSize || u)) {
        ...
        function d(r) {
          ...
          return n.add((() => e({
            body: Object(i.j)(d, t.textEncoder)
          }).then((t => (void 0 !== t.statusCode && (t.statusCode < 200 || t.statusCode >= 300) && ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && c.c.warn(`Sentry responded with status code ${t.statusCode} to sent event.`), f = Object(o.e)(f, t), t)), (t => {
            throw p("network_error"), t
          })))).then((t => t), (t => {
            if (t instanceof a.a) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && c.c.error("Skipped sending event because buffer is full."), p("queue_overflow"), Object(s.c)();
            throw t
          }))
        }
    ...
    FGNl: function(t, e, n) {
      ...
      function s(t, e, n = (() => {})) {
        ...
        const c = Object(i.c)(),
          ...
          u = a.getSpan();
        const f = function() {
          if (Object(o.a)()) return u ? u.startChild(s) : c.startTransaction(s)
        }();

        function l() {
          f && f.finish(), c.getScope().setSpan(u)
        }
        let d;
        a.setSpan(f);
        try {
          ...
          throw f && f.setStatus("internal_error"), n(p), l(), p
        }
        return Object(r.n)(d) ? Promise.resolve(d).then((() => {
          l()
        }), (t => {
    ...
    Fffm: function(t, e, n) {
      ...
      (function(t) {
        ...
        function u(e, n, c = 1 / 0, a = 1 / 0, f = Object(i.a)()) {
          const [l, d] = f;
          ...
          const h = "number" == typeof n.__sentry_override_normalization_depth__ ? n.__sentry_override_normalization_depth__ : c;
          if (0 === h) return p.replace("object ", "");
          if (l(n)) return "[Circular ~]";
          const _ = n;
          if (_ && "function" == typeof _.toJSON) try {
            return u("", _.toJSON(), h - 1, a, f)
          } catch (m) {}
    ...
    GIgW: function(t, e, n) {
      ...
      class d {
        ...
        addBreadcrumb(t, e) {
          ...
          const a = {
            ...
            u = s ? Object(o.b)((() => s(a, e))) : a;
          null !== u && (r.emit && r.emit("beforeAddBreadcrumb", u, e), n.addBreadcrumb(u, c))
        }
        setUser(t) {
      ...
      function g(t = p()) {
        return v(t) && !E(t).isOlderThan(f) || S(t, new d), E(t)
      }

      function y(t, e = g()) {
        if (!v(t) || E(t).isOlderThan(f)) {
          const n = e.getStackTop();
          S(t, new d(n.client, a.a.clone(n.scope)))
        }
      }
    ...
    KoSx: function(t, e, n) {
      ...
      let r = function(t) {
        return t.SCRIPT_CONNECTED = "script-connected", t
      }({})
    },
    LGyv: function(t, e) {
    ...
    METY: function(t, e, n) {
      ...
      function f(t, e) {
        e[t.name] = t, -1 === c.indexOf(t.name) && (t.setupOnce(s.b, o.c), c.push(t.name), ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && i.c.log(`Integration installed: ${t.name}`))
      }
    },
    MPV0: function(t, e, n) {
      "use strict";
      ...
      let r = function(t) {
        return t.CHANNEL_ESTATBLISHED = "channel-established", t.CHANNEL_DISCONNECTED = "channel-disconnected", t.CHANNEL_TERMINATED = "channel-terminated", t.PORT_TRANSFERRED = "port-transferred", t.PORT_TRANSFERRED_V2 = "port-transferred-v2", t.PORT_DELIVERED = "port-delivered", t.OPEN_CHANNEL_TO = "open-channel-to", t
      }({})
    },
    MZrX: function(t, e, n) {
      "use strict";
          ...
          async function h(t) {
            try {
              ...
              if (r && await
                ...
                }(t, a, l)) return await r.insert(t), p(), u("Error sending. Event queued", a), {};
              throw a
            }
          }
    ...
    R2CK: function(t, e, n) {
      ...
      let r = function(t) {
        return t.REQUEST_CHANNEL = "shared-worker-req-events", t.RESPONSE_CHANNEL = "shared-worker-resp-events", t.SQLITE_AVAILABLE = "sqlite-available", t.FAIL_LOAD_LIB_SQLITE3 = "fail-load-sqlite3", t.NOTIFY_STATUS_LOAD_LIB_SQLITE3 = "status-load-sqlite3", t.OPEN_DB_FAIL = "db-open-fail", t.IPC_DB_AUTHENTICATED = "db-authenticated", t.IPC_DB_CLIENT_CONNECTED = "db-client-connected", t.IPC_START_CLOSE_DBS = "db-start-close-dbs", t.IPC_FINISH_CLOSE_DBS = "db-finish-close-dbs", t.SYNC_MSG_ABORT = "sync-msg-abort", t.DB_CORRUPTION_DETECTOR = "z-db-corruption-detector", t.SHOW_SQLITE = "show-sqlite", t.GET_NAME_OF_TARGET_SCRIPT_FOR_DAL_CHANNEL_FROM_HOST = "get-name-of-target-script-for-dal-channel-from-host", t
      }({})
    },
    RDap: function(t, e, n) {
      "use strict";
    ...
    S8fy: function(t, e, n) {
      ...
      function E(t, e, n) {
        var r, i, s, c = Object(o.c)(t.toString().match(/constructor\(([\w, ]+)\)/) || [], 2)[1],
          a = function(t, e) {
            return null === t ? "at position #" + e : '"' + t.split(",")[e].trim() + '" at position #' + e
          }(void 0 === c ? null : c, e);
        return r = "Cannot inject the dependency " + a + ' of "' + t.name + '" constructor. Reason:', i = n, void 0 === s && (s = "    "), Object(o.e)([r], i.message.split("\n").map((function(t) {
          return s + t
        }))).join("\n")
      }
      var S = function(t) {
        ...
        T = function() {
          this.preResolution = new S, this.postResolution = new O
        },
        j = new Map,
        w = function() {
          function t(t) {
            this.parent = t, this._registry = new m, this.interceptors = new T
          }
          return t.prototype.register = function(t, e, n) {
            ...
            if (void 0 === n && (n = {
              ...
              for (var s = [t], c = r; null != c;) {
                var a = c.useToken;
                if (s.includes(a)) throw new Error("Token registration cycle detected! " + Object(o.e)(s, [a]).join(" -> "));
                s.push(a);
                var l = this._registry.get(a);
                c = l && _(l.provider) ? l.provider : null
              }
            if ((n.lifecycle === i.Singleton || n.lifecycle == i.ContainerScoped || n.lifecycle == i.ResolutionScoped) && (g(r) || f(r))) throw new Error('Cannot use lifecycle "' + i[n.lifecycle] + '" with ValueProviders or FactoryProviders');
            return this._registry.set(t, {
              provider: r,
              options: n
            }), this
          }, t.prototype.registerType = function(t, e) {
            return d(e) ? this.register(t, {
              useToken: e
            }) : this.register(t, {
              useClass: e
            })
            ...
            var n = t;
            return e && !d(e) && (n = e), this.register(t, {
              useClass: n
            }, {
              lifecycle: i.Singleton
            })
            ...
            if (!n && d(t)) throw new Error('Attempted to resolve unregistered dependency token: "' + t.toString() + '"');
            ...
            if (this.interceptors.preResolution.has(t)) {
              var i = [];
              try {
                for (var s = Object(o.f)(this.interceptors.preResolution.getAll(t)), c = s.next(); !c.done; c = s.next()) {
                  var a = c.value;
                  "Once" != a.options.frequency && i.push(a), a.callback(t, e)
                }
              } catch (u) {
                n = {
                  error: u
            ...
            if (this.interceptors.postResolution.has(t)) {
              var s = [];
              try {
                for (var c = Object(o.f)(this.interceptors.postResolution.getAll(t)), a = c.next(); !a.done; a = c.next()) {
                  var u = a.value;
            ...
            var n, r = t.options.lifecycle === i.Singleton,
              ...
              s = r || o;
            return n = g(t.provider) ? t.provider.useValue : _(t.provider) ? s ? t.instance || (t.instance = this.resolve(t.provider.useToken, e)) : this.resolve(t.provider.useToken, e) : u(t.provider) ? s ? t.instance || (t.instance = this.construct(t.provider.useClass, e)) : this.construct(t.provider.useClass, e) : f(t.provider) ? t.provider.useFactory(this) : this.construct(t.provider, e), t.options.lifecycle === i.ResolutionScoped && e.scopedResolutions.set(t, n), n
          }, t.prototype.resolveAll = function(t, e) {
            var n = this;
            void 0 === e && (e = new v);
            var r = this.getAllRegistrations(t);
            if (!r && d(t)) throw new Error('Attempted to resolve unregistered dependency token: "' + t.toString() + '"');
            ...
            try {
              for (var n = Object(o.f)(this._registry.entries()), r = n.next(); !r.done; r = n.next()) {
                var i = Object(o.c)(r.value, 2),
                  s = i[0],
                  c = i[1];
                this._registry.setAll(s, c.filter((function(t) {
                  return !g(t.provider)
                })).map((function(t) {
            ...
            try {
              for (var s = Object(o.f)(this._registry.entries()), c = s.next(); !c.done; c = s.next()) {
            ...
            return function(r, i) {
              var s, c, a;
              try {
                return p(r) ? h(r) ? r.multiple ? (s = n.resolve(r.transform)).transform.apply(s, Object(o.e)([n.resolveAll(r.token)], r.transformArgs)) : (c = n.resolve(r.transform)).transform.apply(c, Object(o.e)([n.resolve(r.token, t)], r.transformArgs)) : r.multiple ? n.resolveAll(r.token) : n.resolve(r.token, t) : h(r) ? (a = n.resolve(r.transform, t)).transform.apply(a, Object(o.e)([n.resolve(r.token, t)], r.transformArgs)) : n.resolve(r, t)
              } catch (u) {
                throw new Error(E(e, i, u))
              }
            }
          }, t
        }(),
          ...
          return function(n) {
            function r() {
              ...
              return n.apply(this, Object(o.e)(r.concat(e.slice(r.length).map((function(e, n) {
                var i, s, c;
                try {
                  return p(e) ? h(e) ? e.multiple ? (i = R.resolve(e.transform)).transform.apply(i, Object(o.e)([R.resolveAll(e.token)], e.transformArgs)) : (s = R.resolve(e.transform)).transform.apply(s, Object(o.e)([R.resolve(e.token)], e.transformArgs)) : e.multiple ? R.resolveAll(e.token) : R.resolve(e.token) : h(e) ? (c = R.resolve(e.transform)).transform.apply(c, Object(o.e)([R.resolve(e.token)], e.transformArgs)) : R.resolve(e)
                } catch (u) {
                  var a = n + r.length;
                  throw new Error(E(t, a, u))
                }
              }))))) || this
            }
    ...
    "W+DE": function(t, e, n) {
      ...
      let r = function(t) {
        return t.NEW_SESSION = "new-session", t
      }({})
    },
    WVzo: function(t, e, n) {
      "use strict";
        ...
        return n => {
          ...
          return {
            send: async function(a) {
              ...
              return 0 === u.length && u.push(s), (await Promise.all(u.map((t => t.send(a)))))[0]
            },
            flush: async function(t) {
              const e = [...Object.keys(c).map((t => c[t])), s];
    ...
    YrRS: function(t, e, n) {
      ...
      function a() {
        ...
        f(r.ModuleContainer.resolve(c.a).createZLogger("zconsole", ["zlogger"]))
      }
      const u = function() {};
    ...
    b8N4: function(t, e, n) {
      ...
      function c(t) {
        return Array.isArray(t) && t[0] && r.n.includes(s(t[0]))
      }
    ...
    eBEg: function(t, e, n) {
      ...
      const a = c().EnumeratedLevels,
        u = c().ReversedEnumeratedLevels;
      Object.freeze(a), Object.freeze(u);
      var f = n("jDHv"),
        l = n("jGDt"),
        d = n("KRcn");
      const p = {
    ...
    h6tn: function(t, e, n) {
      ...
      function f(t, e) {
        return void 0 === e && (e = {}),
          function(t, e) {
            void 0 === e && (e = {});
            for (var n = e.splitRegexp, r = void 0 === n ? s : n, i = e.stripRegexp, u = void 0 === i ? c : i, f = e.transform, l = void 0 === f ? o : f, d = e.delimiter, p = void 0 === d ? " " : d, h = a(a(t, r, "$1\0$2"), u, "\0"), _ = 0, g = h.length;
              "\0" === h.charAt(_);) _++;
            for (;
              "\0" === h.charAt(g - 1);) g--;
            return h.slice(_, g).split("\0").map(l).join(p)
          }(t, i({
            delimiter: "",
            transform: u
          }, e))
    ...
    jIae: function(t, e, n) {
      ...
      function c(t, {
        ...
        if (s)
          ...
          } else c ? o.all = r + i(c, r) : 429 === e && (o.all = r + 6e4);
        return o
      }
    },
    jXcl: function(t, e, n) {
        ...
        return function(t) {
          ...
          return Object.entries(t).reduce(((t, [e, n], r) => {
            const o = `${encodeURIComponent(e)}=${encodeURIComponent(n)}`,
              s = 0 === r ? o : `${t},${o}`;
            return s.length > a ? (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && i.c.warn(`Not adding key: ${e} with val: ${n} to baggage header due to exceeding baggage size limits.`), t) : s
          }), "")
    ...
    kdvv: function(t, e, n) {
      ...
      (function(t) {
        ...
        const h = (() => {
          ...
          return s || a < e ? i <= a ? (p = "timeOrigin", t.timeOrigin) : (p = "navigationStart", c) : (p = "dateNow", r)
        })()
      }).call(this, n("3UD+")(t))
    },
    lddD: function(t, e, n) {
                ...
                const a = n.getClient(),
                  ...
                  l = function(t = {}, e = {}) {
                    return {
                      ...
                      ignoreTransactions: [...t.ignoreTransactions || [], ...e.ignoreTransactions || [], ...t.disableTransactionDefaults ? [] : c],
          ...
          ! function(r) {
            ...
            void 0 === i.Reflect ? i.Reflect = n : o = s(i.Reflect, o),
              function(e) {
                ...
                }, f = Object.getPrototypeOf(Function), l = "object" == typeof t && t.env && "true" === t.env.REFLECT_METADATA_USE_MAP_POLYFILL, d = l || "function" != typeof Map || "function" != typeof Map.prototype.entries ? et() : Map, p = l || "function" != typeof Set || "function" != typeof Set.prototype.entries ? nt() : Set, h = new(l || "function" != typeof WeakMap ? rt() : WeakMap);
                ...
                function _(t, e, n, r) {
                  ...
                  if (!Y(r) && !P(r) && !L(r)) throw new TypeError;
                  return L(r) && (r = void 0), w(t, e, n = z(n), r)
                }

                function g(t, e) {
                  function n(n, r) {
                    if (!Y(n)) throw new TypeError;
                    if (!P(r) && !Z(r)) throw new TypeError;
                    D(t, e, n, r)
                  }
                  return n
                }
                ...
                function y(t, e, n, r) {
                  if (!Y(n)) throw new TypeError;
                  return P(r) || (r = z(r)), D(t, e, n, r)
                }

                function b(t, e, n) {
                  if (!Y(e)) throw new TypeError;
                  return P(n) || (n = z(n)), N(t, e, n)
                }

                function m(t, e, n) {
                  if (!Y(e)) throw new TypeError;
                  return P(n) || (n = z(n)), x(t, e, n)
                }

                function v(t, e, n) {
                  if (!Y(e)) throw new TypeError;
                  return P(n) || (n = z(n)), k(t, e, n)
                }

                function E(t, e, n) {
                  if (!Y(e)) throw new TypeError;
                  return P(n) || (n = z(n)), C(t, e, n)
                }

                function S(t, e) {
                  if (!Y(t)) throw new TypeError;
                  return P(e) || (e = z(e)), I(t, e)
                }

                function O(t, e) {
                  if (!Y(t)) throw new TypeError;
                  return P(e) || (e = z(e)), A(t, e)
                }
                ...
                function x(t, e, n) {
                  var r = R(e, n, !1);
                  return !P(r) && M(r.has(t))
                }

                function k(t, e, n) {
                  if (x(t, e, n)) return C(t, e, n);
                  var r = tt(e);
                  return L(r) ? void 0 : k(t, r, n)
                }

                function C(t, e, n) {
                  var r = R(e, n, !1);
                  if (!P(r)) return r.get(t)
                }
                ...
                function I(t, e) {
                  ...
                  for (var o = new p, s = [], c = 0, a = n; c < a.length; c++) {
                    var u = a[c];
                ...
                function $(t, e) {
                  if ("string" === e) {
                    var n = t.toString;
                    if (H(n))
                      if (!Y(i = n.call(t))) return i;
                    if (H(r = t.valueOf))
                      if (!Y(i = r.call(t))) return i
                  } else {
                    var r;
                    if (H(r = t.valueOf))
                      if (!Y(i = r.call(t))) return i;
                ...
                e("decorate", _), e("metadata", g), e("defineMetadata", y), e("hasMetadata", b), e("hasOwnMetadata", m), e("getMetadata", v), e("getOwnMetadata", E), e("getMetadataKeys", S), e("getOwnMetadataKeys", O), e("deleteMetadata", T)
              }(o)
          }()
        }(n || (n = {}))
    ...
    oMcV: function(t, e, n) {
      ...
      class g {
        ...
        captureSession(t) {
          this._isEnabled() ? "string" != typeof t.release ? ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && i.c.warn("Discarded session because of missing or non-string release") : (this.sendSession(t), Object(d.c)(t, {
            init: !1
        ...
        flush(t) {
          ...
          return e ? this._isClientDoneProcessing(t).then((n => e.flush(t).then((t => n && t)))) : Object(c.c)(!0)
        }
        close(t) {
        ...
        sendEvent(t, e = {}) {
          if (this._dsn) {
            let n = function(t, e, n, r) {
              ...
              const s = Object(a.d)(t, i, r, e);
              delete t.sdkProcessingMetadata;
              const c = [{
                type: o
              }, t];
              return Object(a.c)(s, [c])
            }(t, this._dsn, this._options._metadata, this._options.tunnel);
            for (const t of e.attachments || []) n = Object(a.a)(n, Object(a.b)(t, this._options.transportOptions && this._options.transportOptions.textEncoder));
        ...
        _processEvent(t, e, n) {
          ...
          if (!this._isEnabled()) return Object(c.b)(new u.a("SDK not enabled, will not capture event.", "log"));
          const o = b(t),
            a = y(t),
            f = t.type || "error",
            l = `before send for type \`${f}\``;
          if (a && "number" == typeof i && Math.random() > i) return this.recordDroppedEvent("sample_rate", "error", t), Object(c.b)(new u.a(`Discarding event because it's not included in the random sample (sampling rate = ${i})`, "log"));
          const d = "replay_event" === f ? "replay" : f;
          return this._prepareEvent(t, e, n).then((n => {
            if (null === n) throw this.recordDroppedEvent("event_processor", d, t), new u.a("An event processor returned `null`, will not send event.", "log");
            ...
            if (null === r) throw this.recordDroppedEvent("before_send", d, t), new u.a(`${l} returned \`null\`, will not send event.`, "log");
      ...
      function r(t) {
        ...
        return r => {
          ...
          if (i) {
            ...
            let c = i[2] && i[2].startsWith("file://") ? i[2].slice(7) : i[2];
            const a = "native" === i[5];
            c || !i[5] || a || (c = i[5]);
            const u = !(a || c && !c.startsWith("/") && !c.includes(":\\") && !c.startsWith(".") && !c.match(/^[a-zA-Z]([a-zA-Z0-9.\-+])*:\/\//)) && void 0 !== c && !c.includes("node_modules/");
            return {
              filename: c,
              module: t ? t(c) : void 0,
              function: r,
    ...
    pevS: function(t, e, n) {
      ...
      t.exports = function(t, e) {
        var n, l, d, p, h, _, g, y, b = t.target,
          m = t.global,
          v = t.stat,
          E = t.proto,
          S = m ? r : v ? r[b] : (r[b] || {}).prototype,
          O = m ? s : s[b] || (s[b] = {}),
          T = O.prototype;
        for (d in e) n = !o(m ? d : b + (v ? "." : "#") + d, t.forced) && S && u(S, d), h = O[d], n && (_ = t.noTargetGet ? (y = i(S, d)) && y.value : S[d]), p = n && _ ? _ : e[d], n && typeof h == typeof p || (g = t.bind && n ? c(p, r) : t.wrap && n ? f(p) : E && "function" == typeof p ? c(Function.call, p) : p, (t.sham || p && p.sham || h && h.sham) && a(g, "sham", !0), O[d] = g, E && (u(s, l = b + "Prototype") || a(s, l, {}), s[l][d] = p, t.real && T && !T[d] && a(T, d, p)))
      }
    },
    qUYh: function(t, e, n) {
      "use strict";
    ...
    rvIA: function(t, e, n) {
      ...
      class a extends c.a {
        ...
        constructor(t, e) {
          super(t), a.prototype.__init.call(this), a.prototype.__init2.call(this), a.prototype.__init3.call(this), this._hub = e || Object(o.c)(), this._name = t.name || "", this.metadata = {
            source: "custom",
            ...t.metadata,
            spanMetadata: {}
        ...
        getDynamicSamplingContext() {
          ...
          const c = this.metadata.source;
          return c && "url" !== c && (r.transaction = this.name), void 0 !== this.sampled && (r.sampled = String(this.sampled)), r
        }
        setHub(t) {
          this._hub = t
        }
    ...
    vFt6: function(t, e, n) {
      ...
      function c(t, e = {}) {
        try {
          ...
          for (; n && o++ < r && (l = a(n, d), !("html" === l || o > 1 && c + i.length * f + l.length >= p));) i.push(l), c += l.length, n = n.parentNode;
      ...
      function a(t, e) {
        ...
        for (u = 0; u < l.length; u++) c = l[u], a = n.getAttribute(c), a && i.push(`[${c}="${a}"]`);
        return i.join("")
      }
    ...
    vOz9: function(t, e, n) {
      ...
      class f {
        ...
        _notifyEventProcessors(t, e, n, i = 0) {
          return new o.a(((o, c) => {
            ...
            if (null === e || "function" != typeof a) o(e);
              ...
              ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && a.id && null === u && s.c.log(`Event processor "${a.id}" dropped event`), Object(r.n)(u) ? u.then((e => this._notifyEventProcessors(t, e, n, i + 1).then(o))).then(null, c) : this._notifyEventProcessors(t, u, n, i + 1).then(o).then(null, c)
            }
          }))
        }
        ...
        _applyFingerprint(t) {
          t.fingerprint = t.fingerprint ? Object(c.d)(t.fingerprint) : [], this._fingerprint && (t.fingerprint = t.fingerprint.concat(this._fingerprint)), t.fingerprint && !t.fingerprint.length && delete t.fingerprint
        }
      }
      ...
      function p() {
        return {
          traceId: Object(c.h)(),
          spanId: Object(c.h)().substring(16),
          sampled: !1
        }
      }
    },
    ...
    wBhU: function(t, e, n) {
      ...
      function C(t, e, n, r, i) {
        ...
        }), r && i && (o.dsn = Object(x.b)(i)), e && (o.trace = Object(_.c)(e));
        const s = function(t) {
          return [{
            type: "check_in"
          }, t]
    ...
    wudS: function(t, e, n) {
      ...
      function s() {
        const t = globalThis.localStorage.getItem(o);
        let e = [];
        try {
          t && (e = JSON.parse(t))
        } catch (n) {}
      ...
      function c() {
        if (null !== globalThis.localStorage.getItem(o)) return;
        const t = function() {
          let t = new Set;
          for (let e in localStorage)
            for (let n of [r.i, r.h, r.q])
              if (e && e.startsWith(n + "_")) {
                let r = e.substring(n.length + 1, e.length);
                if (r && !isNaN(+r)) {
                  t.add(r);
                  break
                }
              } return 0 == t.size ? [] : Array.from(t)
        }();
        globalThis.localStorage.setItem(o, JSON.stringify(t))
      }

      function a(t) {
        let e = s(),
          n = e.indexOf(t);
        return -1 === n && (e.push(t), n = e.length - 1, globalThis.localStorage.setItem(o, JSON.stringify(e))), n
      }

      function u(t) {
        const e = globalThis.localStorage.getItem(o);
        if (null === e) return !1;
    ...
    zkos: function(t, e, n) {
      ...
      var r = n("R2CK"),
        ...
        s = n("MPV0"),
        c = n("wudS");
      const a = "load-original-script",
        u = "dal-qos",
        f = "dal-sqlite-path-utils",
        l = "database-state-storage",
        d = "dal-port-manager/get-name-of-target-script-request",
        p = "dal-port-manager/get-name-of-target-script-response",
        h = "zmsg-channel-get-ports-request",
        _ = "zmsg-channel-get-ports-response",
        g = "localstorage-key-changed",
        y = "get-is-migrate-full-done/request",
        b = "get-is-migrate-full-done/response";
      let m = function(t) {
        return t.NOTIFY_DB_FAIL = "notify-db-fail", t.NOTIFY_OPEN_DB_FAIL = "notify-open-db-fail", t.NOTIFY_BU_READY = "notify-bu-ready", t.FORCE_CHECK_DB_CORRUPTION = "force-check-db-corruption", t.ZOS_CHANNEL_OUT_OF_MEM = "zos-channel-out-of-mem", t
      }({});
      const v = [s.a.PORT_TRANSFERRED_V2],
        E = [r.a.IPC_DB_AUTHENTICATED, r.a.IPC_START_CLOSE_DBS, s.a.CHANNEL_ESTATBLISHED, s.a.CHANNEL_DISCONNECTED, s.a.CHANNEL_TERMINATED, o.a.NEW_SESSION],
        S = [r.a.IPC_FINISH_CLOSE_DBS, r.a.IPC_DB_CLIENT_CONNECTED, s.a.PORT_DELIVERED, s.a.OPEN_CHANNEL_TO, i.a.SCRIPT_CONNECTED],
        O = [...E, ...S, ...v, a, h, _, g, u, f, l, d, p, y, b, m.NOTIFY_DB_FAIL, m.NOTIFY_BU_READY, m.NOTIFY_OPEN_DB_FAIL, m.ZOS_CHANNEL_OUT_OF_MEM, m.FORCE_CHECK_DB_CORRUPTION],
        T = [c.a]
    }
  });
//# sourceMappingURL=sourcemaps/dal-worker.3a6ecf693cff2fc53577.js.map
