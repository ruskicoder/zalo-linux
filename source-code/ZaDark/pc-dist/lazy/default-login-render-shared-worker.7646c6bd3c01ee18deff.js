/**
 * Deobfuscated from: default-login-render-shared-worker.7646c6bd3c01ee18deff.js
 * Generated: 2025-10-05T13:04:42.614Z
 * 
  ...
  [8], {
    "+7Kn": function(e, t, r) {
      ...
      class n extends Error {
        constructor(e) {
          super(`[MigrateActionManager] An action handler has already registered for ${e} action type!`), this.name = s.a
        }
      }
      class o extends Error {
        constructor(e) {
          super(`[MigrateActionManager] No action handler found for ${e} action type!`), this.name = s.d
        }
      }
      class i extends Error {
        constructor() {
          super("[SecureKeysToMigrate] Invalid initialized data for SecureKeysToMigrate"), this.name = s.b
        }
      }
      class a extends Error {
        constructor() {
          super("[SecureKeysToMigrate] SecureKeysToMigrate hasn't been initialized yet!"), this.name = s.g
        }
      }
      class c extends Error {
        constructor() {
          super("[SecureKeysToMigrate] Invalid secure indexedDB key"), this.name = s.e
        }
      }
      class u extends Error {
        constructor() {
          super("[MigrateRule] Can't generate new key name due to the lack of userID"), this.name = s.f
        }
      }
      class _ extends Error {
        constructor() {
          super("[MigrateFlow] Migration stops due to timeout"), this.name = s.c
        }
      }
    },
    "0W0H": function(e, t, r) {
      ...
      const s = "sqlite_m_d",
        ...
        a = "mig_sk_ss",
        c = "mig_sck",
        u = ["ZLog", "Qos", "SecureLocalstorage", "Storage", ""]
    },
    "5l/R": function(e, t, r) {
      "use strict";
      r.d(t, "a", (function() {
      ...
      var s = r("jDHv");
      const n = Object(s.define)("zlog-writer-manager")
    },
    "7k+P": function(e, t, r) {
      "use strict";
      r.d(t, "a", (function() {
      ...
      var s = r("jDHv");
      const n = Object(s.define)("db-corruption-detector"),
        o = Object(s.define)("db-corruption-detector-adapter")
    },
    BGEY: function(e, t, r) {
      "use strict";
      r.d(t, "a", (function() {
      ...
      function _() {
        ...
        return e || (e = function() {
          ...
          return t
        }() + "-" + u.a.MD5(navigator.userAgent).toString(), window.localStorage.setItem("sh_z_uuid", e)), e
      }
      var l = r("gNXM");
      ...
      const f = "MIGRATE_ACTION_TYPE/LOCAL_STORAGE/RENAME",
        g = "MIGRATE_ACTION_TYPE/LOCAL_STORAGE/DELETE",
        h = "MIGRATE_ACTION_TYPE/LOCAL_STORAGE/RENAME_AND_MARK_FOR_ENCRYPTION",
        I = "MIGRATE_ACTION_TYPE/IDB/RENAME",
        D = "MIGRATE_ACTION_TYPE/IDB/DELETE",
        p = "MIGRATE_ACTION_TYPE/IDB/RENAME_AND_MARK_FOR_ENCRYPTION";
      class $ {
        constructor(e, t, r) {
          this.versionObject = void 0, this.actionType = void 0, this.data = void 0, this.versionObject = e, this.actionType = t, this.data = r
        }
      }
      class y {
        constructor(e) {
      ...
      class w extends y {
        exec(e, t) {
          const {
            ...
            o && i && i.log(`localStorage - Rename ${e} into ${t}`)
          };
          if (Array.isArray(s)) {
            for (const u of s)
              if (a.a.hasItem(u)) {
                const t = "string" == typeof n ? n : n(e, u);
                z(u, t), c(u, t)
              }
          } else {
            const t = s(e);
            if (Array.isArray(t)) {
              ...
              for (const t of r)
                if (a.a.hasItem(t)) {
                  const r = "string" == typeof n ? n : n(e, t);
                  z(t, r), c(t, r)
                }
            } else {
              const r = t,
                s = a.a.getAllKeyNames();
              for (const t of s)
                if (r(t)) {
                  const r = t,
                    s = "string" == typeof n ? n : n(e, r);
                  z(r, s), c(r, s)
                }
            }
          }
      ...
      function z(e, t) {
        const r = a.a.getItem(e);
        a.a.removeItem(e), a.a.setItem(t, r)
      }
      class k extends y {
        exec(e, t) {
          const {
            ...
            n && o && o.log(`localStorage - Delete ${e} `)
          };
          if (Array.isArray(s))
            for (const c of s) a.a.hasItem(c) && (E(c), i(c));
          else {
            const t = s(e);
            if (Array.isArray(t)) {
              const e = t;
              for (const t of e) a.a.hasItem(t) && (E(t), i(t))
            } else {
              const e = t,
                r = a.a.getAllKeyNames();
              for (const t of r) e(t) && (E(t), i(t))
            }
          }
        }
      }
      ...
      class O extends y {
        exec(e, t) {
          const {
            ...
            o && i && (i.log(`localStorage - Rename ${e} into ${t}`), i.log(`localStorage - Will encrypt ${t} in its next key reading`))
          };
          if (Array.isArray(s)) {
            for (const u of s)
              if (a.a.hasItem(u)) {
      ...
      function A(e, t) {
        const r = a.a.getItem(e);
        a.a.removeItem(e), a.a.setItem(t, r), i.a.markLocalStorageKey(t)
      }
      var x = r("H/wq"),
        K = r("gbvv");
      class C extends $ {
      ...
      class R extends y {
        async exec(e, t) {
          const {
            data: r
          } = this._rule, [s, n, o, i] = r, {
            dry: a,
            logger: c
          } = t || {}, u = (e, t) => {
            a && c && c.log(`indexedDB - Rename ${e} into ${t}`)
          };
          let _ = "";
          _ = "string" == typeof s ? s : s(e);
          let d = null;
          try {
            d = await l.a.openExistedDB(_)
          } catch (g) {
            if (g.name === x.a) return;
            throw g
          }
          const f = d.objectStoreNames;
          if (Array.isArray(n)) {
            const t = n;
            for (const r of t) f.contains(r) && await j(e, d, r, o, i, u)
          } else {
            const t = n(e);
            if (Array.isArray(t)) {
              const r = t;
              for (const t of r) f.contains(t) && await j(e, d, t, o, i, u)
            } else {
              const r = t,
                s = Array.from(f);
              for (const t of s) r(t) && await j(e, d, t, o, i, u)
            }
          }
          d.close()
        }
      ...
      async function j(e, t, r, s, n, o) {
        const i = t.transaction(r, "readwrite").objectStore(r),
          a = t.name,
          c = Object(K.a)(a, r);
        if (!c) return void 0;
        const {
        ...
        if (Array.isArray(s)) {
          const t = s;
          for (const r of t) {
            if (!(await l.a.doesObjectStoreHaveKey(r, i))) continue;
            const t = "string" == typeof n ? n : n(e, r);
            await l.a.renameKeyOfObjectStore(r, t, i, u), o(r, t)
          }
        } else {
          const t = s(e);
          if (Array.isArray(t)) {
            const r = t;
            for (const t of r) {
              if (!(await l.a.doesObjectStoreHaveKey(t, i))) continue;
              const r = "string" == typeof n ? n : n(e, t);
              await l.a.renameKeyOfObjectStore(t, r, i, u), o(t, r)
            }
          } else {
            const r = t,
              s = await l.a.getAllKeyNamesOfObjectStore(i);
            for (const t of s) {
              if (!r(t)) continue;
              const s = "string" == typeof n ? n : n(e, t);
              await l.a.renameKeyOfObjectStore(t, s, i, u), o(t, s)
            }
          }
        }
      }
      ...
      class F extends y {
        async exec(e, t) {
          const {
            ...
            i && a && a.log(`indexedDB - Delete ${e}}`)
          };
          let u = "";
          u = "string" == typeof s ? s : s(e);
          let _ = null;
          try {
            _ = await l.a.openExistedDB(u)
          } catch (f) {
            if (f.name === x.a) return;
            throw f
          }
          const d = _.objectStoreNames;
          if (Array.isArray(n)) {
            const t = n;
            for (const r of t) d.contains(r) && await B(e, _, r, o, c)
          } else {
            const t = n(e);
            if (Array.isArray(t)) {
              const r = t;
              for (const t of r) d.contains(t) && await B(e, _, t, o, c)
            } else {
              const r = t,
                s = Array.from(d);
              for (const t of s) r(t) && await B(e, _, t, o, c)
            }
          }
          _.close()
        }
      ...
      async function B(e, t, r, s, n) {
        const o = t.transaction(r, "readwrite").objectStore(r);
        if (Array.isArray(s)) {
          const e = s;
          for (const t of e) {
            await l.a.doesObjectStoreHaveKey(t, o) && (await l.a.deleteKeyOfObjectStore(t, o), n(t))
          }
        } else {
          const t = s(e);
          if (Array.isArray(t)) {
            ...
            const e = t,
              r = await l.a.getAllKeyNamesOfObjectStore(o);
            for (const t of r) e(t) && (await l.a.deleteKeyOfObjectStore(t, o), n(t))
          }
        }
      }
      class P extends $ {
      ...
      class W extends y {
        async exec(e, t) {
          const {
            ...
            a && c && (c.log(`indexedDB - Rename ${e} into ${t}`), c.log(`indexedDB - Will encrypt ${t} in its next key reading`))
          };
          let _ = "";
          _ = "string" == typeof s ? s : s(e);
          let d = null;
          ...
          if (Array.isArray(n)) {
            const t = n;
            for (const r of t) f.contains(r) && await U(e, d, r, o, i, u)
          } else {
            const t = n(e);
            if (Array.isArray(t)) {
              const r = t;
              for (const t of r) f.contains(t) && await U(e, d, t, o, i, u)
            } else {
              const r = t,
                s = Array.from(f);
              for (const t of s) r(t) && await U(e, d, t, o, i, u)
            }
          }
          d.close()
        }
      ...
      async function U(e, t, r, s, n, o) {
        ...
        if (Array.isArray(s)) {
          const t = s;
          for (const s of t) {
            if (!(await l.a.doesObjectStoreHaveKey(s, a))) continue;
            const t = "string" == typeof n ? n : n(e, s);
            await l.a.renameKeyOfObjectStore(s, t, a, _, (() => {
              i.a.markIndexedDBKey(c, r, t)
            })), o(s, t)
          }
        } else {
          const t = s(e);
          if (Array.isArray(t)) {
            ...
            for (const t of s) {
              ...
              const s = "string" == typeof n ? n : n(e, t);
              await l.a.renameKeyOfObjectStore(t, s, a, _, (() => {
                i.a.markIndexedDBKey(c, r, s)
              })), o(t, s)
            }
          } else {
            const s = t,
              u = await l.a.getAllKeyNamesOfObjectStore(a);
            for (const t of u) {
              if (!s(t)) continue;
              const u = "string" == typeof n ? n : n(e, t);
              await l.a.renameKeyOfObjectStore(t, u, a, _, (() => {
                i.a.markIndexedDBKey(c, r, u)
              })), o(t, u)
            }
          }
        }
      ...
      const H = new class {
          ...
          init() {
            this.registerActionFactory(f, new v), this.registerActionFactory(g, new S), this.registerActionFactory(h, new T), this.registerActionFactory(I, new L), this.registerActionFactory(D, new M), this.registerActionFactory(p, new V)
          }
          ...
          getActions(e) {
            ...
            for (const r of e) {
              const {
                actionType: e
              } = r, s = this.getActionFactory(e).createAction(r);
              t.push(s)
            }
            return t
          }
      ...
      function X(e, t) {
        if (!Object(o.c)(e)) return !1;
        const r = Object(o.d)(e);
        return t.startsWith(`${r}_`)
      }

      function ee(e) {
        return !!["zinsrc", "tmpr"].some((t => e.startsWith(`${t}_`))) || G.some((t => {
          const r = "^" + t.replace("${userID}", "[0-9]+") + "$";
          return new RegExp(r, "g").test(e)
        }))
      }

      function te(e, t) {
        return !(!t.startsWith("hide-fbadge") || !t.endsWith(e)) || (t === `$auto-replies-state-v1-${e}` || Q.some((r => {
          const s = r.replace("${userID}", e);
          return t.includes(s)
        })))
      }
      ...
      function se(e) {
        ...
        return !!/^[0-9]{19}_msg_/g.test(e) || Z.some((t => {
          const r = "^" + t.replace("${userID}", "[0-9]+") + "$";
          return new RegExp(r, "g").test(e)
        }))
      }
      var ne = [...[new b({
        ...
        let r = t;
        const s = ["deviceSettings", "viewerkey", "_cl_u_r_", "react_"];
        for (const n of s)
          if (t.endsWith(n)) {
            const e = /^[_-]+|[_-]+$/g;
            r = n.replace(e, "");
        ...
        if (t.includes(e))
          if (t === `${e}_${e}`) s = e;
            ...
            const r = /^[_-]+|[_-]+$/gm;
            s = t.split(e).filter((e => "" !== e)).map((e => e.replace(r, ""))).join("_").replace(/^(sh_)+/g, "")
          } return `${r}_${s}`
      }]), new class extends $ {
        constructor(e, t) {
          super(e, g, t)
        ...
        if (!e) throw new q.f;
        const r = Object(o.d)(e);
        if (t === `$auto-replies-state-v1-${e}`) return `${r}_auto-replies-state-v1`;
        let s = t;
        if (t.includes(e))
          if (t === `${e}_${e}`) s = e;
          else {
        ...
        currentSharedKeyVer: 0,
        targetVer: 1
      }, ["zlocalstorage", ["friend-blocked", "info-cache", "retry-cache"], () => e => "string" == typeof e && ee(e) && !J(e), (e, t) => {
        let r = t;
        const s = ["deviceSettings", "viewerkey", "_cl_u_r_", "react_"];
        for (const n of s)
          if (t.endsWith(n)) {
        ...
        currentSharedKeyVer: 0,
        targetVer: 1
      }, ["zsecure-localstorage", ["async-store"], () => e => "string" == typeof e && ee(e) && !J(e), (e, t) => {
        let r = t;
        const s = ["deviceSettings", "viewerkey", "_cl_u_r_", "react_"];
        for (const n of s)
          if (t.endsWith(n)) {
        ...
        currentUserScopedKeyVer: 0,
        targetVer: 1
      }, ["zlocalstorage", ["friend-blocked", "info-cache", "retry-cache"], e => e ? t => "string" == typeof t && re(e, t) && !X(e, t) : [], (e, t) => {
        if (!e) throw new q.f;
        const r = Object(o.d)(e);
        let s = t;
        if (t.includes(e))
        ...
        currentUserScopedKeyVer: 0,
        targetVer: 1
      }, ["zsecure-localstorage", ["async-store"], e => e ? t => "string" == typeof t && re(e, t) && !X(e, t) : [], (e, t) => {
        if (!e) throw new q.f;
        const r = Object(o.d)(e);
        let s = t;
        if (t.includes(e))
        ...
        currentUserScopedKeyVer: 0,
        targetVer: 1
      }, ["zlocalstorage", ["friend-blocked", "info-cache", "retry-cache"], () => e => "string" == typeof e && se(e)]), new N({
        currentSharedKeyVer: 0,
        currentUserScopedKeyVer: 0,
        targetVer: 1
      }, ["zsecure-localstorage", ["async-store"], () => e => "string" == typeof e && se(e)]), new P({
        currentUserScopedKeyVer: 0,
        targetVer: 1
      ...
      const oe = new class {
        ...
        _getRuleMapKey(e) {
          ...
          return Object.hasOwnProperty.call(e, "currentSharedKeyVer") && (t = d(e.currentSharedKeyVer)), Object.hasOwnProperty.call(e, "currentUserScopedKeyVer") && (r = d(e.currentUserScopedKeyVer)), `${t}_${r}_${s}`
        }
        _initRuleMap() {
          const e = ne;
          for (const t of e) {
            const {
              versionObject: e
            } = t, r = this._getRuleMapKey(e);
            let s = [];
            this._ruleMap.has(r) && (s = this._ruleMap.get(r)), s.push(t), this._ruleMap.set(r, s)
          }
        }
        getRules(e, t, r) {
          const s = this._getRuleMapKey({
              currentSharedKeyVer: e,
              targetVer: r
            }),
            n = this._ruleMap.get(s) || [],
          ...
          return [...n, ...i, ...this._ruleMap.get(a) || []]
        }
      };
      var ie = r("N0Be");
      class ae {
      ...
      async function ue(e, t) {
        const {
          currentSharedKeysVer: i,
          currentUserScopedKeysVer: c,
          targetVer: u,
          err: l
        } = t, d = l instanceof Error ? `${function(e){switch(e){case ie.a:return 1;case ie.d:return 2;case ie.b:return 3;case ie.g:return 4;case ie.e:return 5;case ie.f:return 6;case ie.c:return 7;default:return 0}}(l.name)}` : "0";
        i < u && (a.a.setItem(n.l, "0"), a.a.setItem(n.b, d));
        if (null !== e && c < u) {
        ...
        const f = await r("wBhU");
        f.withScope((e => {
          e.setTag(n.j, `${_()}`);
          const {
            err: r
          } = t, o = Object(s.a)(t, ce);
          e.setExtras(o), r instanceof Error ? f.captureException(r) : "string" == typeof r && f.captureMessage(r, f.Severity.Fatal)
        }))
      }

      function _e(e, t, r) {
        const s = oe.getRules(e, t, r);
        return H.getActions(s)
      }

      function le(e) {
        const t = `${Object(o.d)(e)}_${n.n}`;
        if (!a.a.hasItem(t)) return !1;
        return 1 === +a.a.getItem(t)
      }
      async function de(e, t = {}) {
        Object(o.f)();
        const r = null !== e,
          s = null !== a.a.getItem(n.b);
        let c = !1;
        if (r) {
          const t = `${Object(o.d)(e)}_${n.c}`;
          c = null !== a.a.getItem(t)
        }
        const {
          dry: u,
          logger: _
        } = t;
        if (u && (a.a.turnOnDryMode(), l.a.turnOnDryMode()), r && (i.a.init(e), !u && function() {
            const e = n.k;
            return !!a.a.hasItem(e) && 1 == +a.a.getItem(e)
          }() && le(e))) return;
        const f = new ae;
        f.start();
        const g = {
          currentSharedKeysVer: n.d,
          currentUserScopedKeysVer: n.d,
          targetVer: n.d,
          err: null
        };
        g.targetVer = 1;
        let h = n.d;
        !u && a.a.hasItem(n.k) && (h = +a.a.getItem(n.k), g.currentSharedKeysVer = h), s && (h = n.a);
        let I = n.d;
        if (r) {
          const t = `${Object(o.d)(e)}_${n.n}`;
          !u && a.a.hasItem(t) && (I = +a.a.getItem(t), g.currentUserScopedKeysVer = I)
        }
        c && (I = n.a), await new Promise((async s => {
          const i = setTimeout((async () => {
            const t = new q.c;
            _ && _.error(t.message), g.err = t, await ue(e, g), s()
          }), n.e);
          try {
            for (;;) {
              const r = _e(h, I, 1);
              if (0 === r.length) break;
              for (const s of r) await s.exec(e, t);
              h < 1 && h !== n.a && (h += 1, g.currentSharedKeysVer = h), null !== I && I !== n.a && I < 1 && (I += 1, g.currentUserScopedKeysVer = I)
            }
            if (clearTimeout(i), h !== n.a && (a.a.setItem(n.k, d(1)), a.a.setItem(n.l, "1")), r && I !== n.a) {
              const t = Object(o.d)(e),
                r = `${t}_${n.n}`;
              a.a.setItem(r, d(1));
              const s = `${t}_${n.m}`;
        ...
        const D = f.getDuration();
        if (null !== D) {
          if (a.a.setItem(n.f, `${D}`), r) {
            const t = Object(o.d)(e);
            a.a.setItem(`${t}_${n.g}`, `${D}`)
          }
          f.reset()
        }
        const p = a.a.getAllKeyNames().length + await async function() {
          let e = 0;
          const t = ["friend-blocked", "info-cache", "retry-cache"];
          for (const r of t) e += await l.a.getTotalKeyCountOfStore("zlocalstorage", r);
          return e += await l.a.getTotalKeyCountOfStore("zsecure-localstorage", "async-store"), e
        }();
        if (a.a.setItem(n.h, `${p}`), r) {
          const t = Object(o.d)(e);
          a.a.setItem(`${t}_${n.i}`, `${p}`)
        }
      }
    },
    Cvfp: function(e, t, r) {
        ...
        try {
          switch (__ZaBUNDLENAME__.toLocaleLowerCase()) {
            ...
            case "preload-shared-worker":
              e = s.b.PreloadSharedWorker;
              break;
            case "preload-sqlite":
              e = s.b.PreloadSQLite;
              break;
            case "utility-process-sqlite":
              e = s.b.UProcessSQLite;
              break;
            default:
              e = s.b.Unknown
          }
    ...
    N0Be: function(e, t, r) {
      ...
      const s = "ExistedActionHandlerError",
        n = "NonExistedActionHandlerError",
        o = "InvalidInitializedDataForSecureKeysToMigrateError",
        i = "UninitializedSecureKeysToMigrateError",
        a = "SecureKeysToMigrateInvalidIDBKeyError",
        c = "UnavailableUserIDForKeynameGenerationError",
        u = "MigrateTimeoutError"
    },
    PLj1: function(e, t, r) {
      "use strict";
      r.d(t, "b", (function() {
      ...
      var s = r("fsQs");
      let n = function(e) {
        return e.Main = "main", e.Render = "render", e.SharedWorker = "shared-worker", e.PreloadSharedWorker = "preload-shared-worker", e.Unknown = "unknown", e.Photo = "photo", e.Web = "web", e.Embed = "embed", e.Login = "login", e.PreloadSQLite = "preload-sqlite", e.UProcessSQLite = "u-process-sqlite", e
      }({});
      const o = {
          [n.Main]: s.f,
          [n.Render]: s.f,
          [n.SharedWorker]: s.f,
          [n.PreloadSharedWorker]: s.g,
          [n.PreloadSQLite]: s.f,
          [n.Unknown]: s.f,
          [n.Photo]: s.f,
          [n.Web]: s.h,
    ...
    QxEN: function(e, t, r) {
      ...
      if (o) {
        for (const [t, r] of Object.entries(a))
          if ("release" === t)
            for (const e of r) o[e] = i;
        globalThis.zconsole = o;
        const e = n.a.create(["zconsole", "nullLogger"], {});
        Object(s.a)(e, !0)
      }
    },
    UJDs: function(e, t, r) {
    ...
    YdFT: function(e, t, r) {
      ...
      class a extends n.a {
        constructor(e, t, r, s) {
          super(o.a.DB_CORRUPTION_DETECTED), this.tsStartCheck = e, this.adapterType = t, this.corruptionInfo = r, this.options = s
        }
      }
      class c extends a {
        constructor(e, t) {
          super(e, i.AdapterType.IDB, {
            type: s.a.FULL,
            databaseCorruptInfo: {
              database: ""
            },
      ...
      class u extends a {
        constructor(e, t) {
          super(e, i.AdapterType.SQLite, t, {
    ...
    YrRS: function(e, t, r) {
      ...
      function c() {
        const e = Object(o.a)();
        if (n.a.includes(e)) return;
        s.ModuleContainer.resolve(i.a).setupWriters();
        _(s.ModuleContainer.resolve(a.a).createZLogger("zconsole", ["zlogger"]))
      }
      const u = function() {};

      function _(e, t = !1) {
        const r = ["_applyFilter", "_getLevel", "_transport"],
          s = Object.getOwnPropertyNames(e).filter((t => "function" == typeof e[t] && !r.includes(t)));
        if (globalThis.zconsole)
          for (const n of s) globalThis.zconsole[n] = t ? u : e[n].bind(e)
      }
    },
    bH0y: function(e, t, r) {
      "use strict";
      ...
      const i = new class {
        ...
        init(e) {
          ...
          null !== o && (r = JSON.parse(o));
          const {
            l: i,
            i: a
          } = r;
          this._localStorageKeys = i, this._indexedDBKeys = a
        }
        _hasInitialized() {
          return null !== this._keyName && null !== this._localStorageKeys && null !== this._indexedDBKeys
        }
        _getKeyName() {
          if (!this._hasInitialized()) throw new s.g;
          return this._keyName
        }
        _getSecureIndexedDBKey(e, t, r) {
          return [e, t, r].join(o.a)
        }
        getSecureIndexedDBKeyObject(e) {
          const t = e.split(o.a);
          if (3 !== t.length) throw new s.e;
          const [r, n, i] = t;
          return {
            dbName: r,
            storeName: n,
        ...
        markIndexedDBKey(e, t, r) {
          const s = this._getSecureIndexedDBKey(e, t, r);
          this.isIndexedDBKeyMarked(s) || this.getIndexedDBKeys().push(s)
        }
        unmarkIndexedDBKey(e, t, r) {
          const s = this._getSecureIndexedDBKey(e, t, r);
          if (!this.isIndexedDBKeyMarked(s)) return;
          const n = this.getIndexedDBKeys().indexOf(s);
          this.getIndexedDBKeys().splice(n, 1)
        }
        save() {
    ...
    buT3: function(e, t, r) {
      ...
      const s = "LOCAL_STORAGE_MODE/DEFAULT",
        n = "LOCAL_STORAGE_MODE/DRY";
      const o = new class {
        constructor() {
          this._mode = s
        }
        ...
        setItem(e, t) {
          this._mode !== n && window.localStorage.setItem(e, t)
        }
        getItem(e) {
    ...
    dUtG: function(e, t, r) {
      ...
      var c = class {
        constructor(e) {
          this.name = "IntegrationEventFilter", this.config = void 0, this.logger = new a("sentry-uhrf"), this.config = "object" == typeof e ? Object(i.a)(Object(i.a)({}, s), e) : s, this.logInfo("init success")
        }
        logInfo(...e) {
        ...
        _checkInBlacklistOriginException(e) {
          ...
          const t = this.config.blacklistOriginException || [],
            r = e.originalException || {};
          if ("string" != typeof r.name) return !1;
          if ("string" != typeof r.message) return !1;
          return !!t.find((e => {
            if (e === r) return !0;
            if (e && r instanceof Error) {
              if (r.name.includes(e)) return !0;
        ...
        _checkInBlacklistSentryException(e) {
          ...
          return !!e.exception.values.find((e => {
            const r = (e || {}).value;
            return !!r && t.find((e => r.includes(e)))
          }))
        }
        _handleFilter(e, t) {
        ...
        setupOnce(e, t) {
          e(((e, t) => {
            if (this.logInfo("receive event", {
              ...
              const r = this._handleFilter(e, t);
              return this.logInfo("result filter", r), r
            }
            return e
          }))
        }
      ...
      var _ = class {
        ...
        initSentry(e) {
          ...
          if (r && s.dsn) try {
            this.sentry.init({
              dsn: s.dsn,
              integrations: e => (e.push(new c(s.integrationFilter)), e),
              release: "Zalo24.9.1",
              environment: "production",
              beforeSend: e => {
                let r = u(e);
                return this.logger.info(`Message key error: ${r}`), t.has(r) ? (this.logger.info("Error already exists!. Not sent to server"), null) : (t.set(r, !0), this.logger.info("sent error to sentry server"), e)
              }
            }), this.logger.info("sentry init success")
          } catch (n) {
            this.logger.error("sentry init error", n)
      ...
      class l extends _ {
        ...
        loadConfig() {
          try {
            ...
            return e ? (this.logger.info("Load config from file sentry-config.json"), e) : (this.logger.info("Load config from default config"), n)
          } catch (e) {
            return this.logger.error(`Load config file error. \n${e} \nLoad config from default config`), n
          }
        }
      }
      l._instance = null, l.getInstance().install()
    },
    dko3: function(e, t, r) {
      "use strict";
      var s = r("wH4e"),
      ...
      class i {
        ...
        handleConnectionClosedAbnormally(e) {
          o.ModuleContainer.resolve(n.TDBCorruptionDetector).forceCheckDBCorruptionFor(s.AdapterType.IDB)
        }
      }
      i._instance = void 0;
      var a = i;
        ...
        set onsuccess(e) {
          this.openRequest.onsuccess = async t => {
            this.openRequest.result.onclose = e => {
              a.instance().handleConnectionClosedAbnormally(e)
            }, await e(t)
          }
        }
        set onblocked(e) {
      ...
      t.a = class {
        constructor() {}
        static open(e, t) {
          const r = window.indexedDB.open(e, t);
          return new c(r)
        }
      }
    },
    eBEg: function(e, t, r) {
      ...
      function a() {
        ...
        return o.forEach((s => {
          i.forEach((o => {
            "" === o ? (t[e] = `${n}${s}A`, r[`${n}${s}A`] = e, e += 1) : "T" === o ? (t[e] = `${n}${s}AT`, r[`${n}${s}AT`] = e, e += 1) : (t[e] = `${n}${s}${o}`, r[`${n}${s}${o}`] = e, e += 1)
          }))
        })), {
          EnumeratedLevels: t,
          ReversedEnumeratedLevels: r
        }
      }
      Object.freeze(i), Object.freeze(o);
      ...
      class h {
        constructor(e, t) {
          this.tags = e, this.transporters = t, this.enabled = !0, this.Sentry = null, this.tempOffConfig = {
          ...
          }, this.zfatal = (...e) => {}, this.zcritical = (...e) => {}, this.zsymb = (e, t, ...r) => {
            if (!this.enabled) return;
            const s = c[e];
            let n = [];
            if (s.endsWith("T") && (null == r ? void 0 : r.length) > 0 && (n = r.shift()), s.includes("zcritical")) return void(this.Sentry && this.Sentry.captureException(new Error(r.join(" "))));
            const o = this._getLevel(s);
            let i = "None";
            s.endsWith("A") || s.endsWith("AT") ? i = "ConsoleFile" : s.endsWith("C") || s.endsWith("CT") ? i = "toConsole" : (s.endsWith("F") || s.endsWith("FT")) && (i = "toFile"), "None" !== i && this._applyFilter({
              metadata: {
                tick: Date.now(),
                level: o,
                ln: t,
            ...
            if (!f[e.metadata.level]) return;
            let t = e.metadata.targetTransporter;
            const r = _.ModuleContainer.resolve(l.a),
              s = Object(d.a)(),
              n = !!this.transporters.consoleTransporter && g.a[s].toConsole && r.isEnabledConsole(),
              o = !!this.transporters.fileTransporter && g.a[s].toFile;
            "ConsoleFile" === t && (n || (t = "toFile"), o || (t = "None")), "toConsole" !== t || n || (t = "None"), "toFile" !== t || o || (t = "None"), "None" !== t && (e.metadata.targetTransporter = t, this._transport(e))
          }, this._transport = e => {
            const t = e.metadata.targetTransporter;
            var r, s;
            "toConsole" !== t && "ConsoleFile" !== t || (null === (r = this.transporters.consoleTransporter) || void 0 === r || r.transport(e));
            "toFile" !== t && "ConsoleFile" !== t || (null === (s = this.transporters.fileTransporter) || void 0 === s || s.transport(e))
          }, this._getLevel = e => {
            let t = e;
    ...
    gNXM: function(e, t, r) {
      ...
      const c = new class {
        ...
        async openExistedDB(e) {
          ...
          return await new Promise(((r, s) => {
            t.onupgradeneeded = function() {
              var r;
              null === (r = t.transaction) || void 0 === r || r.abort(), s(new o.b(`No database whose name is ${e} exists`))
        ...
        async renameKeyOfObjectStore(e, t, r, n, o = (() => {})) {
          const i = await this.getKeyDataInObjectStore(e, r);
          this._mode !== a && (await new Promise(((t, s) => {
            const n = r.delete(e);
            n.onsuccess = function() {
              t()
            }, n.onerror = function() {
            ...
            const a = r.put(Object(s.a)(Object(s.a)({}, i), {}, {
              [n]: t
            }));
        ...
        async deleteKeyOfObjectStore(e, t) {
          this._mode !== a && await new Promise(((r, s) => {
            const n = t.delete(e);
            n.onsuccess = function() {
              r()
            }, n.onerror = function() {
        ...
        async getTotalKeyCountOfStore(e, t) {
          let r = null;
          try {
            r = await this.openExistedDB(e)
          } catch (n) {
            return -1
          }
          if (!r.objectStoreNames.contains(t)) return -1;
          const s = r.transaction(t, "readwrite").objectStore(t);
          r.close();
          return (await this.getAllKeyNamesOfObjectStore(s)).length
        }
      }
    },
    gbvv: function(e, t, r) {
    ...
    ggcH: function(e, t, r) {
      "use strict";
      var s = r("YdFT");
      r.d(t, "IndexedDBCorruptionDetectedEvent", (function() {
        return s.a
      })), r.d(t, "SQLiteDBCorruptionDetectedEvent", (function() {
        return s.b
      }));
      var n = r("vvAz");
      r.o(n, "TDBCorruptionDetector") && r.d(t, "TDBCorruptionDetector", (function() {
        return n.TDBCorruptionDetector
      })), r.o(n, "TDBCorruptionDetectorAdapter") && r.d(t, "TDBCorruptionDetectorAdapter", (function() {
        return n.TDBCorruptionDetectorAdapter
      }));
      var o = r("7k+P");
      r.d(t, "TDBCorruptionDetector", (function() {
        return o.a
      })), r.d(t, "TDBCorruptionDetectorAdapter", (function() {
        return o.b
      }))
    },
    iGh7: function(e, t, r) {
      "use strict";
      r("cOPa"), r("mNvP"), r("QxEN")
    },
    vvAz: function(e, t) {},
    wbRq: function(e, t, r) {
      "use strict";
