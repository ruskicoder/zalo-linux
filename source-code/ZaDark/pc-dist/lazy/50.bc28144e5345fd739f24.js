/**
 * Deobfuscated from: 50.bc28144e5345fd739f24.js
 * Generated: 2025-10-05T13:04:42.354Z
 * 
  ...
  [50], {
    YQdx: function(e, a, t) {
      ...
      function y(e) {
        const a = {
          ...
          s = e.data.map((e => {
            let s, r = !1,
              u = e.value;
            return Object(m.b)(e.value) ? (u = _(e.value, void 0, 2), r = !0, s = n.a.createElement(c.UnControlled, {
              value: u,
              options: a
            })) : ("time" === e.type && (u = `${u} (${function(e){const a=new Date(+e);if(isNaN(a.getTime()))return"";const t=String(a.getHours()).padStart(2,"0"),l=String(a.getMinutes()).padStart(2,"0"),s=String(a.getSeconds()).padStart(2,"0"),n=String(a.getDate()).padStart(2,"0"),c=a.getMonth();return`${t}:${l}:${s} - ${E[c]} ${n}, ${a.getFullYear()}`}(u)})`), u += "", s = n.a.createElement("div", {
              className: "h100 truncate-5"
            }, u)), n.a.createElement(g.d, {
              ...
              className: Object(l.a)("debug-message-info__value-cell", "debug-message-info__value-cell--hoverable", r && "debug-message-info__value-cell--no-padding", "clickable"),
              onClick: a => {
                t(a, _(e.value, void 0, 2))
              }
            }, s, n.a.createElement(o.a, {
              className: Object(l.a)("Copy_24_Line", "debug-message-info__value-cell-copy-icon", r && "debug-message-info__value-cell-copy-icon--top")
            }))))
          }));
        return n.a.createElement(g.a, {
          ...
          vCenter: !0
        }, "Value"))), n.a.createElement("div", null, s))
      }
      a.default = function(e) {
        ...
        if (null == t || !t.message || !v.a.includes(t.message.msgType)) return null;
        const [l, c] = Object(s.useState)({}), [r, o] = Object(s.useState)([]), i = [{
          property: "Over 14 days",
          value: Date.now() - (null == t || null === (a = t.message) || void 0 === a ? void 0 : a.sendDttm) > 12096e5 ? "true" : "false",
          type: ""
        }], m = Object.keys(l || {}).sort(), g = ["mediaInfo", "msgInfo", "encryptInfo"], _ = ["ts"], E = n.a.useRef(0);
        return r.forEach(((e, a) => {
          ...
          Object(b.d)("info for message", t)
        }), []), Object(s.useEffect)((() => {
          p.a.getCloudItem(null == t ? void 0 : t.message).then(c).catch((e => {
            Object(b.d)("Get cloud info failed", e)
          }))
        }), []), Object(s.useEffect)((() => {
          let {
            message: e
          ...
          if (e) {
            let a = (new f.a(e).withRawResult(!0).run() || []).map((e => null == e ? void 0 : e.path));
            o(a)
          }
        }), [t]), n.a.createElement(u.b, {
          onScroll: e => {
            var a, t, l;
            ...
            E.current = null !== (t = null === (l = e.srcElement) || void 0 === l ? void 0 : l.scrollTop) && void 0 !== t ? t : E.current
          }
        }, n.a.createElement("div", {
        ...
        }, "ZCloud Info")), n.a.createElement("div", {
