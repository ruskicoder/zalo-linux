/**
 * Deobfuscated from: 38.67f1ec6882c9130825bc.js
 * Generated: 2025-10-05T13:04:42.341Z
 * 
...
(this.webpackJsonp = this.webpackJsonp || []).push([
  [38], {
    Ds0a: function(e, t, n) {
      ...
      var u = e => {
          ...
          return {
            containerStyle: Object(o.useMemo)((() => ({
              ...
              height: n,
              padding: "2px 8px",
              backgroundColor: "rgba(14, 31, 115, 0.5)",
              color: "rgb(116, 242, 255)",
              fontSize: "12px",
            ...
            graphStyle: Object(o.useMemo)((() => ({
              ...
              bottom: "8px",
              height: r ? n - 42 : n - 30,
              backgroundColor: "rgba(14, 31, 115, 0.45)",
              overflow: "hidden",
            ...
            getBarStyle: Object(o.useCallback)(((e, t) => ({
              ...
              right: 4 * (a - 1 - t) + "px",
              width: "4px",
              height: ((r ? n - 42 : n - 30) - 2) * e,
              backgroundColor: "rgba(116, 242, 255, 0.7)",
      ...
      const f = {
        ...
        m = Object(o.memo)((() => {
          ...
          Object(o.useEffect)((() => {
            ...
            return b.a.UIManager.on(g.a.VISUALIZE_INFO, e), () => {
              b.a.UIManager.removeListener(g.a.VISUALIZE_INFO, e)
            }
          }), []);
        ...
        h = Object(o.memo)((e => {
          ...
          Object(o.useEffect)((() => {
            ...
            const i = r => {
              let u, b, g;
              if (t || (t = r), u = (r - t) / 10 / 1e3, b = 500 * u / 7, g = -1 * b * b + l * b + c, n && n > g) {
                const e = o + 1;
                o = e, a.current.style.transform = `rotate(${e}deg)`
              }
              n = g, a.current.style.left = 7 * b + "px", a.current.style.bottom = 7 * g + "px", 7 * g < -1e3 || u >= 1 ? e.onDone(e.id) : s(i)
            };
            s(i)
          }), []);
          const s = Object(o.useCallback)((e => {
      ...
      var O = m;
      const x = r.a.lazy((() => n.e(44).then(n.bind(null, "2CG1")))),
        j = r.a.lazy((() => n.e(45).then(n.bind(null, "IODd")))),
        v = Object(o.memo)((e => {
          const {
            width: t = 64,
            height: n = 64
          ...
          return Object(o.useEffect)((() => {
            ...
            var t;
            s && (b.a.UIManager.on(g.a.TOGGLE_FPS_FALLING, e), f(!(null === (t = b.a.UIManager.Tool) || void 0 === t || !t.isOpen())));
            return () => {
              b.a.UIManager.removeListener(g.a.TOGGLE_FPS_FALLING, e)
            }
          }), [s]), s ? r.a.createElement("div", {
            style: m
          }, r.a.createElement(r.a.Suspense, {
            fallback: null
          }, r.a.createElement(j, null)), d ? r.a.createElement(r.a.Suspense, {
            fallback: null
          }, r.a.createElement(x, null)) : r.a.createElement("span", null, l, " FPS"), r.a.createElement("div", {
            style: h
...
//# sourceMappingURL=../sourcemaps/lazy/38.67f1ec6882c9130825bc.js.map
