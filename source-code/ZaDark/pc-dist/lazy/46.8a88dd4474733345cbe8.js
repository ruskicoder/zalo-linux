/**
 * Deobfuscated from: 46.8a88dd4474733345cbe8.js
 * Generated: 2025-10-05T13:04:42.348Z
 * 
    ...
    AYQT: function(t, e, s) {
      ...
      const l = function() {
        ...
        return function(e, s, r) {
          ...
          const a = Object(c.a)(s, n.AdapterType.IDB),
            o = (null == a ? void 0 : a.partitionsMap.default.tables.filter((t => t.tableName === r))[0]).getTransformConfigs(n.AdapterType.IDB);
          return o.forEach((t => {
            t.init(e)
          })), t.set(i, o), o
        }
      ...
      class u {
        constructor(t, e) {
          ...
          this.logger = s.createZLogger(h.ZLoggerNametags.liteIDB, [h.ZLoggerNametags.liteIDB])
        }
        acquireDB() {
          return new Promise((async (t, e) => {
            if (this.db) return t(this.db);
            const s = d.a.open(this.dbName);
            s.onsuccess = () => {
              this.db = s.result, t(this.db)
            }, s.onerror = t => {
              this.logger.zsymb(18, "VN4ud-", "open db error", this.dbName, t), e(t)
            }, s.onupgradeneeded = t => {
              this.logger.zsymb(0, "KEDzJS", "on db upgrade");
              const e = Object(c.a)(this.dbIdentity, n.AdapterType.IDB);
              null == e || e.partitionsMap.default.tables.map((e => {
                let s = {};
                if (e.isNonFieldlikeEntity) s = {
                  ...
                  s = {
                    keyPath: Object(n.firstOrArray)(t.getRealFields()),
        ...
        writeTrans(t) {
          return new Promise(((e, s) => {
            this.acquireDB().then((r => {
              const i = r.transaction([t], "readwrite");
              i.oncomplete = e, i.onerror = s, e(i)
            }))
          }))
        }
        async writeStore(t) {
      ...
      class b extends u {
        constructor(t, e, s) {
          super(s, e), this.uin = t, this.transforms = void 0, this.transforms = []
        }
        toDBTransform(t) {
          ...
          return new Promise((r => {
            try {
              ...
              i.onsuccess = t => {
                ...
                var s, i;
                r(void 0), t.preventDefault(), t.stopPropagation(), 0 !== (null === (s = t.target) || void 0 === s || null === (i = s.error) || void 0 === i ? void 0 : i.code) && this.logger.zsymb(18, "5mNhvP", "import err: ", t, e)
              }
            } catch (i) {
              this.logger.zsymb(18, "iDFdPD", "add err", i, e), r(void 0)
            }
          }))
        }
        async import(t, e) {
          this.transforms = l(this.uin, this.dbIdentity, t);
          const s = await this.writeStore(t),
            r = this.toDBTransform(e).reduce(((t, r, i) => (t.push(this.add(s, r, e[i])), t)), []);
      ...
      class m {
        ...
        insert(t, e, s) {
          const r = this.getDB(t, this.getDBName(t));
          return r ? r.import(e, s).then((t => t)) : Promise.resolve({
            success: [],
            fail: []
          })
        }
      ...
      class f {
        ...
        insertMulti(t, e = r.a.DefaultInsertOptions) {
          return p.insert(this.databaseName, this.tableName, t)
        }
      }
      let I = Object(a.singleton)(r.b)(g = Reflect.metadata("design:type", Function)(g = Reflect.metadata("design:paramtypes", [])(g = class {
        constructor() {
