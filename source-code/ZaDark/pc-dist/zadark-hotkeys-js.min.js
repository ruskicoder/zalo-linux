/**
 * Deobfuscated from: zadark-hotkeys-js.min.js
 * Generated: 2025-10-05T13:04:48.591Z
 * 
...
/*! hotkeys-js v3.10.2 | MIT © 2023 kenny wong <wowohoo@qq.com> http://jaywcjlove.github.io/hotkeys */ ! function(e, t) {
  ...
  function y(e) {
    for (var t = (e = (e = "string" != typeof e ? "" : e).replace(/\s/g, "")).split(","), n = t.lastIndexOf(""); 0 <= n;) t[n - 1] += ",", t.splice(n, 1), n = t.lastIndexOf("");
    return t
  }
  for (var o = {
      backspace: 8,
      ...
      17: !1,
      91: !1
    }, v = {}, t = 1; t < 20; t++) o["f".concat(t)] = 111 + t;
  var k = [],
    w = !1,
    n = "all",
    O = [],
  ...
  function f(e) {
    ...
    y(e.key).forEach(function(e) {
      var t, e = e.split(f),
        ...
        o = e[n - 1],
        o = "*" === o ? "*" : K(o);
      v[o] && (r = r || b(), t = 1 < n ? p(h, e) : [], v[o] = v[o].filter(function(e) {
        return !((!i || e.method === i) && e.scope === r && function(e, t) {
  ...
  function x(e, t, n, o) {
    ...
    if (t.element === o && (t.scope === n || "all" === t.scope)) {
      for (var i in r = 0 < t.mods.length, g) Object.prototype.hasOwnProperty.call(g, i) && (!g[i] && ~t.mods.indexOf(+i) || g[i] && !~t.mods.indexOf(+i)) && (r = !1);
      (0 !== t.mods.length || g[16] || g[18] || g[17] || g[91]) && !r && "*" !== t.shortcut || !1 === t.method(e, t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, e.stopPropagation && e.stopPropagation(), e.cancelBubble && (e.cancelBubble = !0))
    }
  }
  ...
  function C(n, e) {
    ...
    if (E.filter.call(this, n)) {
      if (~k.indexOf(o = 93 !== o && 224 !== o ? o : 91) || 229 === o || k.push(o), ["ctrlKey", "altKey", "shiftKey", "metaKey"].forEach(function(e) {
          var t = m[e];
      ...
      n.getModifierState && (!n.altKey || n.ctrlKey) && n.getModifierState("AltGraph") && (~k.indexOf(17) || k.push(17), ~k.indexOf(18) || k.push(18), g[17] = !0, g[18] = !0);
      var f = b();
      if (t)
        for (var c = 0; c < t.length; c++) t[c].scope === f && ("keydown" === n.type && t[c].keydown || "keyup" === n.type && t[c].keyup) && x(n, t[c], f, e);
      if (o in v)
        for (var a = 0; a < v[o].length; a++)
          if (("keydown" === n.type && v[o][a].keydown || "keyup" === n.type && v[o][a].keyup) && v[o][a].key) {
            for (var l = v[o][a], s = l.key.split(l.splitKey), u = [], d = 0; d < s.length; d++) u.push(K(s[d]));
  ...
  function E(e, t, n) {
    ...
    void 0 !== f && (t = f, !~O.indexOf(t)) && window && (O.push(f), d(f, "keydown", function(e) {
      C(e, f)
    }, u), w || (w = !0, d(window, "focus", function() {
      k = []
    }, u)), d(f, "keyup", function(e) {
      C(e, f);
  ...
  var r, c, a = {
    getPressedKeyString: function() {
      return k.map(function(e) {
        return n = e, Object.keys(o).find(function(e) {
          return o[e] === n
        }) || (t = e, Object.keys(h).find(function(e) {
          return h[e] === t
    ...
    unbind: function(e) {
      if (void 0 === e) Object.keys(v).forEach(function(e) {
        return delete v[e]
      });
  ...
  return "undefined" != typeof window && (c = window.hotkeys, E.noConflict = function(e) {
    return e && window.hotkeys === E && (window.hotkeys = c), E
  }, window.hotkeys = E), E
});
