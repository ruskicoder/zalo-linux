/**
 * Deobfuscated from: opfs-worker.3a6ecf693cff2fc53577.js
 * Generated: 2025-10-05T13:04:47.826Z
 * 
...
__ZaBUNDLENAME__ = "opfs-worker", __SCRIPT_TYPE__ = "web-worker",
  function(t) {
    var e = {};
    ...
    "5DaW": function(t, e, n) {
      ...
      function y() {
        const t = Object(o.e)();
        t.__SENTRY__ && (t.__SENTRY__.extensions = t.__SENTRY__.extensions || {}, t.__SENTRY__.extensions.startTransaction || (t.__SENTRY__.extensions.startTransaction = _), t.__SENTRY__.extensions.traceHeaders || (t.__SENTRY__.extensions.traceHeaders = p), u || (u = !0, Object(a.b)("error", f), Object(a.b)("unhandledrejection", f)))
      }
    },
    "5FGm": function(t, e, n) {
      "use strict";
      ...
      const r = Object.freeze({
        ...
        i = "cal";
      let o = function(t) {
        return t[t.None = 0] = "None", t[t.FlushNow = 1] = "FlushNow", t[t.FlushOnNextRun = 2] = "FlushOnNextRun", t
      }({})
    },
    "5l/R": function(t, e, n) {
      "use strict";
      ...
      function h(t) {
        if (!p[t]) switch (p[t] = !0, t) {
          ...
          case "history":
            ...
            break;
          case "error":
            w = f.onerror, f.onerror = function(t, e, n, r, i) {
              return g("error", {
                column: r,
                error: i,
                line: n,
          ...
          case "unhandledrejection":
            j = f.onunhandledrejection, f.onunhandledrejection = function(t) {
              return g("unhandledrejection", t), !(j && !j.__SENTRY_LOADER__) || j.apply(this, arguments)
      ...
      function O(t, e = !1) {
        return n => {
          ...
          (void 0 === S || function(t, e) {
            ...
            name: r,
            global: e
          }), T = n), clearTimeout(S), S = f.setTimeout((() => {
            S = void 0
          }), E)
        }
      }
      ...
      function f(t, e, n = Object(r.a)(t.bufferSize || u)) {
        ...
        function d(r) {
          ...
          return n.add((() => e({
            ...
            if (t instanceof c.a) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && a.c.error("Skipped sending event because buffer is full."), p("queue_overflow"), Object(s.c)();
            throw t
          }))
        }
    ...
    GIgW: function(t, e, n) {
      ...
      function y(t, e = g()) {
        if (!v(t) || E(t).isOlderThan(f)) {
          ...
          S(t, new d(n.client, c.a.clone(n.scope)))
        }
      }
    ...
    S8fy: function(t, e, n) {
      ...
      var S = function(t) {
        ...
        O = function() {
          this.preResolution = new S, this.postResolution = new T
        },
        w = new Map,
        j = function() {
          function t(t) {
            this.parent = t, this._registry = new m, this.interceptors = new O
          }
    ...
    gqaZ: function(t, e, n) {
      ...
      n("KFwE");
      let r = function(t) {
          return t.ping = "ping", t.initBinaryLogFile = "initBinaryLogFile", t.getFileSize = "getFileSize", t.readRange = "readRange", t.writeRange = "writeRange", t.getWebLogFileAsBuffer = "getWebLogFileAsBuffer", t.removeFile = "removeFile", t.closeWorker = "closeWorker", t
        }({}),
        i = function(t) {
          return t.pong = "pong", t.onWorkerReady = "onWorkerReady", t.responseInitBinaryFile = "responseInitBinaryFile", t.responseFileSize = "responseFileSize", t.responseReadRange = "responseReadRange", t.responseWriteRange = "responseWriteRange", t.responseGetWebLogFileAsBuffer = "responseGetWebLogFileAsBuffer", t
        }({});
      var o = n("5FGm"),
        s = n("1BPm");
      const a = new Map,
        c = async t => {
          ...
          const e = await navigator.storage.getDirectory(),
            n = await e.getFileHandle(t, {
              create: !0
            }),
            r = await n.createSyncAccessHandle();
          return a.set(t, r), r
        };
      self.postMessage({
        type: i.onWorkerReady
        ...
        try {
          switch (e.type) {
              ...
              const t = e.payload,
                n = await (async t => {
                  ...
                  try {
                    ...
                    n = o.c.Failure({
                      code: s.a.UnknownError,
                      message: `getFileSize failed for ${t}`
                    })
                  }
                  return n
                })(t.filePath);
              self.postMessage({
                type: i.responseFileSize,
                payload: {
                  filePath: t.filePath,
                  response: n
                }
              ...
              const t = e.payload,
                n = await (async (t, e) => {
                  ...
                  try {
                    ...
                    i = o.c.Failure({
                      code: s.a.UnknownError,
                      message: `initBinaryLogFile failed for ${t}`
                    })
                  }
                  return i
                })(t.filePath, t.initData);
              self.postMessage({
                type: i.responseInitBinaryFile,
                payload: {
                  filePath: t.filePath,
                  response: n
                }
            ...
            case r.readRange: {
              const t = e.payload,
                n = await (async (t, e, n) => {
                  ...
                  let i;
                  try {
                    if (0 === r.getSize()) i = o.c.Failure({
                      code: s.a.FileNotFound,
                      message: `readRange failed for ${t}`
                    });
                    else {
                    ...
                    zconsole.error("ZLOG: readRange has error", a), i = o.c.Failure({
                      code: s.a.UnknownError,
                      message: `readRange failed for ${t}`
                    })
                  }
                  return i
                })(t.filePath, t.start, t.end);
              self.postMessage({
                type: i.responseReadRange,
                payload: {
                  filePath: t.filePath,
                  response: n
                }
              ...
              const t = e.payload,
                n = await (async (t, e, n) => {
                  ...
                  try {
                    ...
                    a = o.c.Failure({
                      code: s.a.UnknownError,
                      message: `writeRange failed for ${t}`
                    })
                  }
                  return a
                })(t.filePath, t.offset, t.data);
              self.postMessage({
                type: i.responseWriteRange,
                payload: {
                  filePath: t.filePath,
                  response: n
                }
            ...
            case r.getWebLogFileAsBuffer: {
              const t = e.payload,
                n = await (async t => {
                  ...
                  try {
                    ...
                    zconsole.error("ZLOG: getAllFileContent throws error", r), n = o.c.Failure({
                      code: s.a.UnknownError,
                      message: `readRange failed for ${t}`
                    })
                  }
              ...
              self.postMessage({
                type: i.responseGetWebLogFileAsBuffer,
                payload: {
                  filePath: t.filePath,
                  response: n
                }
                ...
                n = await (async t => {
                  try {
                    ...
                    return (await e.getFileHandle(t, {
                      create: !0
                    })).remove(), o.c.Success(!0)
                  } catch (e) {
                    return o.c.Failure({
                      code: s.a.UnknownError,
                      message: `deleteFile failed for ${e}`
                    })
                  }
                })(t.filePath);
              zconsole.log("ZLOG: removeFile response", n);
              break
            }
            case r.closeWorker:
              a.forEach((t => {
          ...
          zconsole.error("ZLOG: cal-worker caught error", n)
        }
      }
    },
    h6tn: function(t, e, n) {
      ...
      function f(t, e) {
        return void 0 === e && (e = {}),
          function(t, e) {
            void 0 === e && (e = {});
            for (var n = e.splitRegexp, r = void 0 === n ? s : n, i = e.stripRegexp, u = void 0 === i ? a : i, f = e.transform, l = void 0 === f ? o : f, d = e.delimiter, p = void 0 === d ? " " : d, h = c(c(t, r, "$1\0$2"), u, "\0"), _ = 0, g = h.length;
              "\0" === h.charAt(_);) _++;
            for (;
              "\0" === h.charAt(g - 1);) g--;
    ...
    kdvv: function(t, e, n) {
      ...
      (function(t) {
        ...
        const h = (() => {
          ...
          return s || c < e ? i <= c ? (p = "timeOrigin", t.timeOrigin) : (p = "navigationStart", a) : (p = "dateNow", r)
        })()
      }).call(this, n("3UD+")(t))
    },
    lddD: function(t, e, n) {
            ...
            void 0 === i.Reflect ? i.Reflect = n : o = s(i.Reflect, o),
              function(e) {
                ...
                function _(t, e, n, r) {
                  ...
                  if (!L(r) && !P(r) && !B(r)) throw new TypeError;
                  return B(r) && (r = void 0), j(t, e, n = z(n), r)
                }

                function g(t, e) {
                  function n(n, r) {
                    if (!L(n)) throw new TypeError;
                    if (!P(r) && !q(r)) throw new TypeError;
                    C(t, e, n, r)
                  }
                  return n
                }
                ...
                function N(t, e, n) {
                  if (x(t, e, n)) return D(t, e, n);
                  var r = tt(e);
                  return B(r) ? void 0 : N(t, r, n)
                }
                ...
                function I(t, e) {
                  ...
                  for (var o = new p, s = [], a = 0, c = n; a < c.length; a++) {
                    var u = c[a];
                ...
                e("decorate", _), e("metadata", g), e("defineMetadata", y), e("hasMetadata", b), e("hasOwnMetadata", m), e("getMetadata", v), e("getOwnMetadata", E), e("getMetadataKeys", S), e("getOwnMetadataKeys", T), e("deleteMetadata", O)
              }(o)
          }()
        }(n || (n = {}))
    ...
    pevS: function(t, e, n) {
      ...
      t.exports = function(t, e) {
        var n, l, d, p, h, _, g, y, b = t.target,
          ...
          T = m ? s : s[b] || (s[b] = {}),
          O = T.prototype;
        for (d in e) n = !o(m ? d : b + (v ? "." : "#") + d, t.forced) && S && u(S, d), h = T[d], n && (_ = t.noTargetGet ? (y = i(S, d)) && y.value : S[d]), p = n && _ ? _ : e[d], n && typeof h == typeof p || (g = t.bind && n ? a(p, r) : t.wrap && n ? f(p) : E && "function" == typeof p ? a(Function.call, p) : p, (t.sham || p && p.sham || h && h.sham) && c(g, "sham", !0), T[d] = g, E && (u(s, l = b + "Prototype") || c(s, l, {}), s[l][d] = p, t.real && O && !O[d] && c(O, d, p)))
      }
    },
    qUYh: function(t, e, n) {
      "use strict";
    ...
    vFt6: function(t, e, n) {
      ...
      function a(t, e = {}) {
        try {
          ...
          for (; n && o++ < r && (l = c(n, d), !("html" === l || o > 1 && a + i.length * f + l.length >= p));) i.push(l), a += l.length, n = n.parentNode;
...
//# sourceMappingURL=sourcemaps/opfs-worker.3a6ecf693cff2fc53577.js.map
