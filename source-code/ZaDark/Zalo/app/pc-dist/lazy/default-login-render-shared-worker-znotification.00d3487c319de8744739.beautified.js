/**
 * Deobfuscated from: default-login-render-shared-worker-znotification.00d3487c319de8744739.js
 * Generated: 2025-10-06T06:30:08.672Z
 * 
...
(this.webpackJsonp = this.webpackJsonp || []).push([
  [2], {
    ...
    "1CsI": function(e, t, n) {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("schema-version")
    },
    "1UUk": function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      class s extends a.b {
        ...
        createQueryBuilder(e) {
          return i.ModuleContainer.resolve(r.a).createQueryBuilder(e)
        }
      }
      const o = Object(i.define)("database-manager")
    },
    "3wcW": function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      class u extends r.b {
        constructor(e, t, n, i) {
          super(), this.fullname = e, this.partition = t, this.instance = n, this.allowMissingTable = i, this.version = void 0, this.logger = void 0, this.schemaVersionHistory = a.ModuleContainer.resolve(c.a);
          const r = a.ModuleContainer.resolve(s.ZLoggerFactory);
          this.logger = r.createZLogger(o.f, ["migrate-executor"])
        }
        ...
        async upgrade(e, t) {
          if (this.checkAbnormalSchemaMigration(e, t), null !== t && (this.logger.zsymb(3, "OujUhV", ["Database: {} - Version: from {} to {} - Start", "S8bu7r"], this.partition.database, e, t), e !== t))
            if (e < this.partition.milestoneVersion) {
              ...
              this.logger.zsymb(3, "-voW34", ["Database: {} - Create ALL tables: {}", "_FNZXO"], this.partition.database, e.map((({
                params: e
              }) => e.table.name))), await this._applyMigrations(e)
            } else {
              this.logger.zsymb(3, "_wblxp", ["Database: {} - Create SOME tables", "IZoZ1i"], this.partition.database);
              const n = this.partition.tables;
              for (const a of n) {
                const n = a.getMigrationInfos(this.partition.type);
                ...
                for (; r <= t;) {
                  ...
                  if (e) {
                    ...
                    this.logger.zsymb(3, "qWYMNu", ["Database: {} - Current schema migrated version: {} - Table: {} - Action: {}", "M74_kB"], this.partition.database, r, a.name, n.map((({
                      type: e
        ...
        async validate() {
          ...
          if (n.length > 0) {
            ...
            if (!this.allowMissingTable) throw new l.A(this.partition.database, e);
            ...
            switch (n.type) {
              case "create-table": {
                ...
                0, await this._createTable(e).catch((e => {
                  throw this.logger.zsymb(18, "vRMMnr", "create table error", t, e.message), e
                }));
                break
              }
              case "create-index": {
                ...
                0, await this._createIndex(e, t).catch((e => {
                  throw this.logger.zsymb(18, "KAtfRM", "create index error", i, e.message), e
                }));
                break
              }
              case "add-column": {
                ...
                0, await this._addColumns(e, t).catch((e => {
                  throw this.logger.zsymb(18, "hUbvAc", "add columns error", i, e.message), e
                }));
                break
              }
              default:
                throw new l.H(`Unhandled '${n.type}' migration script.`)
            }
          }
        }
      }
    ...
    "45ei": function(e, t, n) {
      ...
      class r extends i.a {
        constructor(e) {
          super(a.InitServices), this.app = e
        }
      }
      class s extends i.a {
        constructor(e, t) {
      ...
      class o extends s {
        constructor(e) {
          super(a.Authenticating, e)
        }
      }
      class l extends s {
        constructor(e) {
          super(a.Authenticated, e)
        }
      }
      class d extends i.a {
        constructor(e) {
          super(a.LogOut), this.shouldClearData = e
        }
      }
    },
    "4IGy": function(e, t, n) {
      ...
      const c = {
        ...
        p = {
          partitionNamingStrategy: [r.a.const("Storage")],
          partitionsMap: Object(o.a)(c)
        },
        m = {
          partitionNamingStrategy: [r.a.const("zlocalstorage")],
          partitionsMap: Object(o.a)(c)
        },
        h = Object(i.a)(Object(i.a)(Object(i.a)({}, u), p), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_PARTIAL
        }),
        y = Object(i.a)(Object(i.a)(Object(i.a)({}, u), m), {}, {
          version: 5,
          milestoneVersion: 5,
          type: a.a.IDB
        });
      ...
      t.a = {
        ...
        schema: c,
        get useSqlite() {
          return null === g && (g = new s.a(h)), g
        },
        get useIdb() {
          return null === f && (f = new s.a(y)), f
        }
      }
    },
    "4W2c": function(e, t, n) {
      ...
      class s extends r {
        ...
        toDB(e) {
          if ("" === this.cipcherKey) throw new i.j("Cipher key is unavailable!");
          for (let t = 0; t < this.secureFields.length; t++) {
            const n = this.secureFields[t];
            e[n] && (e[n] = a.a.encrypt(JSON.stringify(e[n]), this.cipcherKey))
          }
        }
        fromDB(e) {
          if (e) {
            ...
            for (let n = 0; n < this.secureFields.length; n++) {
              const i = this.secureFields[n];
              if ("string" == typeof e[i]) try {
                e[i] = JSON.parse(a.a.decrypt(e[i], this.cipcherKey))
              } catch (t) {}
            }
          }
        }
    ...
    "6Sr9": function(e, t, n) {
      ...
      function I(e) {
        e.addEventListenerOnce(a.a.InitServices, (e => {
          r.forEach((t => {
            try {
              i.ModuleContainer.resolveToken(t).onStart(e)
            } catch (n) {}
          }))
        })), e.addEventListenerOnce(a.a.Authenticating, (e => {
          s.forEach((t => i.ModuleContainer.resolveToken(t).onAuthenticating(e)))
        })), e.addEventListenerOnce(a.a.Authenticated, (e => {
          o.forEach((t => i.ModuleContainer.resolveToken(t).onAuthenticated(e)))
        })), e.addEventListenerOnce(a.a.Start, (e => {
          d.forEach((t => {
            try {
              i.ModuleContainer.resolveToken(t).onApplicationStart(e)
            } catch (n) {}
          }))
        })), e.addEventListenerOnce(a.a.ServicesReady, (e => {
          c.forEach((t => i.ModuleContainer.resolveToken(t).onApplicationReady(e)))
        })), e.addEventListenerOnce(a.a.Exit, (() => {
          l.forEach((e => i.ModuleContainer.resolveToken(e).onDispose()))
        })), e.addEventListenerOnce(a.a.LogOut, (() => {
    ...
    "75G/": function(e, t, n) {
      ...
      const c = new a.d({
        ...
        transforms: [new d.a(["content", "localPath"])]
      });
      c.setAdapterSpecificConfigs(l.AdapterType.IDB, {}), c.setAdapterSpecificConfigs(l.AdapterType.SQLite, {});
      const u = new a.d({
        tableName: "file",
        name: "File",
        fields: {
        ...
        transforms: [new d.a(["content", "localPath", "folderPath"])]
      });
      u.setAdapterSpecificConfigs(l.AdapterType.IDB, {}), u.setAdapterSpecificConfigs(l.AdapterType.SQLite, {});
      const p = new a.d({
        tableName: "link",
        name: "Link",
        fields: {
        ...
        transforms: [new d.a(["content", "parsedInfo"])]
      });
      p.setAdapterSpecificConfigs(l.AdapterType.IDB, {}), p.setAdapterSpecificConfigs(l.AdapterType.SQLite, {});
      const m = new a.d({
      ...
      m.setAdapterSpecificConfigs(l.AdapterType.IDB, {}), m.setAdapterSpecificConfigs(l.AdapterType.SQLite, {});
      const h = {
          Image: c,
          File: u,
          Link: p,
        ...
        g = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("Media")],
          partitionsMap: Object(o.a)(h)
        },
        f = {
          partitionNamingStrategy: [r.a.const("media"), r.a.byUser()],
          partitionsMap: Object(o.a)(h)
        },
        b = Object(i.a)(Object(i.a)(Object(i.a)({}, y), g), {}, {
          version: 1,
          milestoneVersion: 1,
          type: s.a.SQLite,
          corruptionImpact: s.b.IMPACT_FULL
        }),
        I = Object(i.a)(Object(i.a)(Object(i.a)({}, y), f), {}, {
          version: 1,
          milestoneVersion: 1,
          type: s.a.IDB
        });
      ...
      t.a = {
        ...
        schema: h,
        get useSqlite() {
          return null === v && (v = new a.a(b)), v
        },
        get useIdb() {
          return null === C && (C = new a.a(I)), C
        }
      }
    },
    "7FSS": function(e, t, n) {
      ...
      const i = globalThis.zconsole || globalThis.console
    },
    "7xKq": function(e, t) {},
    "8/YW": function(e, t, n) {
      "use strict";
      ...
      class a {
        ...
        removeEventListener(e, t) {
          const n = e.toString(),
            i = this.events.get(n);
          if (!i) return;
          this.events.set(n, i.filter((e => e !== t)))
        }
    ...
    Abbu: function(e, t, n) {
      ...
      let a;
      var r;
      (r = a || (a = {})).isBeginTransaction = function(e) {
        return e.type === i.e.BeginTransaction
      }, r.isCommitTransaction = function(e) {
        return e.type === i.e.CommitTransaction
      }, r.isInsertQuery = function(e) {
        return e.type === i.e.Insert
      }, r.isUpdateQuery = function(e) {
        return e.type === i.e.Update
      }, r.isCloseDBQuery = function(e) {
        return e.type === i.e.CloseDB
      }, r.isDeleteDBQuery = function(e) {
        return e.type === i.e.DeleteDB
      }, r.isCloseAllDBsQuery = function(e) {
        return e.type === i.e.CloseAllDBs
      }, r.isDeleteAllDBsQuery = function(e) {
        return e.type === i.e.DeleteAllDBs
      }, r.isInTransaction = function(e) {
        return !!e.transaction
      }, r.isValid = function(e) {
        return !0
      }, r.isPartitionlessQuery = function(e) {
        return e.type === i.e.BeginTransaction || e.type === i.e.CommitTransaction
      }
    },
    C9Dv: function(e, t, n) {
      "use strict";
    ...
    "DI/x": function(e, t, n) {
      ...
      class f extends d {
        constructor(e, t, n) {
          let i = `Missing partition config for '${e}' table`;
          if (t) {
            const {
              userId: e
            } = t;
          ...
          super(204, i, n), this.name = "MissingPartitionConfig"
        }
      }
      class b extends d {
        constructor(e, t) {
      ...
      class v extends d {
        constructor(e, t) {
          super(a, e, t), this.name = "MissingPartitionKey"
        }
      }
      class C extends d {
        constructor(e, t) {
      ...
      class S extends d {
        constructor(e, t) {
          super(r, e, t), this.name = "InvalidQueryParams"
        }
      }
      class _ extends d {
        constructor(e, t) {
      ...
      class A extends d {
        constructor(e, t) {
          super(309, e, t), this.name = "DBCorruptError", this.adapterType = i.a.IDB
        }
      }
      class E extends d {
        constructor(e, t) {
          ...
          super(s, `An attempt was made to open a database (${n}) using a lower version (${a}) than the existing version (${i}).`, t), this.data = e, this.name = "InvalidVersionError"
        }
      }
      class j extends d {
        constructor(e, t) {
      ...
      class F extends d {
        constructor(e, t, n) {
          const i = `Found missing table(s): ${JSON.stringify(t)}. But current adapter cannot create table without increasing the database version.`;
          super(l, i, n), this.database = e, this.missingTables = t, this.name = "MissingTableError"
        }
      }
      class B extends d {
        constructor(e, t, n) {
          super(n, e), this.name = void 0, this.adapterType = i.a.IDB, this.name = t
        }
      }
      class L extends d {
        constructor(e, t, n) {
          super(t, e.replace(`${n}: `, "")), this.name = void 0, this.adapterType = i.a.SQLite, this.name = n
        }
      }
    },
    IpiK: function(e, t, n) {
      ...
      const u = new s.d({
        ...
        transforms: [new c.a(["message"])]
      });
      u.setAdapterSpecificConfigs(a.a.IDB, {}), u.setAdapterSpecificConfigs(a.a.SQLite, {});
      const p = new s.d({
          tableName: "Quotes",
          name: "Quotes",
          fields: {
        ...
        h = new s.d({
          ...
          transforms: [new c.a(["msg", "attach"])]
        });
      h.setAdapterSpecificConfigs(a.a.IDB, {}), h.setAdapterSpecificConfigs(a.a.SQLite, {});
      const y = new s.d({
          tableName: "TTLItem",
          name: "TTLItem",
          fields: {
        ...
        b = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("MsgInfo")],
          partitionsMap: Object(o.a)(g)
        },
        I = {
          partitionNamingStrategy: [r.a.const("msginfo"), r.a.byUser()],
          partitionsMap: Object(o.a)(g)
        },
        v = Object(i.a)(Object(i.a)(Object(i.a)({}, f), b), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_FULL
        }),
        C = Object(i.a)(Object(i.a)(Object(i.a)({}, f), I), {}, {
          version: 6,
          milestoneVersion: 6,
          type: a.a.IDB
        });
    ...
    Jcee: function(e, t, n) {
      ...
      class u {
        constructor() {
          this.id = void 0, this.id = Object(d.a)()
        }
        revoke() {
          c.delete(this.id)
        }
      ...
      class p extends u {
        constructor() {
          if (super(), this._status = void 0, p.instance) return p.instance;
          p.instance = this
        }
        get status() {
          return this._status
        ...
        create() {
          this._status = "create", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.create) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        start() {
          this._status = "start", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.start) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        running() {
          this._status = "running", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.running) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        pause() {
          this._status = "pause", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.pause) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        resume() {
          this._status = "resume", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.resume) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        restart() {
          this._status = "restart", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.restart) || void 0 === n ? void 0 : n.call(t)
          }))
        }
        stop() {
          this._status = "stop", c.forEach((e => {
            var t, n;
            return null === (t = i.ModuleContainer.resolveToken(e)) || void 0 === t || null === (n = t.stop) || void 0 === n ? void 0 : n.call(t)
          }))
        }
      }
      p.instance = void 0;
      ...
      class h extends a.b {
        constructor(e, t, n) {
          super(), this.name = e, this.config = t, this.disposables = void 0, this.currentSession = null, this.logger = void 0, this.onApplicationStarted = e => {
            ...
            this.dispatchEvent(new Event(r.a.BeforeUnload))
          }, this.onApplicationFirstIdle = e => {
            this.dispatchEvent(e)
          }, this.onApplicationIdle = e => {
            this.logger.zsymb(12, "WRmaT2", "idle"), this.dispatchEvent(e)
          }, this.onApplicationActive = e => {
            this.logger.zsymb(12, "-AT93x", "active"), this.dispatchEvent(e)
          }, this.logger = n.createZLogger("common", ["application"]), this.disposables = new s, m.create()
        }
        async start() {
          this.logger.zsymb(0, "qUfb3c", "starting"), this.listenInternalEvents(), Object(o.g)(this), this.onApplicationStarted(new Event(r.a.Start)), m.start()
        }
        async init() {
          this.logger.zsymb(3, "ay0dI-", ["initializing services...", "KHsdN3"]), this.onInitService(new l.c(this)), window.addEventListener("beforeunload", (() => {
            this.onBeforeUnload()
          }))
        }
        async ready() {
          this.logger.zsymb(3, "RdnYIS", ["application ready", "C4izXE"]), this.onServiceReady(new Event(r.a.ServicesReady)), m.running()
        }
        async exit() {
          this.logger.zsymb(3, "6rruWv", ["exiting", "GL6L_n"]), this.onApplicationStarted(new Event(r.a.Exit)), setTimeout((() => {
            this.disposables.dispose()
          })), m.stop()
        }
        authenticating(e) {
          this.logger.zsymb(0, "VJQcFg", (() => ["authenticating", {
            id: e.userId
          }])), this.currentSession = e, this.dispatchEvent(new r.c(this.currentSession))
        }
        authenticate(e) {
          this.logger.zsymb(0, "3_tKgl", (() => ["authenticate", {
            id: e.userId
          }])), this.currentSession = e, this.dispatchEvent(new r.c(this.currentSession)), this.dispatchEvent(new r.b(this.currentSession))
        }
        logOut(e) {
          this.dispatchEvent(new r.e(e))
        }
        getSession() {
          return this.currentSession
        }
        setStateToIdle() {
          this.onApplicationIdle(new Event(r.a.Idle))
        }
        setStateToActive() {
          this.onApplicationActive(new Event(r.a.Active))
        }
        listenInternalEvents() {
          this.addEventListenerOnce(r.a.Idle, (() => this.onApplicationFirstIdle(new Event(r.a.FirstIdle))))
        }
      }
      const y = Object(i.define)("application")
    },
    LzQZ: function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("database-transaction-manager")
    },
    MRjZ: function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      function s(e, t) {
        var n;
        const s = Object(i.a)({
          method: a.c.getTypeName(e.type),
          database: e.database,
          table: r.a.isBeginTransaction(e) ? e.params.tables.join(",") : e.table,
          step: e.meta.step,
      ...
      function l(e, t = !1) {
        const n = e && o(e) ? `${e.name}: ${e.message}` : String(e);
        return t ? `${n}\ntrace: ${e.stack}` : n
      }
    },
    MWu7: function(e, t, n) {
      ...
      let a;
      var r;
      (r = a || (a = {})).isCorruptError = function(e) {
        const {
          message: t
        } = e;
        return !!i.z.some((e => t.includes(e)))
      }, r.isOutOfMemError = function(e) {
        if (!(e instanceof Error)) return !1;
        const {
          message: t
        } = e;
        return t.includes("malformed")
      }, r.isRawSQLiteException = function(e) {
        return e instanceof Error && void 0 !== e.errno && void 0 !== e.code
      }, r.isSerializedSQLiteException = function(e) {
        return "object" == typeof e && void 0 !== e.errno && void 0 !== e.code
      }, r.serializeSQLiteException = function(e) {
        if (!a.isRawSQLiteException(e)) throw new Error("Can't serialize a non SQLite exception error");
        return {
          errno: e.errno,
          code: e.code,
          message: e.message
    ...
    OMsT: function(e, t, n) {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("log-collector")
    },
    PhBv: function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      n("PmZf");
      class r extends a.b {}
      const s = Object(i.define)("database-query-planner")
    },
    PmZf: function(e, t, n) {
      "use strict";
      n.d(t, "b", (function() {
      ...
      class r extends i.a {
        constructor(e) {
          super(a.SessionChange), this.session = e
        }
      }
      i.a;
      i.a;
      ...
      class s extends i.a {
        constructor(e) {
          super(a.QueryExec), this.data = e
        }
      }
      class o extends i.a {
        constructor(e) {
          super(a.QueryError), this.error = e
        }
      }
      class l extends i.a {
        constructor(e) {
          super(a.UnexpectedError), this.error = e
        }
      }
      class d extends i.a {
        constructor(e, t) {
          super(a.TimeConsumingQuery), this.logInfo = e, this.totalTime = t
        }
      }
      class c extends i.a {
        constructor(e) {
          super(a.SuccessOpenDB), this.data = e
        }
      }
      class u extends i.a {
        constructor(e) {
          super(a.ConnectionClosedAbnormally), this.database = e
        }
      }
      class p extends i.a {
        constructor(e) {
          super(a.LongOpenDB), this.data = e
        }
      }
      class m extends i.a {
        constructor(e) {
          super(a.SchemaMigratedAbnormally), this.data = e
        }
      }
      class h extends i.a {
        constructor(e) {
          super(a.Warning), this.data = e
        }
      }
    },
    SWKE: function(e, t, n) {
      ...
      class s {
        ...
        async cleanupAsyncLocalStorageMatchConditions(e = (e => !1)) {
          const t = r.default.getInstance(),
            ...
            i = [];
          for (const a of n) {
            const t = await a.getAllKey();
            if (0 === t.length) continue;
            if (Array.isArray(t[0])) {
              this.logger.zsymb(9, "dqKDNz", ['"{}" store has array-typed keys; then can\'t be matched for cleaning up', "dwajxa"], a.name);
              continue
            }
            const n = [];
            for (const i of t) e(`${i}`) && n.push(i);
            n.length && i.push(a.deleteMulti(n))
          }
    ...
    UJ0r: function(e, t, n) {
      ...
      n("PmZf");
      class r extends a.b {}
      const s = Object(i.define)("database-adapter-manager")
    },
    UK4g: function(e, t, n) {
      "use strict";
      n.d(t, "j", (function() {
    ...
    Uzj0: function(e, t, n) {
      ...
      ! function(e) {
        ...
        async function n(e, t) {
          return await Promise.all(e.map(((e, n, i) => t(e, n, i))))
        }! function(e) {
          let t, n = function(e) {
          ...
          e.Order = n, e.create = function(e) {
            return (t, i) => {
              for (let a = 0; a < e.length; a++) {
                const r = e[a],
                  s = r.comparer(t[r.key], i[r.key]);
                if (0 !== s) return r.order === n.DES ? s * r.order : s
              }
              return 0
            }
          }, (i = t || (t = e.Comparer || (e.Comparer = {}))).bool = function(e, t) {
            if (e || t) {
              if (!e) return 1;
              if (!t) return -1
            }
          ...
          let n = [];
          for (let i = 0; i < e.length; i++) await t(e[i], i, e) && n.push(e[i]);
          return n
        }, e.asyncFilterParallel = async function(e, t) {
          const i = await n(e, t),
            a = [];
          for (let n = 0; n < e.length; n++) i[n] && a.push(e[n]);
          return a
        }, e.asyncMap = async function(e, t) {
          let n = [];
          for (let i = 0; i < e.length; i++) n.push(await t(e[i], i, e));
          return n
      ...
      function(e) {
        ...
        e.delay = t, e.timeout = function(e, n, i) {
          return Promise.race([t(n).then((() => i)), e])
        };
        let n;
        e.Container = class {
          constructor() {
      ...
      }(r || (r = {})), (s || (s = {})).getNumberOfDays = function(e, t) {
          const n = new Date(e),
        ...
        function(e) {
          ...
          e.isEmptyObject = e => "object" == typeof e && !Object.keys(e), e.isNotEmptyObject = e => "object" == typeof e && !!Object.keys(e), e.clone = (e, t = "shalow") => "deep" === t ? JSON.parse(JSON.stringify(e)) : Object(i.a)({}, e), e.safeParseJson = e => {
            try {
            ...
            var n, i;
            return null !== (n = null !== (i = e[t]) && void 0 !== i ? i : e[t.toLowerCase()]) && void 0 !== n ? n : e[t.toUpperCase()]
          };
          e.Comparer = class {
            constructor(e, t, n) {
            ...
            compareField(e, t) {
              var n;
              const i = this.object1[e],
                a = this.object2[e];
              return null !== (n = null == t ? void 0 : t(i, a)) && void 0 !== n ? n : i == a
            }
          }
        }(o || (o = {})),
        function(e) {
      ...
      const d = "undefined" != typeof window && "Microsoft Internet Explorer" == (null === (c = window) || void 0 === c || null === (u = c.navigator) || void 0 === u ? void 0 : u.appName);
      var c, u;
      let p;
      var m;
      let h, y;
      (m = p || (p = {})).encrypt = function(e, t) {
          let n = 0,
            i = [];
          if (d) {
            let n = 0,
            ...
            n %= a;
            for (let t = 0; t < e.length; t++) i.push(String.fromCharCode(e.charCodeAt((t + n) % a)))
          } else
            for (let a = 0; a < e.length; a++) i.push(String.fromCharCode(e.charCodeAt(a) ^ t.charCodeAt(n))), n++, n > t.length - 1 && (n = 0);
          return i.join("")
        }, m.decrypt = function(e, t) {
          let n = 0,
            i = [];
          if (d) {
            let n = 0,
        ...
        function(e) {
          const t = 36e5,
            ...
            a = e.timeInMs = e => {
              ...
              let n, a = 0;
              for (; n = t.exec(e);) a += parseInt(n[1]) * i[n[2]];
              return a
            };
          e.countDays = (e, t) => {
            if (e > t) return 0;
            ...
            const r = i.getTime() - n.getTime();
            return Math.ceil(r / a("1D")) + 1
          }, e.countUniqDays = (...e) => {
            const t = new Set;
            return e.forEach((e => {
              const n = new Date(e);
        ...
        function(e) {
          ...
          e.sizeInByte = e => {
            ...
            let i, a = 0;
            for (; i = t.exec(e);) a += parseInt(i[1]) * n[i[2]];
            return a
          }, e.bytesToMB = e => e / t
        }(y || (y = {}))
    },
    WOPK: function(e, t, n) {
      ...
      var i = n("kQx2");
      let a = 0;
      const r = () => (a++, Math.floor(Object(i.a)() + a))
    },
    X2RP: function(e, t, n) {
      "use strict";
      n.d(t, "b", (function() {
      ...
      class l extends a.b {
        ...
        validateKey(e, t, n) {
          if (!e.getIndex(t).validateKey(n)) throw new s.o("The query key is invalid!");
          return n
        }
      }
    },
    XB6V: function(e, t, n) {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("zlogger-factory")
    },
    YEoC: function(e, t, n) {
      "use strict";
      n.d(t, "c", (function() {
    ...
    YZti: function(e, t, n) {
      ...
      var i = n("MWu7"),
        ...
        r = n("YEoC"),
        s = n("DI/x");
      const o = "undefined" != typeof window && "Microsoft Internet Explorer" == (null === (l = window.navigator) || void 0 === l ? void 0 : l.appName);
      var l;
      let d;
      var c;
      let u;
      ...
      (c = d || (d = {})).encrypt = function(e, t) {
        ...
        if (o) {
          ...
          for (let a = 0; a < e.length; a++) i.push(String.fromCharCode(e.charCodeAt(a) ^ t.charCodeAt(n))), n++, n > t.length - 1 && (n = 0);
        return i.join("")
      }, (u || (u = {})).getTypeName = function(e) {
        switch (e) {
          case r.e.BeginTransaction:
            return "begin-transaction";
          case r.e.CommitTransaction:
            return "commit-transaction";
          case r.e.Clear:
            return "clear";
          case r.e.Get:
            return "get";
          case r.e.GetAndUpdate:
            return "get-and-update";
          case r.e.GetMulti:
            return "get-multi";
          case r.e.GetMultiIfExists:
          ...
          case r.e.Insert:
            return "insert";
          case r.e.InsertMulti:
            return "insert-multi";
          case r.e.Update:
            return "update";
          case r.e.UpdateMulti:
            return "update-multi";
          case r.e.Delete:
            return "delete";
          case r.e.DeleteMulti:
            return "delete-multi";
          case r.e.FindAndDelete:
            return "find-and-delete";
          case r.e.Count:
            return "count";
          case r.e.CloseDB:
            return "close-db";
          case r.e.CloseAllDBs:
            return "close-all-dbs";
          case r.e.DeleteDB:
            return "delete-db";
          case r.e.DeleteAllDBs:
            return "delete-all-dbs"
        }
      }, (m = p || (p = {})).isMissingTableError = function(e) {
        return e instanceof s.e && e.code === s.r
      }, m.isInvalidVersionError = function(e) {
        return e instanceof s.e && e.code === s.n
      }, m.isFailedToOpenConnectionError = function(e) {
        return e instanceof s.e && e.code === s.k
      }, m.isOutOfMemError = function(e) {
        return a.a.isOutOfMemError(e) || i.a.isOutOfMemError(e)
      }
    },
    ZcVI: function(e, t, n) {
      "use strict";
    ...
    b3Jv: function(e, t, n) {
      ...
      const l = {
        ...
        c = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("Search")],
          partitionsMap: Object(o.a)(l)
        },
        u = {
          partitionNamingStrategy: [r.a.const("sidx"), r.a.byUser()],
          partitionsMap: Object(o.a)(l)
        },
        p = Object(i.a)(Object(i.a)(Object(i.a)({}, d), c), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_PARTIAL
        }),
        m = Object(i.a)(Object(i.a)(Object(i.a)({}, d), u), {}, {
          version: 2,
          milestoneVersion: 2,
          type: a.a.IDB
        });
      ...
      t.a = {
        ...
        schema: l,
        get useSqlite() {
          return null === h && (h = new s.a(p)), h
        },
        get useIdb() {
          return null === y && (y = new s.a(m)), y
        }
      }
    },
    bSii: function(e, t, n) {
      ...
      function s(e) {
        i.default.getInstance().setItemForCurrentUser(r, e ? "1" : "0")
      }

      function o() {
        return "1" === i.default.getInstance().getItemForCurrentUser(r)
      }
    },
    "d/or": function(e, t, n) {
      "use strict";
      ...
      var i = n("jDHv");
      const a = Object(i.define)("database-settings-manager")
    },
    d04y: function(e, t, n) {
      "use strict";
      var i = n("VTBJ"),
      ...
      const l = new s.d({
        ...
        u = {
          partitionNamingStrategy: [r.a.const("Qos")],
          partitionsMap: Object(o.a)(d)
        },
        p = {
          partitionNamingStrategy: [r.a.const("zdb_qos")],
          partitionsMap: Object(o.a)(d)
        },
        m = Object(i.a)(Object(i.a)(Object(i.a)({}, c), u), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_PARTIAL
        }),
        h = Object(i.a)(Object(i.a)(Object(i.a)({}, c), p), {}, {
          version: 3,
          milestoneVersion: 3,
          type: a.a.IDB
        });
    ...
    fsN4: function(e, t, n) {
      ...
      class s {
        static getInstance() {
          if (!this.instance) {
            const e = i.ModuleContainer.resolve(r.b);
    ...
    fsQs: function(e, t, n) {
      ...
      const i = 1024,
        ...
        m = {
          line_malloc: 10 * i,
          mem_batch_lim: 500 * i,
          line_hard_lim: 30 + 50 * i,
          line_soft_lim: 30 + 4 * i,
          file_lim: 10 * a,
          page_limit: 10 * a
        },
        h = m,
    ...
    "g/Dz": function(e, t, n) {
        ...
        const n = Object(i.m)(t, {
          operations: {
            ...
            contains(e, t, n) {
              ...
              return Object(i.l)((t => "string" == typeof t && t.includes(e)), t, n)
            },
            startsWith(e, t, n) {
              if ("string" != typeof e) {
              ...
              return Object(i.l)((t => "string" == typeof t && t.startsWith(e)), t, n)
            },
            endsWith(e, t, n) {
              if ("string" != typeof e) {
              ...
              return Object(i.l)((t => "string" == typeof t && t.endsWith(e)), t, n)
            }
          }
        });
        return n(e)
      ...
      function u(e, t, n) {
        ...
        if (!e.isNonFieldlikeEntity) {
          const {
            primaryIndex: n
          } = e, a = n.fields[0].field;
          Object.prototype.hasOwnProperty.call(i, a) || (i[a] = t)
        }
        return i
      }(c = d || (d = {})).isVersionError = function(e) {
        return e instanceof DOMException && "VersionError" === e.name
      }, c.getCurrentVersionFromVersionError = function(e) {
        if (!d.isVersionError(e)) return NaN;
        const t = [...e.message.matchAll(/\(\d+\)/g)];
        if (!t.length) return -1;
        const n = t[1][0];
        return +n.slice(1, n.length - 1)
      }, c.isInvalidStateError = function(e) {
      ...
      const p = e => {
        ...
        y = (e, t, n = r.c.NEXT) => {
          const i = t.lower,
            a = t.upper,
            s = n === r.c.PREV || n === r.c.PREV_UNIQUE;
          for (let r = 1; r < e.length; ++r) {
            const t = e.slice(r),
              n = i.slice(r),
              o = a.slice(r);
            if (s) {
              if (indexedDB.cmp(t, o) > 0) return e.slice(0, r).concat(o);
              if (indexedDB.cmp(t, n) < 0) return e.slice(0, r).concat([h(e[r])]).concat(a.slice(r + 1))
            } else {
              if (indexedDB.cmp(t, n) < 0) return e.slice(0, r).concat(n);
              if (indexedDB.cmp(t, o) > 0) return e.slice(0, r).concat([m(e[r])]).concat(i.slice(r + 1))
            }
          }
          return null
        }
    ...
    igA5: function(e, t, n) {
      ...
      const d = "citk",
        ...
        u = "default_cache_map",
        p = "z_ecrp",
        m = "undefined" != typeof window && "Microsoft Internet Explorer" == (null === (h = window) || void 0 === h || null === (y = h.navigator) || void 0 === y ? void 0 : y.appName);
      var h, y;
      class g {
        static encrypt(e, t) {
      ...
      var f, b;
      let I = Object(i.g)()(f = Reflect.metadata("design:type", Function)(f = Reflect.metadata("design:paramtypes", [])(((b = class e {
        constructor() {
        ...
        get logger() {
          if (!this._logger) {
            const e = a.ModuleContainer.resolve(o.ZLoggerFactory);
        ...
        _initUserIDList(e) {
          try {
            this._validateUserIDList(), this.userScopedPrefix = `${Object(r.d)(e)}`
          } catch (t) {}
        }
        _validateUserIDList() {}
        _testCipher() {
          if (this.checkExistForCurrentUser(d)) {
            if (this.getSecureItemForCurrentUser(d) !== c) throw new Error("SecureLocalStorage encryption and decryption produce incorrect results")
          } else this.setSecureItemForCurrentUser(d, c)
        }
        async _recoverCipher() {
          ...
          await n.cleanupAsyncLocalStorageMatchConditions((e => "string" == typeof e && t(e))), this.setSecureItemForCurrentUser(d, c)
        }
        hasOwnProperty(e) {
        ...
        async setItemAsync(e, t) {
          ...
          await i.SecureLocalstorage.AsyncStore.insert({
            key: n,
            val: t
          }, {
            replace: !0
        ...
        setSecureItemForCurrentUser(e, t) {
          ...
          const a = this._disableCipher ? i : this.encryptValue(i);
          globalThis.localStorage.setItem(n, a), this.applyItemChangedForCurrentUser(e, t)
        }
        async getSecureItemForCurrentUserAsync(e) {
          const t = this.getKeyNameForCurrentUser(e),
            n = s.default.getInstance(),
            i = await n.SecureLocalstorage.AsyncStore.get(t);
          if (!i) return null;
          const {
            val: a
          } = i;
          return this._disableCipher && !this.isEncryptedValue(a) ? a : this.decryptValue(a)
        }
        ...
        setObject(e, t) {
          try {
            ...
            globalThis.localStorage.setItem(n, i), this.applyItemChanged(e, i)
          } catch (n) {}
        }
        setObjectForCurrentUser(e, t) {
          try {
            ...
            this._warnIfKeyCannotBeModified(n);
            const i = JSON.stringify(t);
            globalThis.localStorage.setItem(n, i), this.applyItemChangedForCurrentUser(e, i)
          } catch (n) {}
        }
        getObject(e) {
          const t = this.getKeyNameForSharedItem(e),
        ...
        _getCacheMap(e) {
          if (!this._cacheMaps[e]) {
            let n = new Map,
              i = globalThis.localStorage.getItem(e);
            if (i) try {
              n = JSON.parse(i).reduce(((e, t) => {
                const [n, i] = t;
                return e.set(n, i), e
              }), n)
            } catch (t) {}
        ...
        _flushAndSaveToStorageReal(e) {
          ...
          globalThis.localStorage.setItem(e, i), this.applyItemChangedForCurrentUser(e, i)
        }
        addEntryToCacheMap(e, t, n = u) {
          const i = this.getKeyNameForSharedItem(n);
          this._getCacheMap(i).set(e, t), this._flushAndSaveToStorage(i)
        }
        addEntryToCacheMapForCurrentUser(e, t, n = u) {
          const i = this.getKeyNameForCurrentUser(n);
          this._getCacheMap(i).set(e, t), this._flushAndSaveToStorage(i)
        }
        deleteEntryFromCacheMap(e, t = u) {
          const n = this.getKeyNameForSharedItem(t);
          this._getCacheMap(n).delete(e), this._flushAndSaveToStorage(n)
        }
        deleteEntryFromCacheMapForCurrentUser(e, t = u) {
          const n = this.getKeyNameForCurrentUser(t);
          this._getCacheMap(n).delete(e), this._flushAndSaveToStorage(n)
        }
        getEntryOfCacheMap(e, t = u) {
          const n = this.getKeyNameForSharedItem(t);
          return this._getCacheMap(n).get(e) || null
        }
        getEntryOfCacheMapForCurrentUser(e, t = u) {
          const n = this.getKeyNameForCurrentUser(t);
          return this._getCacheMap(n).get(e) || null
        }
        forEachEntryOfCacheMap(e, t = u) {
          const n = this.getKeyNameForSharedItem(t);
          this._getCacheMap(n).forEach(e)
        }
        forEachEntryOfCacheMapForCurrentUser(e, t = u) {
          const n = this.getKeyNameForCurrentUser(t);
          this._getCacheMap(n).forEach(e)
        }
        getCacheMapSize(e = u) {
        ...
        getCacheMapSizeForCurrentUser(e = u) {
          const t = this.getKeyNameForCurrentUser(e);
          return this._getCacheMap(t).size
        }
        hasCacheMap(e) {
    ...
    ipeT: function(e, t, n) {
      ...
      var i = n("VTBJ"),
        a = (n("jDHv"), n("Mgpg"), n("UK4g")),
        r = n("YEoC"),
        s = n("DI/x"),
        o = n("MRjZ");
      class l {
        constructor(e, t, n = 0, i, a, r) {
          this.database = e, this.tableConfig = t, this.transaction = n, this.doQuery = i, this.dispatchQueryErrorEvent = a, this.databaseConfig = r, this.bindedIndex = void 0
        }
        get name() {
        ...
        index(e) {
          ...
          if (this.bindedIndex) {
            ...
            throw new s.I("index", t)
          }
          const t = new l(this.database, this.tableConfig, this.transaction, this.doQuery, this.dispatchQueryErrorEvent, this.databaseConfig);
        ...
        get(e, t = {}) {
          const n = {
            ...
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
            retry: t.retry || a.h,
            timing: {},
            meta: {
              databaseConfig: this.databaseConfig,
          ...
          if (this.tableConfig.isNonFieldlikeEntity) return this.queryBuilderReject(new s.I("get", "This method cannot be performed on non-fieldlike table!"), n);
        ...
        getMulti(e, t = {}) {
          ...
          return this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("getMulti", "This method cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)
        }
        getMultiIfExists(e, t = {}) {
          const n = {
            trace: (...e) => {},
            type: r.e.GetMultiIfExists,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
        ...
        getAll(e, t = {}) {
          const n = c(t.limit),
            i = {
              ...
              params: {
                ...
                range: e,
                limit: n,
                direction: t.direction || r.c.NEXT,
                filter: t.filter,
          ...
          return this.tableConfig.isNonFieldlikeEntity && e ? this.queryBuilderReject(new s.I("getAll", "'getAll()' with range cannot be performed on non-fieldlike table!"), i) : this.doQuery(i)
        }
        getAllKey(e, t = {}) {
          const n = c(t.limit),
            i = {
          ...
          return this.tableConfig.isNonFieldlikeEntity && e ? this.queryBuilderReject(new s.I("getAllKey", "'getAllKey()' with range cannot be performed on non-fieldlike table!"), i) : this.doQuery(i)
        }
        getAndUpdate(e, t = {}) {
          const n = {
            trace: (...e) => {},
            type: r.e.GetAndUpdate,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
          ...
          return t.updater ? (n.params = Object(i.a)(Object(i.a)({}, n.params), {}, {
            updater: t.updater
          }), this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("getAndUpdate", "This method cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)) : this.queryBuilderReject(new s.o("'updater' option is required!"), n)
        }
        insert(e, t = {}) {
          const n = {
            trace: (...e) => {},
          ...
          if (Array.isArray(e)) return this.queryBuilderReject(new s.I("insert", "Receive an array as input! Please use 'insertMulti' instead!"), n);
          return this.doQuery(n)
        }
        put(e, t = {}) {
          throw new s.I("put", "This method is legacy! Please use 'insert' instead")
        }
        async insertMulti(e, t = {}) {
          const n = {
            trace: (...e) => {},
            type: r.e.InsertMulti,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
          ...
          return Array.isArray(e) ? 0 === e.length ? {
            success: [],
            fail: []
          } : this.doQuery(n) : this.queryBuilderReject(new s.I("insertMulti", "Receive a non-array value as input! Please use 'insert' instead!"), n)
        }
        update(e, t = {}) {
          const n = {
            trace: (...e) => {},
          ...
          return t.value && t.attributes ? (n.params = Object(i.a)(Object(i.a)({}, n.params), {}, {
            attributes: t.attributes,
            value: t.value
          }), this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("update", "This method cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)) : this.queryBuilderReject(new s.o(`'${t.value?"attributes":"value"}' option is required!`), n)
        }
        updateMulti(e = {}) {
          const t = {
            trace: (...e) => {},
            type: r.e.UpdateMulti,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: e.priority || r.d.NON_BLOCKING,
            retry: e.retry || a.h,
            timing: {},
            meta: {
              databaseConfig: this.databaseConfig,
            ...
            params: {
              index: this.bindedIndex || e.index || "primary",
              patches: e.patches || [],
              ignoreNotFound: !0 === e.ignoreNotFound
            }
          };
          return this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("updateMulti", "This method cannot be performed on non-fieldlike table!"), t) : this.doQuery(t)
        }
        delete(e, t = {}) {
          const n = {
            trace: (...e) => {},
          ...
          return this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("delete", "This method cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)
        }
        remove(e, t = {}) {
          throw new s.I("remove", "This method is legacy. Please use 'delete' instead!")
        }
        deleteMulti(e, t = {}) {
          const n = {
            trace: (...e) => {},
            type: r.e.DeleteMulti,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
          ...
          return this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("deleteMulti", "This method cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)
        }
        findAndDelete(e, t = {}) {
          const n = {
            trace: (...e) => {},
            type: r.e.FindAndDelete,
            database: this.database,
            table: this.tableConfig.name,
            transaction: this.transaction,
            priority: t.priority || r.d.NON_BLOCKING,
          ...
          return this.tableConfig.isNonFieldlikeEntity && e ? this.queryBuilderReject(new s.I("findAndDelete", "'findAndDelete()' with range cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)
        }
        count(e, t = {}) {
          const n = {
            trace: (...e) => {},
          ...
          return this.tableConfig.isNonFieldlikeEntity && e ? this.queryBuilderReject(new s.I("count", "'count()' with range cannot be performed on non-fieldlike table!"), n) : this.doQuery(n)
        }
      ...
      class d {
        constructor(e, t, n = 0, i, a, r) {
          this.database = e, this.tableConfig = t, this.transaction = n, this.doQuery = i, this.dispatchQueryErrorEvent = a, this.databaseConfig = r
        }
        get isNonFieldlikeEntity() {
          return this.tableConfig.isNonFieldlikeEntity
        }
        ...
        async insertMulti(e, t = {}) {
          ...
          return Array.isArray(e) ? 1 === e.length ? this.insert(e[0], t) : void(await this.doQuery(n)) : this.queryBuilderReject(new s.I("insertMulti", "Receive a non-array value as input! Please use 'insert' instead!"), n)
        }
        async update(e, t = {}) {
          const n = {
            trace: (...e) => {},
          ...
          return t.value && t.attributes ? (n.params = Object(i.a)(Object(i.a)({}, n.params), {}, {
            attributes: t.attributes,
            value: t.value
          }), this.tableConfig.isNonFieldlikeEntity ? this.queryBuilderReject(new s.I("update", "This method cannot be performed on non-fieldlike table!"), n) : void(await this.doQuery(n))) : this.queryBuilderReject(new s.o(`'${t.value?"attributes":"value"}' option is required!`), n)
        }
        async updateMulti(e = {}) {
          const t = {
            trace: (...e) => {},
          ...
          if (this.tableConfig.isNonFieldlikeEntity) return this.queryBuilderReject(new s.I("updateMulti", "This method cannot be performed on non-fieldlike table!"), t);
        ...
        async delete(e, t = {}) {
          ...
          if (this.tableConfig.isNonFieldlikeEntity) return this.queryBuilderReject(new s.I("delete", "This method cannot be performed on non-fieldlike table!"), n);
          await this.doQuery(n)
        }
        async remove(e, t = {}) {
          throw new s.I("remove", "This method is legacy. Please use 'delete' instead!")
        ...
        async deleteMulti(e, t = {}) {
          ...
          if (this.tableConfig.isNonFieldlikeEntity) return this.queryBuilderReject(new s.I("deleteMulti", "This method cannot be performed on non-fieldlike table!"), n);
          await this.doQuery(n)
        }
      }
    ...
    jDHv: function(e, t, n) {
      ...
      class r {
        constructor() {
          this.inject = e => i.d(e.token), this.injectToken = e => i.d(e), this.singleton = i.h, this.injectable = i.e, this.isRegistered = e => i.c.isRegistered(e.token), this.register = (e, t) => {
            i.c.register(e.token, {
              useClass: t
            ...
            i.c.registerSingleton(t), i.c.register(e.token, {
          ...
          }, this.resolve = e => i.c.resolve(e.token), this.resolveToken = e => i.c.resolve(e), this.resolveAll = e => i.c.resolveAll(e.token), this.resolveIfExist = e => {
            try {
              return i.c.resolve(e.token)
            } catch (t) {
              return
            }
          }
    ...
    jGDt: function(e, t, n) {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("zlog-session")
    },
    kFM4: function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
    ...
    oRsZ: function(e, t, n) {
      ...
      o.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          58: {
            version: 58,
            scripts: [{
          ...
          64: {
            ...
            scripts: [{
              ...
              type: "create-index",
              params: {
                indexName: "zType_zSize"
              }
            }, {
              type: "create-index",
              params: {
                indexName: "zType_zDate"
              }
            }]
          }
        }
      ...
      const f = new s.d({
        ...
        transforms: [new g.a(["previewMessage"])]
      });
      f.setAdapterSpecificConfigs(a.a.IDB, {}), f.setAdapterSpecificConfigs(a.a.SQLite, {});
      const b = new s.d({
      ...
      I.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          55: {
            version: 55,
            scripts: [{
      ...
      v.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          53: {
            version: 53,
            scripts: [{
      ...
      C.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          55: {
            version: 55,
            scripts: [{
      ...
      T.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          55: {
            version: 55,
            scripts: [{
      ...
      _.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          55: {
            version: 55,
            scripts: [{
      ...
      B.setAdapterSpecificConfigs(a.a.IDB, {}), B.setAdapterSpecificConfigs(a.a.SQLite, {
      ...
      R.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          52: {
            version: 52,
            scripts: [{
      ...
      }), R.setAdapterSpecificConfigs(a.a.SQLite, {});
      const P = new s.d({
        ...
        K = new s.d({
          ...
          transforms: [new g.a(["message", "media"])]
        });
      K.setAdapterSpecificConfigs(a.a.IDB, {}), K.setAdapterSpecificConfigs(a.a.SQLite, {});
      const V = new s.d({
      ...
      $.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          52: {
            version: 52,
            scripts: [{
      ...
      Y.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          63: {
            version: 63,
            scripts: [{
      ...
      Z.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          65: {
            version: 65,
            scripts: [{
      ...
      }), Z.setAdapterSpecificConfigs(a.a.SQLite, {});
      const W = {
        Avatar: u,
        AvaHistory: p,
        BoardSuggest: m,
      ...
      const X = {
        ...
        ee = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("Core")],
          partitionsMap: Object(l.a)(W)
        },
        te = {
          partitionNamingStrategy: [r.a.const("zdb"), r.a.byUser()],
          partitionsMap: Object(l.a)(W)
        },
        ne = Object(i.a)(Object(i.a)(Object(i.a)({}, X), ee), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_FULL
        }),
        ie = Object(i.a)(Object(i.a)(Object(i.a)({}, X), te), {}, {
          version: 65,
          milestoneVersion: 51,
          type: a.a.IDB
        });
      ...
      t.a = {
        ...
        schema: W,
        get useSqlite() {
          return null === ae && (ae = new s.a(ne)), ae
        },
        get useIdb() {
          return null === re && (re = new s.a(ie)), re
        }
      }
    },
    ohhZ: function(e, t, n) {},
    pAGP: function(e, t, n) {
      ...
      n("x9oK"), n("UJ0r"), n("3wcW"), n("X2RP"), n("6Cx8");
      var i = n("teaq"),
        a = (n("tHMN"), n("ipeT"), n("PhBv"), n("d/or"));
      n("LzQZ")
    },
    pP8i: function(e, t, n) {
      "use strict";
      ...
      const h = {
        ...
        g = {
          partitionNamingStrategy: [r.a.const("ZLog")],
          partitionsMap: Object(o.a)(h)
        },
        f = {
          partitionNamingStrategy: [r.a.const("zdb_log")],
          partitionsMap: Object(o.a)(h)
        },
        b = Object(i.a)(Object(i.a)(Object(i.a)({}, y), g), {}, {
          version: 1,
      ...
      t.a = {
        ...
        schema: h,
        get useSqlite() {
          return null === v && (v = new s.a(b)), v
        },
        get useIdb() {
          return null === C && (C = new s.a(I)), C
        }
      }
    },
    pRxM: function(e, t, n) {
      ...
      const c = {
        ...
        p = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("Reaction")],
          partitionsMap: Object(o.a)(c)
        },
        m = {
          partitionNamingStrategy: [r.a.const("r_db"), r.a.byUser()],
          partitionsMap: Object(o.a)(c)
        },
        h = Object(i.a)(Object(i.a)(Object(i.a)({}, u), p), {}, {
          version: 1,
    ...
    pjo1: function(e, t, n) {
      ...
      var i = n("jDHv");
      const a = Object(i.define)("database-client")
    },
    "rdC+": function(e, t, n) {
      "use strict";
      var i = n("VTBJ"),
      ...
      const l = {
        ...
        c = {
          partitionNamingStrategy: [r.a.const("SecureLocalstorage")],
          partitionsMap: Object(o.a)(l)
        },
        u = {
          partitionNamingStrategy: [r.a.const("zsecure-localstorage")],
          partitionsMap: Object(o.a)(l)
        },
        p = Object(i.a)(Object(i.a)(Object(i.a)({}, d), c), {}, {
          version: 1,
    ...
    tHMN: function(e, t, n) {
      ...
      n("PmZf");
      class r extends a.b {}
      const s = Object(i.define)("database-engine")
    },
    teaq: function(e, t, n) {
      "use strict";
      n.d(t, "d", (function() {
      ...
      class h extends m {
        constructor(e) {
          super(), this.fieldConfigs = void 0, this.fieldConfigs = Object.values(e).map((e => p.isBinaryFieldConfig(e) ? new p(e) : new u(e)))
        }
        getFieldType(e) {
        ...
        createValidator(e) {
          ...
          a.push(`const vldFls = ${i}`, "const curFlds = Object.keys(v)", "for (const field of curFlds) { if (!vldFls.includes(field)) return { ok: false, reason: 3, field }}");
          const r = a.join(";").concat(";return { ok: true };");
        ...
        createFullEntityValidator(e) {
          ...
          return function(e) {
            ...
            const a = i,
              r = Object.keys(e);
            for (const n of r) a.includes(n) || t.push({
              ok: !1,
              reason: 3,
              field: n
            });
      ...
      class y extends m {
        ...
        constructor(e) {
          super(), this.fieldConfig = void 0, this.fieldConfig = new u(Object(i.a)({
            name: "data"
          }, e))
        }
        getFieldValues(e) {
      ...
      class f {
        constructor(e) {
          this.commonConfig = e, this.entity = void 0, this.isNonFieldlikeEntity = void 0, this.fieldManager = void 0, this.indices = void 0, this.tableName = void 0, this.name = void 0, this.primaryIndex = void 0, this.mapNameToIndices = void 0, this.validators = void 0, this.fullEntityValidators = void 0, this.adapterSpecificConfigs = null, this.dbName = void 0, this.isNonFieldlikeEntity = e.isNonFieldlikeEntity || !1, this.indices = Object.values(e.indices).map((e => new g(e)));
          let t = e.fields;
          if (!this.isNonFieldlikeEntity) {
            ...
            })), n.size && (t = Object.entries(e.fields).reduce(((e, [t, a]) => {
              const r = Object(i.a)({}, a);
              return n.has(r.name) && (r.autoIncrement = !0), e[t] = r, e
            }), {}))
          }
          this.fieldManager = this.createConfigFieldManager(t), this.mapNameToIndices = new Map(this.indices.map((e => [e.name, e]))), this.primaryIndex = this.getPrimaryIndex() || null, this.name = e.name, this.tableName = e.tableName, this.validators = new Map, this.fullEntityValidators = new Map, this.getIndexPartitionField = r()(this.getIndexPartitionField.bind(this)), this.getRawConfigByAdapterType = r()(this.getRawConfigByAdapterType.bind(this))
        }
        hasBlobField() {
        ...
        createConfigFieldManager(e) {
          return this.isNonFieldlikeEntity ? new y(e) : new h(e)
        }
        getPrimaryIndex() {
          if (!this.mapNameToIndices.has("primary") && !this.isNonFieldlikeEntity) throw new d.w("primary");
          return this.mapNameToIndices.get("primary")
        }
        getIndex(e) {
          const t = this.mapNameToIndices.get(e);
          if (!t) throw new d.w(e);
          return t
        }
        ...
        validate(e, t = !0) {
          const n = t || this.isNonFieldlikeEntity ? void 0 : Object.keys(e).sort(),
            i = this.validateFields(e, n);
          let a = null;
          if (!1 === i.ok) switch (i.reason) {
            case 1:
              a = new d.o(`'${i.field}' field is missing!`);
              break;
            case 2:
              a = new d.o(`'${i.field}' field has invalid data type - Expected: ${i.expected} - Actual: ${i.actual}`);
              break;
            case 3:
              a = new d.o(`'${i.field}' field is unknown!`)
          }
          if (a) throw a
        }
        getValidator(e) {
        ...
        prepareValue(e, t, n) {
          if (!t) return e;
          const a = this.getFields().filter((e => void 0 !== e.defaultValue));
        ...
        setAdapterSpecificConfigs(e, t) {
          ...
          const [n, i] = this.validateConfig(e, t);
          if (n) throw n;
          this.adapterSpecificConfigs.set(e, i)
        }
        validateConfig(e, t) {
          return e === l.a.SQLite && t.partitionField && void 0 === t.corruptionImpact ? [new d.s(this.name), null] : [null, t]
        }
      }
      class b {
        constructor(e, t, n, i, a, r, s, o) {
          this.database = e, this.type = t, this.name = n, this.sessional = i, this.version = a, this.milestoneVersion = r, this.cipherKey = s, this.tablesMap = void 0, this.tables = void 0, this.tablesMap = new Map(o.tables.map((e => [e.name, e]))), this.tables = o.tables, this.tables.forEach((t => {
            t.dbName = e
          }))
        }
        getTableConfig(e) {
      ...
      class I {
        ...
        getPartition(e, t) {
          const n = this.session && (null == t ? void 0 : t.userId) || "",
            i = this.session && (null == t ? void 0 : t.UIN) || "",
            a = this.computePartitionName(n, e);
          let r = this.partitionsConfigCache.get(a);
          return r || (r = this.createPartitionConfig(n, e, i), r && this.partitionsConfigCache.set(a, r)), r
        }
        getCorruptionImpact() {
        ...
        computeDatabaseName(e, t) {
          const n = this.partitionNamingStrategy || [],
            i = Object(c.b)(this.type),
            a = {
              session: e,
              table: t
            };
          return n.map((e => a[e] || e)).join(i)
        }
        ...
        createPartitionConfig(e, t, n) {
          const i = this.getPatitionsMapKey(e, t);
          let a = this.partitionsMap[i];
          const r = this.computePartitionName(e, t);
          if (this.hasPartitionedTables) {
            if (-1 !== this.partitionedTables.findIndex((e => e.name === t))) a = {
              tables: [...a.tables].filter((e => e.name === t))
            };
            else {
              const e = this.partitionedTables.map((e => e.name));
              a = {
                tables: [...a.tables].filter((t => !e.includes(t.name)))
              }
            }
          }
          return new b(this.name, this.type, r, this.session, this.version, this.milestoneVersion, n, a)
        }
        validateConfig(e) {
          const t = e.name;
          return e.type === l.a.SQLite && void 0 === e.corruptionImpact ? [new d.s(t), e] : [null, e]
        }
      }
      const v = Object(s.define)("database-config-manager")
    },
    wH4e: function(e, t, n) {
      "use strict";
      var i = n("UK4g");
      ...
      n.d(t, "AdapterType", (function() {
        return a.a
      })), n.d(t, "CorruptionImpact", (function() {
        return a.b
      ...
      var r = n("DI/x");
      n.d(t, "DBError", (function() {
        return r.e
      })), n.d(t, "INVALID_QUERY_PARAMS_ERROR_CODE", (function() {
        return r.m
      })), n.d(t, "MISSING_PARTITION_KEY_ERROR_CODE", (function() {
        return r.q
      }));
      n("PmZf");
      var s = n("bSii");
      ...
      n("ibl3"), n("xI/L"), n("ohhZ"), n("4W2c"), n("YZti"), n("kFM4")
    },
    wudS: function(e, t, n) {
      "use strict";
      n.d(t, "a", (function() {
      ...
      function s() {
        const e = globalThis.localStorage.getItem(r);
        let t = [];
        try {
          e && (t = JSON.parse(e))
        } catch (n) {}
      ...
      function o() {
        if (null !== globalThis.localStorage.getItem(r)) return;
        const e = function() {
          let e = new Set;
          for (let t in localStorage)
            for (let n of [i.i, i.h, i.q])
              if (t && t.startsWith(n + "_")) {
                let i = t.substring(n.length + 1, t.length);
                if (i && !isNaN(+i)) {
                  e.add(i);
                  break
                }
        ...
        globalThis.localStorage.setItem(r, JSON.stringify(e))
      }

      function l(e) {
        let t = s(),
          n = t.indexOf(e);
        return -1 === n && (t.push(e), n = t.length - 1, globalThis.localStorage.setItem(r, JSON.stringify(t))), n
      }

      function d(e) {
        const t = globalThis.localStorage.getItem(r);
        if (null === t) return !1;
    ...
    x9oK: function(e, t, n) {
      ...
      var i, a = n("8/YW"),
        ...
        g = n("X2RP"),
        f = n("6Cx8");
      let b = Object(a.h)()(i = Reflect.metadata("design:type", Function)(i = Reflect.metadata("design:paramtypes", [void 0 === m.c ? Object : m.c, String, void 0 === y.a ? Object : y.a, "undefined" == typeof T ? Object : T, void 0 === g.a ? Object : g.a, void 0 === f.TransactionExecutor ? Object : f.TransactionExecutor, "undefined" == typeof DatabaseAdapterOptions ? Object : DatabaseAdapterOptions])(i = class extends s.b {
        constructor(e, t, n, i, a, s, l) {
          super(), this.partition = e, this.fullName = t, this.transactionManager = n, this.instance = i, this.queryExecutor = a, this.transactionExecutor = s, this.options = l, this.queryExecutorMap = void 0, this.active = !0, this.logger = void 0, this.removeListeners = () => {}, this.isCloseDBQueryContainer = null, this.isDeleteDBQueryContainer = null, this.queryExecutorMap = {
            [d.e.Clear]: a.clear.bind(a),
            [d.e.Get]: a.get.bind(a),
            [d.e.GetAndUpdate]: a.getAndUpdate.bind(a),
            [d.e.GetMulti]: a.getMulti.bind(a),
            [d.e.GetMultiIfExists]: a.getMultiIfExists.bind(a),
            [d.e.GetAll]: a.getAll.bind(a),
            [d.e.GetAllKey]: a.getAllKey.bind(a),
            [d.e.Insert]: a.insert.bind(a),
            [d.e.InsertMulti]: a.insertMulti.bind(a),
            [d.e.Update]: a.update.bind(a),
            [d.e.UpdateMulti]: a.updateMulti.bind(a),
            [d.e.Delete]: a.delete.bind(a),
            [d.e.DeleteMulti]: a.deleteMulti.bind(a),
            [d.e.FindAndDelete]: a.findAndDelete.bind(a),
            [d.e.Count]: a.count.bind(a)
          };
          const c = r.ModuleContainer.resolve(o.ZLoggerFactory);
          this.logger = c.createZLogger("db", ["adapter"]), this.registerListeners()
        }
        registerListeners() {
          const e = e => {
              this.dispatchEvent(e)
            ...
            t = [];
          t.push(this.instance.addEventListener(u.b.SuccessOpenDB, e)), t.push(this.instance.addEventListener(u.b.LongOpenDB, e)), t.push(this.instance.addEventListener(u.b.SchemaMigratedAbnormally, e)), t.push(this.queryExecutor.addEventListener(u.b.Warning, e)), this.removeListeners = () => t.forEach((e => e()))
        }
        onDispose() {
        ...
        executeByQueryExecutor(e) {
          ...
          const t = t => {
            ...
            this.logger.zsymb(18, "0YSSU4", (() => [p.c.getTypeName(e.type), {
              logInfo: n,
              error: t
            }])), e.deferrer.reject(t)
          };
          try {
            if (e.transaction) {
              ...
              t.execute((() => this.queryExecutorMap[e.type](e))).then((t => {
                ...
                this.checkTimeConsumingQuery(e, i), e.deferrer.resolve(t)
              })).catch(e.deferrer.reject)
            } else {
              const t = performance.now();
              this.queryExecutorMap[e.type](e).then((n => {
                const i = performance.now() - t;
                this.checkTimeConsumingQuery(e, i), e.deferrer.resolve(n)
              })).catch(e.deferrer.reject)
            }
          } catch (n) {
            t(n)
        ...
        checkTimeConsumingQuery(e, t) {
          if (t >= 5e3) {
            const n = {
              ...
              table: e.table,
              trans: e.transaction,
              type: p.c.getTypeName(e.type)
            };
            this.logger.zsymb(18, "rxu6v1", "Time consuming query:", n, "- Total time: ", t), this.dispatchEvent(new u.i(n, t))
          }
        }
      }) || i) || i) || i;
      const I = `database-adapter-${d.a.IDB}`,
        v = `database-adapter-${d.a.SQLite}`,
        C = Object(r.define)(I),
        w = Object(r.define)(v)
    },
    "xI/L": function(e, t, n) {
    ...
    xM06: function(e, t, n) {
      ...
      const i = "SQL_STATEMENT",
        a = "DAL_UTILITY",
        r = "BACK_UP",
        s = "DB_MIGRATION",
        o = "DB_CORRUPTION",
        l = "NEED-SCHEMA-MIGRATION",
        d = "DAL_UTILITY/CLOSE_DB",
        c = "DAL_UTILITY/DELETE_DB",
        u = "DAL_UTILITY/GET_PARTITION_KEYS",
        p = "DAL_UTILITY/CLEAR_SESSIONAL_POOLS_UTILITY_TYPE_ID",
        m = "DAL_UTILITY/CLEAR_ALL_POOLS_UTILITY_TYPE_ID",
        h = "BACK_UP_UTILITY/CREATE_BACK_UP_TYPE_ID",
        y = "BACK_UP_UTILITY/ABORT_CREATE_BACK_UP_TYPE_ID",
        g = "DB_MIGRATION/START",
        f = "DB_MIGRATION/SEND_PROGRESS",
        b = "DB_MIGRATION/FINISH",
        I = "DB_MIGRATION/PAUSE",
        v = "DB_MIGRATION/RESUME",
        C = "DB_MIGRATION/QOS",
        w = "DB_MIGRATION/PROMOTE",
        T = "DB_MIGRATION/RESET",
        S = "DB_MIGRATION/GET_PROGRESS",
        _ = "DB_MIGRATION/INIT_STATE",
        M = "DB_MIGRATION/CLEAR_INFO_DB_SIZE_CACHE",
        N = "SIGNAL_CORRUPTION",
        D = "ANALYZE_CORRUPTION";
      const A = "lst_bic",
        E = ["SQLITE_CORRUPT", "SQLITE_NOTADB"]
    },
    "xS/Y": function(e, t, n) {
      "use strict";
      var i = n("VTBJ"),
      ...
      u.setAdapterSpecificConfigs(a.a.IDB, {
        migrations: {
          3: {
            version: 3,
            scripts: [{
      ...
      const p = {
        ...
        h = {
          partitionNamingStrategy: [r.a.byUser(), r.a.const("Res")],
          partitionsMap: Object(o.a)(p)
        },
        y = {
          partitionNamingStrategy: [r.a.const("zres"), r.a.byUser()],
          partitionsMap: Object(o.a)(p)
        },
        g = Object(i.a)(Object(i.a)(Object(i.a)({}, m), h), {}, {
          version: 1,
          milestoneVersion: 1,
          type: a.a.SQLite,
          corruptionImpact: a.b.IMPACT_FULL
        }),
        f = Object(i.a)(Object(i.a)(Object(i.a)({}, m), y), {}, {
          version: 3,
          milestoneVersion: 1,
          type: a.a.IDB
        });
    ...
    yi2h: function(e, t, n) {
      ...
      var i = n("VTBJ"),
        a = n("wH4e");
      const r = (e, t) => Object(i.a)(Object(i.a)({}, e), {}, {
        type: a.ValidDataType.blob,
        jsBinaryType: t
      })
    }
  }
