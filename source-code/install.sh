...
cp -r "$SCRIPT_DIR/$ZALO_DIR" /tmp/zalo-installer/
...
cd /tmp/zalo-installer/$ZALO_DIR/Zalo
...
# Copy the Zalo subdirectory (which contains app/ and other files)
cp -r /tmp/zalo-installer/$ZALO_DIR/Zalo ~/.local/share/Zalo
